local VERSION_TEXT = "1.9.4 c";
local VERSION_DATE = 1787500000;
...
local DefaultValues = {
    ...
    QuestItemDestroyAlert = false,       --Show related quest info when destroying a quest-starting item，lnui
    ...
    PartyInviterInfo = true,           --Show the inviter's level and class，lnui
		PartyInviter_Race = false,
		PartyInviter_Faction = false,
    PlayerTitleUI = true,              --Add search box and filter to TitleManagerPane，lnui
	Plunderstore = true,
	...
	--Reduction
    BossBanner_MasterSwitch = true,--lnui
	...
	NewExpansionLandingPage = true,
        ...
        LandingButton_Unaffected = true,--lnui
    ...
    MerchantPrice = true,              --Merchant Price (Alt Currency) Overview, gray insufficient items，lnui
