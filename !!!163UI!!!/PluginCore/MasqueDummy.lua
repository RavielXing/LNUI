...
do
    if select(5, C_AddOns.GetAddOnInfo("Masque"))=="MISSING" then return end
    if C_AddOns.GetAddOnEnableState("TellMeWhen", U1PlayerGuid)>=2 then return end
    if C_AddOns.GetAddOnEnableState("WeakAuras", U1PlayerGuid)>=2 then return end
end
