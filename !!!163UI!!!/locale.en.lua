...
--[[1773]] L["    爱不易（AbyUI）是新一代整合插件。其设计理念是兼顾整合插件的易用性和单体插件的灵活性，同时适合普通和高级用户群体。|n|n    功能上，爱不易实现了任意插件的随需加载，并可先进入游戏再逐一加载插件，此为全球首创。此外还有标签分类、拼音检索、界面缩排等特色功能。"] = "    老农整合包，一款基于暴雪原始界面、功能强大的插件整合包。实现了首次使用，无需繁琐设置，就能自动对插件优化调整，真正做到了“开袋即食”的效果。同时兼顾整合插件的易用性和单体插件的灵活性，适合新手玩家和硬核玩家群体。|n    此外，更对整合的插件做到了最大程度的简繁汉化。"
...
--[[  32]] L["|cffcd1a1c【爱不易】|r- "] =  "|cff19CCF9[老农整合包-|cFFFFFF00503-1|r版]|r- "
...
--[[   3]] --L["爱不易"] = true
--[[   5]] L["爱不易是新一代整合插件。其设计理念是兼顾整合插件的易用性和单体插件的灵活性，同时适合普通和高级用户群体。|n|n    功能上，爱不易实现了任意插件的随需加载，并可先进入游戏再逐一加载插件，此为全球首创。此外还有标签分类、拼音检索、界面缩排等特色功能。"] = "老农整合包，一款基于暴雪原始界面、功能强大的插件整合包。实现了首次使用，无需繁琐设置，就能自动对插件优化调整，真正做到了“开袋即食”的效果。同时兼顾整合插件的易用性和单体插件的灵活性，适合新手玩家和硬核玩家群体。`此外，更对整合的插件做到了最大程度的简繁汉化。"
