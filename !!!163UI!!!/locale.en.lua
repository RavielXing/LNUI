...
--[[ 597]] --L["爱不易设置"] = true
--[[ 597]] L["直接显示爱不易的介绍和配置项，再次点击则恢复当前的选择插件"] = "Jump to option page. Click the button again to go back to the former selected addon."
...
--[[ 650]] L["方案"] = "Prf"
L["更新记录"] = "ChangeLog"
L["点击查看老农整合包更新内容。"] = "View LNui what's new"
L["更新"] = "Log"
--[[ 666]] L["爱不易快捷设置"] = "老农快捷设置"
...
--[[1658]] L["仅老农整合包的插件才能用拼音搜索名称。"] = "仅老农整合包的插件才能用拼音搜索名称。"
...
--[[1745]] L["爱不易"] = "|cff19CCF9老农插件中心"
--[[1745]] L["点击爱不易标志开启插件控制中心\n \nCtrl点击小地图图标可以收集/还原"] = "Click the icon to open LNui control panel.\n \nCtrl click minimap buttons to gather/restore them."
--[[1754]] --L["爱不易"] = true
--[[1771]] L["爱不易插件中心"] = "|cff19CCF9老农插件中心"
--[[1773]] L["    爱不易（AbyUI）是新一代整合插件。其设计理念是兼顾整合插件的易用性和单体插件的灵活性，同时适合普通和高级用户群体。|n|n    功能上，爱不易实现了任意插件的随需加载，并可先进入游戏再逐一加载插件，此为全球首创。此外还有标签分类、拼音检索、界面缩排等特色功能。"] = "    老农整合包，一款基于暴雪原始界面、功能强大的插件整合包。实现了首次使用，无需繁琐设置，就能自动对插件优化调整，真正做到了“开袋即食”的效果。同时兼顾整合插件的易用性和自装单体插件的灵活性，适合新手玩家和硬核玩家群体。|n    此外，更对整合的插件做到了最大程度的简繁汉化。"
--[[1775]] L["鼠标右键点击可打开快捷设置"] = "Right click to open quick menu."
--[[1776]] L["检测到其他小地图按钮收集插件"] = "Another minimap button collector is detected."
...
--[[  32]] L["|cffcd1a1c【爱不易】|r- "] =  "|cff19CCF9[老农整合包-|cFFFFFF00577|r版]|r- "
...
--[[   3]] --L["爱不易"] = true
--[[   5]] L["爱不易是新一代整合插件。其设计理念是兼顾整合插件的易用性和单体插件的灵活性，同时适合普通和高级用户群体。|n|n    功能上，爱不易实现了任意插件的随需加载，并可先进入游戏再逐一加载插件，此为全球首创。此外还有标签分类、拼音检索、界面缩排等特色功能。"] = "老农整合包，一款基于暴雪原始界面、功能强大的插件整合包。实现了首次使用，无需繁琐设置，就能自动对插件优化调整，真正做到了“开袋即食”的效果。同时兼顾整合插件的易用性和自装单体插件的灵活性，适合新手玩家和硬核玩家群体。`此外，更对整合的插件做到了最大程度的简繁汉化。"
--[[   9]] L["|cffcd1a1c[爱不易原创]|r"] = "|cffcd1a1cwarbaby(爱不易)|r"
