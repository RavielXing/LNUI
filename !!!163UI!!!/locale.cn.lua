...
L["TAG_BIG"] = "大型插件"
L["TAG_DESC_BIG"] = "此分类下是老农整合包中内存占用相对较高、模块数量较多的大型插件，而且关闭后一般不影响正常的游戏习惯，如果希望节省内存可以全部停用。"
L["TAG_TRADING"] = "商业交易"
...
L["TAG_DESC_MANAGEMENT"] = "此分类是用来'管理插件的插件'，主要是一些比较高阶的错误信息及数据统计等，控制台就在此分类中，此外还有错误提示增强、错误消息屏蔽等功能。"
L["TAG_ITEM"] = "物品装备"
...
L["TAG_SINGLE"] = "自装插件"
L["TAG_DESC_SINGLE"] = "自装插件是非老农整合包中的插件，如果用户自行下载了整合包收录的插件的单体版，也会列在此分类中。"
L["TAG_UNIQUE"] = "爱不易独家"
L["TAG_NEW"] = "最新发布"
L["TAG_DATA"] = "资料数据库"
L["TAG_DEV"] = "DevTools"
...
--[[ 581]] L["爱不易设置"] = "老农设置"
--[[ 597]] --L["爱不易设置"] = true
--[[ 597]] L["直接显示爱不易的介绍和配置项，再次点击则恢复当前的选择插件"] = "直接显示介绍和配置项，再次点击则恢复当前的选择插件"
--[[ 598]] L["快捷设置"] = true
...
--[[1745]] L["爱不易"] = "|cff19CCF9老|cffffb300农|cffD56AFF插|cffFF6BED件|cffFF2AA5中|cff96ff00心|r"
--[[1745]] L["点击爱不易标志开启插件控制中心\n \nCtrl点击小地图图标可以收集/还原"] = "点击老农标志开启插件控制中心\n \nCtrl点击小地图图标可以收集/还原"
--[[1754]] --L["爱不易"] = true
--[[1771]] L["爱不易插件中心"] = "|cff19CCF9老|cffffb300农|cffD56AFF插|cffFF6BED件|cffFF2AA5中|cff96ff00心|r"
...
L["In addition of saving addon enable/disable states, also save the options shown in the EAC panel."] = "选中此项则会保存/加载插件控制台里的所有设置项"
L["Rename"] = "改名"
L["Unnamed"] = "未命名"
L["Load"] = "加载"
L["Delete"] = "删除"
...
L["Shared Profile"] = "全局通用配置"
L["Apply to All Visible Characters"] = "立即应用到所有可见角色"
...
--[[  13]] L["延迟加载插件"] = true
--[[  14]] L["说明`爱不易独家支持，可以先读完蓝条然后再逐一加载插件。会大大加快读条速度，但是加载大型插件时会有卡顿。如果不喜欢这种方式，请取消勾选即可，下次进游戏时就会采用新设置。` `对比测试：`未开启时，在第7.5秒后读完蓝条同时加载完全部插件`开启后，在第3.8秒读完蓝条，第8.0秒加载完全部插件"] = "可以先读完蓝条然后再逐一加载插件。会大大加快读条速度，但是加载大型插件时会有卡顿。如果不喜欢这种方式，请取消勾选即可，下次进游戏时就会采用新设置。` `对比测试：`未开启时，在第7.5秒后读完蓝条同时加载完全部插件`开启后，在第3.8秒读完蓝条，第8.0秒加载完全部插件"
