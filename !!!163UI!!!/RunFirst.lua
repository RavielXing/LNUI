...
local sum = 0 for i = 1, C_AddOns.GetNumAddOns() do sum = sum + C_AddOns.GetAddOnEnableState(i, U1PlayerGuid) end
...
function U1Message(text, r, g, b, chatFrame)
    local LNicon = "|TInterface/AddOns/!!!163UI!!!/Textures/UI2-logo-small.blp:20|t"  -- 老农图标
    (chatFrame or DEFAULT_CHAT_FRAME):AddMessage(LNicon .. L["|cffcd1a1c【爱不易】|r- "] .. text, r, g, b);
end
