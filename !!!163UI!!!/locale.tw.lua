...
L["TAG_BIG"] = "大型插件"
L["TAG_DESC_BIG"] = "此分類下是老農整合包中記憶體佔用相對較高、模組數量較多的大型插件，而且關閉後一般不影響正常的遊戲習慣，如果希望節省記憶體可以全部停用。"
L["TAG_TRADING"] = "商業交易"
...
L["TAG_DESC_MANAGEMENT"] = "此分類是用來'管理插件的插件'，主要是一些比較高階的錯誤資訊及資料統計等，控制台就在此分類中，此外還有錯誤提示增強、錯誤消息屏蔽等功能。"
L["TAG_ITEM"] = "物品裝備"
...
L["TAG_SINGLE"] = "單體插件"
L["TAG_DESC_SINGLE"] = "單體插件是非老農整合包中的插件，如果用戶自行下載了整合包收錄的插件的單體版，也會列在此分類中。"
L["TAG_UNIQUE"] = "愛不易獨家"
L["TAG_NEW"] = "最新發佈"
L["TAG_DATA"] = "資料資料庫"
L["TAG_DEV"] = "DevTools"
...
--[[ 429]] L[" 爱不易整合 "] = "|cff19CCF9老|cffffb300農|cffD56AFF整|cffFF2AA5合|r"
--[[ 430]] L["　其他插件　"] = "　其他插件　"
--[[ 430]] L["　单体插件　"] = "　自裝插件　"
--[[ 494]] L["地图任务"] = "地圖任務"
--[[ 577]] L["正常模式"] = "正常模式"
...
--[[ 581]] L["爱不易设置"] = "老農設置"
--[[ 597]] --L["爱不易设置"] = "愛不易設置"
--[[ 597]] L["直接显示爱不易的介绍和配置项，再次点击则恢复当前的选择插件"] = "直接顯示介紹和配置項，再次點擊則恢復當前的選擇插件"
--[[ 598]] L["快捷设置"] = "快捷設置"
...
--[[ 650]] L["方案"] = "方案"
L["更新记录"] = "更新記錄"
L["点击查看老農整合包更新内容。"] = "點擊查看老農整合包更新內容。"
L["更新"] = "更新"
--[[ 666]] L["爱不易快捷设置"] = "老農快捷設置"
...
--[[1658]] L["仅老农整合包的插件才能用拼音搜索名称。"] = "繁體版不支持拼音檢索"
...
--[[1745]] L["爱不易"] = "|cff19CCF9老|cffffb300農|cffD56AFF插|cffFF6BED件|cffFF2AA5中|cff96ff00心|r"
--[[1745]] L["点击爱不易标志开启插件控制中心\n \nCtrl点击小地图图标可以收集/还原"] = "點擊老農標誌開啟插件控制中心\n \nCtrl點擊小地圖按鈕可以收集/還原"
--[[1754]] --L["爱不易"] = "愛不易"
--[[1771]] L["爱不易插件中心"] = "|cff19CCF9老|cffffb300農|cffD56AFF插|cffFF6BED件|cffFF2AA5中|cff96ff00心|r"
--[[1773]] L["    爱不易（AbyUI）是新一代整合插件。其设计理念是兼顾整合插件的易用性和单体插件的灵活性，同时适合普通和高级用户群体。|n|n    功能上，爱不易实现了任意插件的随需加载，并可先进入游戏再逐一加载插件，此为全球首创。此外还有标签分类、拼音检索、界面缩排等特色功能。"] = "    老農整合包，一款基於暴雪原始界面、功能強大的插件整合包。實現了首次使用，無需繁瑣設置，就能自動對插件優化調整，真正做到了「開袋即食」的效果。同時兼顧整合插件的易用性和自裝單體插件的靈活性，適合新手玩家和硬核玩家群體。|n    此外，更對整合的插件做到了最大程度的簡繁漢化。"
--[[1775]] L["鼠标右键点击可打开快捷设置"] = "滑鼠右鍵點擊可打開快捷設置"
--[[1776]] L["检测到其他小地图按钮收集插件"] = "檢測到其他小地圖按鈕收集插件"
...
L["In addition of saving addon enable/disable states, also save the options shown in the EAC panel."] = "選中此項則會保存/載入插件控制台裡的所有設置項"
L["Rename"] = "改名"
L["Unnamed"] = "未命名"
L["Load"] = "載入"
L["Delete"] = "刪除"
...
--[[  32]] L["|cffcd1a1c【爱不易】|r- "] = "|cff19CCF9[{老農}老農整合包-|cFFFFFF00577|r版]|r- "

--[[    ]] -- File: Tags.lua

--[[  31]] L["全部插件"] = "全部插件"
--[[  38]] L["精新推荐"] = "|cff19CCF9甄選推薦|r"
--[[  43]] --L["爱不易"] = "愛不易"
--[[  51]] --L["单体插件"] = "單體插件"
--[[  58]] L["专用"] = "專用"
--[[  65]] --L["已启用"] = "已啟用"
...
--[[   3]] --L["爱不易"] = "愛不易"
--[[   5]] L["爱不易是新一代整合插件。其设计理念是兼顾整合插件的易用性和单体插件的灵活性，同时适合普通和高级用户群体。|n|n    功能上，爱不易实现了任意插件的随需加载，并可先进入游戏再逐一加载插件，此为全球首创。此外还有标签分类、拼音检索、界面缩排等特色功能。"] = "老農整合包，一款基于暴雪原始界面、功能強大的插件整合包。實現了首次使用，無需繁瑣設置，就能自動對插件優化調整，真正做到了“開袋即食”的效果。同時兼顧整合插件的易用性和自裝單體插件的靈活性，適合新手玩家和硬核玩家群體。`此外，更對整合的插件做到了最大程度的簡繁漢化。"
--[[   9]] L["|cffcd1a1c[爱不易原创]|r"] = "|cffcd1a1cwarbaby(愛不易)|r"
--[[  13]] L["延迟加载插件"] = "延遲加載插件"
--[[  14]] L["说明`爱不易独家支持，可以先读完蓝条然后再逐一加载插件。会大大加快读条速度，但是加载大型插件时会有卡顿。如果不喜欢这种方式，请取消勾选即可，下次进游戏时就会采用新设置。` `对比测试：`未开启时，在第7.5秒后读完蓝条同时加载完全部插件`开启后，在第3.8秒读完蓝条，第8.0秒加载完全部插件"] = "說明`可以先讀完藍條然後再逐一載入插件。會大大加快讀條速度，但是載入大型插件時會有卡頓。如果不喜歡這種方式，請取消勾選即可，下次進遊戲時就會採用新設置。` `對比測試：`未開啟時，在第7.5秒後讀完藍條同時載入完全部插件`開啟後，在第3.8秒讀完藍條，第8.0秒載入完全部插件"
