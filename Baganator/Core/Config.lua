...
local settings = {
  ...
  SEEN_WELCOME = {key = "seen_welcome", default = 1},--LNUI
  BAG_VIEW_WIDTH = {key = "bag_view_width", default = 14, refresh = {Refresh.Layout}, zone = {Zone.Bags}},--LNUI
  ...
  ICON_TOP_LEFT_CORNER_ARRAY = {key = "icon_top_left_corner_array", default = {"pawn", "can_i_mog_it"}, refresh = {Refresh.ItemTextures, Refresh.ItemWidgets}},--LNUI
  ...
  MAIN_VIEW_POSITION = {key = "bag_view_position", default = {"BOTTOMRIGHT", addonTable.Constants.IsRetail and -110 or -30, 150}},  --lnui背包位置
