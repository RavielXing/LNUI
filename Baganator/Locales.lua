...
L["BAG_VIEW_TYPE"] = "背包视图类型"
L["BAGANATOR"] = "Baganator"
L["BANK"] = "银行"
L["BANK_COLUMNS"] = "银行列数"
L["BANK_DATA_MISSING_HINT"] = "缺少银行数据。请使用 %s 访问银行以填充此视图。"
L["BANK_VIEW_TYPE"] = "银行视图类型"
...
L["BINDING_TOGGLE_CURRENCY_PANEL"] = "切换货币面板"
...
L["BOE"] = "装绑"
L["BOU"] = "用绑"
L["BRACKETS_CATEGORY_VIEW_ONLY"] = "（仅分类视图）"
L["BUY_CHARACTER_BANK_TAB"] = "购买角色银行标签页？"
L["BUY_GUILD_BANK_TAB"] = "购买公会银行标签页？"
L["BUY_REAGENT_BANK"] = "购买材料银行"
L["BUY_WARBAND_BANK_TAB"] = "购买战团银行标签页？"
L["BY_PLUSMOUSE"] = "作者：plusmouse"
L["CAN_I_MOG_IT"] = "Can I Mog It"
L["CANNOT_ADD_ANY_MORE_ITEMS_TO_THIS_TRADE"] = "无法向此交易添加更多物品"
L["CANNOT_EDIT_GUILD_BANK_TAB_ERROR"] = "您没有权限编辑此标签页"
L["CANNOT_MOVE_ITEMS_AS_NO_SPACE_LEFT"] = "无法移动物品，空间不足"
L["CANNOT_WITHDRAW_ANY_MORE_ITEMS_FROM_THE_GUILD_BANK"] = "无法从公会银行取出更多物品"
L["CANNOT_YOU_ARE_IN_COMBAT"] = [=[无法操作：你正处于战斗中

]=]
L["CATALYST"] = "化生台"
L["CATEGORIES"] = "分类"
L["CATEGORIES_FAILED_WARNING"] = "显示分类时出现问题。\\n\\n失败的搜索为：“%s”。以下物品失败：\\n%s\\n\\n请截图并访问 Discord："
L["CATEGORIES_IN_TOOLTIPS_X"] = "背包物品提示中的分类匹配现已 %s"
L["CATEGORY_AUTO_EQUIPMENT_SETS"] = "自动：装备方案"
L["CATEGORY_BAG"] = "背包"
L["CATEGORY_EQUIPMENT_SET"] = "装备方案"
L["CATEGORY_EQUIPMENT_SETS_AUTO"] = "装备方案（自动）"
L["CATEGORY_FOOD"] = "食物"
L["CATEGORY_GROUPS"] = "分类分组"
L["CATEGORY_GROUPS_DESCRIPTION"] = "按类型对物品进行分组，并可添加新的自定义分类。"
L["CATEGORY_HEARTHSTONE"] = "炉石"
L["CATEGORY_INVENTORY_SLOTS_AUTO"] = "物品栏位（自动）"
L["CATEGORY_JUNK"] = "垃圾"
...
L["CHARACTER_BANK_NOT_PURCHASED_HINT"] = "角色银行空间未购买。请使用右侧的新标签页按钮购买"
L["CHARACTER_PANEL"] = "角色面板"
L["CHOOSE"] = "选择"
L["CHOOSE_A_LABEL_FOR_THIS_SEARCH"] = "为此搜索选择一个标签"
L["CLICK_TO_CLEAR_RECENT"] = "<点击清除最近>"
L["COMBINE_STACKS_ONLY"] = "仅合并堆叠"
L["CONFIRM_DELETE_PROFILE_X"] = "您确定要删除配置 \\\"%s\\\" 吗？"
L["CONFIRM_TRANSFER_ALL_ITEMS_FROM_BAG"] = "您要转移背包中的所有物品吗？"
L["CONFIRM_TRANSFER_ALL_ITEMS_FROM_BANK"] = "您要转移银行中的所有物品吗？"
L["CONFIRM_TRANSFER_ALL_ITEMS_FROM_GUILD_BANK"] = "您要转移公会银行中的所有物品吗？"
L["COOKING"] = "烹饪"
L["COST_X"] = "费用：%s"
L["CRAFTING_WINDOW"] = "制造窗口"
L["CREATE_NEW_CATEGORY"] = "创建新分类..."
L["CREATE_NEW_DIVIDER"] = "创建新分隔线..."
L["CREATE_NEW_SECTION"] = "创建新分组..."
L["CTRL_C_TO_COPY"] = "Ctrl+C 复制"
L["CTRL_CLICK_TO_TRANSFER"] = "<Ctrl+点击 转移>"
L["CURRENCIES"] = "货币"
L["CUSTOMISE_BAGANATOR"] = "自定义 Baganator"
L["DARK"] = "暗色"
L["DEPOSIT_REAGENTS"] = "存放材料"
...
L["DONATE"] = "赞助"
L["DRAGGING"] = "拖动时"
L["DRAGGING_THEN_ALT"] = "拖动后按 Alt"
L["EDIT"] = "编辑"
L["ELVUI"] = "ElvUI"
L["EMPTY"] = "空"
L["ENABLE_CATEGORY_MODE_WARNING"] = "如果要使用分类，您需要启用分类视图"
L["ENABLED"] = "已启用"
L["ENCHANTING"] = "附魔"
L["ENGINEERING"] = "工程学"
...
L["EXPANSION"] = "内容更新"
L["EXPORT"] = "导出"
L["FACTION_REALM_WIDE_GOLD_X"] = "阵营/服务器金币：%s"
...
L["GROUP_BY"] = "分组方式"
L["GROUP_EMPTY_SLOTS"] = "分组空栏位"
L["GROUP_IDENTICAL_ITEMS"] = "分组相同物品"
...
L["GUILD_BANK"] = "公会银行"
L["GUILD_BANK_COLUMNS"] = "公会银行列数"
L["GUILD_BANK_DATA_MISSING_HINT"] = "此公会银行尚未被访问过。"
L["GUILD_BANK_NO_TABS"] = "此公会银行没有标签页。"
L["GUILD_BANK_SORT_METHOD"] = "公会银行排序方法"
L["GUILD_MONEY_LOGS_TOOLTIP_TEXT"] = "查看公会银行的资金存取记录"
L["GUILD_MONEY_WITHDRAW_X"] = "金币 - 提取：%s"
L["GUILD_MONEY_X"] = "金币 - 总计：%s"
L["GUILD_NO_TABS_PURCHASED"] = "未购买公会银行标签"
L["GUILD_TAB_INFO_TOOLTIP_TEXT"] = "查看此标签页存储的信息"
L["GUILD_TAB_LOGS_TOOLTIP_TEXT"] = "查看此标签页的物品存取记录"
L["GUILD_WITHDRAW_DEPOSIT_X_X"] = "物品 - 提取： %s | 存入： %s"
L["GW2_UI"] = "GW2 UI"
L["HELP"] = "帮助"
L["HELP_COLON_SEARCH"] = "帮助：搜索"
L["HELP_SEARCH_ITEM_LEVEL"] = "装备等级"
L["HELP_SEARCH_ITEM_LEVEL_LINE_1"] = "123（精确等级），<123（低于），>123（高于），123-234（区间）"
L["HELP_SEARCH_ITEM_LEVEL_LINE_2"] = "例如：#装备&>242"
L["HELP_SEARCH_KEYWORDS"] = "关键词"
L["HELP_SEARCH_KEYWORDS_LINE_1"] = "您的搜索将在两个位置寻找匹配：指定的关键词集合内，以及物品名称和提示描述中。要仅搜索精确关键词，请在关键词前使用井号（#）。"
L["HELP_SEARCH_KEYWORDS_LINE_2"] = "例如：#装备&探索者"
L["HELP_SEARCH_OPERATORS"] = "运算符"
L["HELP_SEARCH_OPERATORS_LINE_1_V2"] = "&（与）， |（或）， !（非）， #（精确关键词），( ) （分组）"
L["HELP_SEARCH_OPERATORS_LINE_2_V2"] = "运算符按以下优先级顺序求值：( )（分组），!（非），&（与），|（或）。"
L["HELP_SEARCH_OPERATORS_LINE_3"] = "例如：!A & B | C 的求值结果为 ((!A) & B) | C。"
L["HERBALISM"] = "草药"
L["HIDDEN"] = "隐藏"
L["HIDE_BOE_STATUS_ON_COMMON_2"] = "在垃圾/普通品质物品上隐藏装绑状态"
L["HIDE_ICON_BACKGROUNDS"] = "隐藏图标背景"
L["HIGH"] = "高"
L["HIGHER"] = "更高"
L["HIGHEST"] = "最高"
L["HOLD_SHIFT_TO_SHOW_ACCOUNT_TOTAL"] = "<按住 Shift 显示帐号总计>"
L["ICON_CORNERS"] = "图标边角"
L["ICON_SIZE"] = "图标大小"
L["ICON_TEXT_FONT_SIZE"] = "图标文字大小"
L["ICONS"] = "图标"
L["IGNORED_BAG_SLOTS"] = "忽略的背包栏位（角色特定）"
L["IGNORED_BANK_SLOTS"] = "忽略的银行栏位（角色特定）"
...
L["INVALID_CATEGORY_IMPORT_FORMAT"] = "无效的分类导入格式"
L["ITEM_INFORMATION_MISSING"] = "缺少物品信息"
L["ITEM_LEVEL"] = "物品等级"
L["ITEM_NAME"] = "物品名称"
L["ITEM_QUALITY"] = "物品品质"
L["ITEM_QUALITY_TEXT_COLORS"] = "物品品质文字颜色"
L["ITEM_TYPE"] = "物品类型"
L["ITEM_UPGRADE"] = "物品升级"
L["ITEMS"] = "物品"
L["JEWELCRAFTING"] = "珠宝"
...
L["KEYWORDS_IN_TOOLTIPS_X"] = "背包物品提示中的关键词现已 %s"
L["LAYOUT"] = "布局"
L["LEATHERWORKING"] = "制皮"
L["LINK"] = "链接"
L["LOCK_WINDOWS"] = "锁定窗口"
...
L["NEW_SECTION"] = "新分组"
L["NO_TRANSACTIONS_AVAILABLE"] = "没有可用交易记录"
L["NONE"] = "无"
L["NORMAL"] = "普通"
L["NOTHING_TO_SAVE"] = "没有可保存的内容"
L["OPEN_OPTIONS"] = "打开选项"
...
L["REALM_X_X_X"] = "%s（x%s）"
L["RECENT_CHARACTER_TABS"] = "最近角色标签页"
L["RECENT_HEADER_CLICK_MESSAGE"] = "点击标题立即清除。"
L["RECENT_INCLUDE_OWNED"] = "包括已拥有"
L["RECENT_TIMER"] = "最近计时"
L["REDUCE_UI_SPACING"] = "减少界面间距"
L["RELOAD_REQUIRED"] = "需要重新加载"
L["REMOVE_BORDERS"] = "移除边框"
L["REMOVE_FROM_CATEGORY"] = "从分类中移除"
L["REMOVED_UNUSED_CATEGORIES"] = "已删除所有未使用的自定义分类"
L["RESET_POSITIONS"] = "重置位置"
L["REVERSE_GROUPS_SORT_ORDER"] = "反转分组排序顺序"
L["REVERT_CHANGES"] = "还原更改"
L["RIGHT_CLICK_FOR_SETTINGS"] = "<右键点击打开设置>"
L["RIGHT_CLICK_TO_REMOVE"] = "<右键-点击 移除>"
L["RIGHT_CLICK_TO_RESET"] = "<右键-点击 重置>"
L["RIGHT_CLICK_TO_TRANSFER"] = "<右键-点击 转移>"
L["RIGHT_CLICK_TO_VENDOR_6"] = "<右键点击出售给商人（最多6件物品）>"
L["SAVE_SEARCH"] = "保存搜索"
L["SAVED_SEARCHES"] = "保存的搜索"
L["SCRAP"] = "废料"
L["SCRAPPING_MACHINE"] = "拆解机"
L["SEARCH_BOX"] = "搜索框"
L["SEARCH_EVERYWHERE"] = "全局搜索"
L["SEARCH_EVERYWHERE_TOOLTIP_TEXT_2"] = "搜索结果将输出到聊天框中。"
L["SEARCH_HELP"] = "搜索帮助"
L["SEARCH_TRY_X"] = "搜索，试试 %s"
L["SECTION_CRAFTING"] = "制造"
L["SECTION_EQUIPMENT"] = "装备"
L["SELLJUNK"] = "出售垃圾"
L["SHIFT_CLICK_TO_TRACK_UNTRACK"] = "<Shift+点击 追踪/取消追踪>"
L["SHIFT_CLICK_TO_VENDOR_ALL"] = "<按住 Shift 可绕过限制>"
L["SHOW_ADD_BUTTONS"] = "显示添加按钮"
L["SHOW_BUTTONS"] = "显示按钮"
L["SHOW_IN"] = "显示于"
L["SHOW_NAME_PREFIX"] = "显示名称前缀"
L["SHOW_SORT_BUTTON"] = "显示排序按钮"
L["SHOW_TRANSFERABLE_ONLY"] = "仅显示可转移物品"
L["SINGLE_BAG"] = "单背包"
L["SINGLE_BAG_DESCRIPTION_2"] = "按栏位排列物品。将所有物品放在一个大背包中。"
L["SLASH_CATEGORIES"] = "分类"
L["SLASH_CATEGORIES_HELP"] = "在鼠标提示中显示匹配或不匹配物品的分类。"
L["SLASH_HELP"] = "打开 Baganator 设置。"
L["SLASH_KEYWORDS"] = "关键词"
L["SLASH_KEYWORDS_HELP"] = "在鼠标提示中显示匹配的关键词。"
L["SLASH_REMOVEUNUSEDCATEGORIES"] = "删除未使用的分类"
L["SLASH_REMOVEUNUSEDCATEGORIES_HELP"] = "删除当前未使用的任何分类。"
L["SLASH_RESET"] = "重置"
L["SLASH_RESET_HELP"] = "重置所有 Baganator 设置，然后重新加载。"
L["SLASH_RESETCATEGORIES"] = "重置分类"
L["SLASH_RESETCATEGORIES_HELP"] = "将分类设置重置为默认值，然后重新加载界面。"
L["SLASH_SEARCH"] = "搜索"
L["SLASH_SEARCH_EXTENDED"] = "搜索 [文本]"
L["SLASH_SEARCH_HELP"] = "打开背包并进行搜索。"
L["SLASH_SWAP"] = "切换"
L["SLASH_SWAP_HELP"] = "在分类布局和单背包布局之间切换。"
L["SLASH_UNKNOWN_COMMAND"] = "未知命令 '%s'"
L["SLOT"] = "栏位"
L["SOCKET_INTERFACE"] = "插槽界面"
L["SORT"] = "排序"
L["SORT_METHOD_2"] = "排序方式"
L["SORT_METHOD_RESET_FOR_CATEGORIES"] = "排序方式已重置以配合分类使用"
L["SORT_ON_OPEN"] = "打开时排序"
L["SORTBAGS"] = "SortBags"
L["SORTING"] = "排序中"
L["SOUL"] = "灵魂"
L["SQUARE_ICONS"] = "方形图标"
L["SYNDICATOR_ENABLE_MESSAGE"] = "使用 Baganator 需要 |cffd1b219Syndicator|r 插件。"
L["SYNDICATOR_INSTALL_MESSAGE"] = "请使用curseforge插件网站/客户端安装 |cffd1b219Syndicator|r 以使用 Baganator。"
L["TAB_INFO"] = "标签页信息"
L["TAB_LOGS"] = "标签页记录"
L["THAT_ITEM_IS_EQUIPPED"] = "该物品已装备"
L["THAT_ITEM_IS_IN_A_MAILBOX"] = "该物品在邮箱中"
L["THAT_ITEM_IS_IN_VOID_STORAGE"] = "该物品在虚空仓库"
L["THAT_ITEM_IS_LISTED_ON_THE_AUCTION_HOUSE"] = "该物品已在拍卖行上架"
L["THE_MERCHANT_DOESNT_WANT_ANY_OF_THOSE_ITEMS"] = "商人不需要这些物品"
L["THEME"] = "主题"
L["THEMES"] = "主题"
L["TIPS_PLUGINS"] = "通过与 AllTheThings、CanIMogIt、Pawn、Dejunk 等流行插件集成，为 Baganator 带来更多功能..."
L["TIPS_SEARCH"] = "强大、灵活且快速。使用灵活的查询运算符 &（与）、|（或）和 !（非）来精确找到您需要的物品。"
L["TIPS_THEMES"] = "通过 ElvUI 和 GW2 的自动主题或简单的暗色选项，让 Baganator 与您的界面风格匹配。"
L["TIPS_TRANSFER"] = "搜索物品，然后使用转移按钮轻松将它们转移到银行、邮件、交易窗口或商人处。"
L["TL"] = "可交易"
...
L["TRANSFER"] = "转移"
L["TRANSFER_BANK_VIEW_TOOLTIP_TEXT"] = "将搜索到的物品从银行转移到背包中。"
L["TRANSFER_GUILD_VIEW_TOOLTIP_TEXT"] = "将搜索到的物品从公会银行转移到背包中。\\n\\n由于公会银行本身较慢，转移速度会较慢。"
L["TRANSFER_MAIN_VIEW_BANK_TOOLTIP_TEXT"] = "将搜索到的物品从背包转移到银行中。"
L["TRANSFER_MAIN_VIEW_GUILD_TOOLTIP_TEXT"] = "将搜索到的物品从背包转移到公会银行中。\\n\\n由于公会银行本身较慢，转移速度会较慢。"
L["TRANSFER_MAIN_VIEW_MAIL_TOOLTIP_TEXT"] = "将搜索到的物品附加到邮件中发送。"
L["TRANSFER_MAIN_VIEW_SCRAPPER_TOOLTIP_TEXT"] = "将可拆解物品放入拆解机内。"
L["TRANSFER_MAIN_VIEW_TRADE_TOOLTIP_TEXT"] = "将搜索到的物品添加到交易窗口（最多6件）。"
L["TRANSFER_MAIN_VIEW_VENDOR_TOOLTIP_TEXT"] = "将搜索到的物品出售给商人；\\n限制6件，按住 Shift 可绕过限制。"
L["TRANSPARENCY"] = "透明度"
L["TYPE"] = "类型"
L["UNLIMITED"] = "无限制"
L["UPGRADE_DETECTION"] = "升级检测"
L["UPGRADE_TRACK"] = "升级路线"
L["USE_DEFAULT"] = "使用默认"
...
L["WARBAND"] = "战团"
L["WARBAND_BANK"] = "战团银行"
L["WARBAND_BANK_COLUMNS"] = "战团银行列数"
L["WARBAND_BANK_DATA_MISSING_HINT"] = "缺少战团银行数据。使用任意角色访问银行以填充此视图。"
L["WARBAND_BANK_NOT_PURCHASED_HINT"] = "战团银行空间未购买。请使用右侧的新标签页按钮购买"
L["WARBAND_BANK_TEMPORARILY_DISABLED_HINT"] = "战团银行已被暴雪暂时禁用。"
L["WARBOUND_ONLY"] = "仅战团"
L["WARBOUND_UNTIL_EQUIPPED"] = "装备前战团绑定"
L["WELCOME_DESCRIPTION"] = "选择您想要的背包类型。这可以在之后更改。"
