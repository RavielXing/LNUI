...
L["Filter DND characters."] = "過濾忙碌角色."
...
L["Modes"] = "模式"
L["Monster"] = "怪物"
L["Mute Already In Group SE"] = "靜音已在隊伍中音效"
L["Mute the sound effect that alerts you when you are already in a group."] = "靜音當你已經在隊伍系統提示音效."
L["NGA.cn"] = "NGA 玩家社區"
L["NetEase Message"] = "網易訊息"
...
L["The change will not take effect until you apply it!"] = "不套用設定, 過濾可能不會生效!"
...
L["You can whisper the player once to add him/her to the whitelist temporarily."] = "你可以密語該玩家一次來暫時將其加入白名單."
