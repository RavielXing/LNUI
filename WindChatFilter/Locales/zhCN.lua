...
L["The change will not take effect until you apply it!"] = "不应用设置,过滤可能不会生效!"
...
L["You can whisper the player once to add him/her to the whitelist temporarily."] = "你可以密语该玩家一次来临时添加其到白名单."
