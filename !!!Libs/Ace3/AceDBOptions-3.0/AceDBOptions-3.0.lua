...
-- @release $Id: AceDBOptions-3.0.lua 1405 2026-09-03 02:03:09Z funkehdude $
...
local L = {
	...
	name_too_long = "Profile names cannot be longer than 30 characters!",
	new = "New",
...
if LOCALE == "deDE" then
	...
	L["name_too_long"] = "Profilnamen können nicht länger als 30 Zeichen sein!"
	L["new"] = "Neu"
...
elseif LOCALE == "frFR" then
	...
	L["name_too_long"] = "Les noms de profil ne peuvent pas dépasser 30 caractères!"
	L["new"] = "Nouveau"
...
elseif LOCALE == "koKR" then
	...
	L["name_too_long"] = "프로필 이름은 30자리를 초과할 수 없습니다!"
	L["new"] = "새로운 프로필"
...
elseif LOCALE == "esES" or LOCALE == "esMX" then
	...
	L["name_too_long"] = "Los nombres de perfil no pueden exceder los 30 caracteres!"
	L["new"] = "Nuevo"
...
elseif LOCALE == "zhTW" then
	...
	L["name_too_long"] = "設定檔名稱不能超過30個字元!"
	L["new"] = "新建"
	L["new_sub"] = "新建一個空的設定檔。"
	L["profiles"] = "設定檔"
...
elseif LOCALE == "zhCN" then
	...
	L["name_too_long"] = "配置文件名称不能超过30个字符!"
	L["new"] = "新建"
...
elseif LOCALE == "ruRU" then
	...
	L["name_too_long"] = "Имена профилей не могут превышать 30 символов!"
	L["new"] = "Новый"
...
elseif LOCALE == "itIT" then
	...
	L["name_too_long"] = "Il nome del profilo non può superare i 30 caratteri!"
	L["new"] = "Nuovo"
...
elseif LOCALE == "ptBR" then
	...
	L["name_too_long"] = "O nome do perfil não pode exceder 30 caracteres!"
	L["new"] = "Novo"
...
local optionsTable = {
	...
	new = {
		...
		validate = function(_, text)
			...
			if length > 30 or length == 0 or text:find("^ +$") then
				return false
			end
			return true
		end,
