...
WorldQuestTracker.MapData.QuestTypeIcons = {
	...
	[WQT_QUESTTYPE_REPUTATION] = {name = "名望", icon = [[Interface\ICONS\Achievement_Reputation_01]], coords = {5/64, 59/64, 5/64, 59/64}},--lnui
	[WQT_QUESTTYPE_RACING] = {name = "竞速", icon = [[Interface\AddOns\WorldQuestTracker\media\icon_racing_nobackground]], coords = {0, 1, 0, 1}},--lnui
}
