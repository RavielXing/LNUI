...
-- ---------------------------------------------------------------------------------------------------------------------------------
	...
	local extraChoices = { ns.colour.plaintext ..ns.L[ "Symbol" ] .." ^ " ..ns.L[ "Blue" ],
				...
				ns.colour.plaintext ..ns.L[ "Fire" ] .." V " ..ns.L[ "Arcane" ],
				ns.colour.plaintext ..ns.L[ "Fire" ] .." V " ..ns.L[ "Blood" ],
				ns.colour.plaintext ..ns.L[ "Fire" ] .." V " ..ns.L[ "Fel" ],
				ns.colour.plaintext ..ns.L[ "Fire" ] .." V " ..ns.L[ "Frost" ],
				ns.colour.plaintext ..ns.L[ "Fire" ] .." V " ..ns.L[ "Nature" ],
				ns.colour.plaintext ..ns.L[ "Fire" ] .." V " ..ns.L[ "Flower" ],
				ns.colour.plaintext ..ns.L[ "Fire" ] .." V " ..ns.L[ "Potion" ] }
