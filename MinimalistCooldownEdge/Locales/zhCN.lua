...
L["MINIAURAS_DESC"] = "MiniAuras 冷却图标的专用样式。加载 MiniAuras 时，可支持其控制效果图标、姓名板、头像和覆盖层模块。"
...
L["DYNAMIC_COLORS_GENERAL_DESC"] = "将剩余时间阈值应用到启用中的 MiniCE 分类。即使 Blizzard 提供的是隐藏数值，跨越午夜时也能安全处理持续时间。"
