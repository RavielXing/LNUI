...
L["Applies to MiniCC Enemy CDs in both Arena Frames and Linear Bar layouts."] = true
...
L["Healer Warning Color"] = true
L["Changes the MiniCC 'Healer in CC!' warning text color."] = true
