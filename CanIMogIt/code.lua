...
local simpleTextMap = {
    ...
    [CanIMogIt.KNOWN_BY_ANOTHER_CHARACTER_WARBOUND] = CanIMogIt.KNOWN_WARBOUND,
    ...
    [CanIMogIt.KNOWN_FROM_ANOTHER_ITEM_AND_CHARACTER_WARBOUND] = CanIMogIt.KNOWN_FROM_ANOTHER_ITEM_WARBOUND,
}
...
local knownTexts = {
    ...
    [CanIMogIt.KNOWN_BY_ANOTHER_CHARACTER_WARBOUND] = true,
...
function CanIMogIt:IsReadyForCalculations(itemLink)
    ...
    if C_Item.GetItemInfo(itemLink)
        ...
        or CanIMogIt:IsItemPet(itemLink) then
        return true
    end
    return false
end
