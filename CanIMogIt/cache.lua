...
CanIMogIt.eventFrame:AddSmartEvent(OnClearCacheEvent, {"TRANSMOG_COLLECTION_UPDATED"})
...
CanIMogIt.eventFrame:AddSmartEvent(OnClearBindCacheEvent, {"ITEM_LOCK_CHANGED"})
