...
L["DONATE"] = "赞助"
L["DUE_TO_AURA_BARS_CHANGING_RELOAD_REQUIRED"] = "由于光环条变更，需重载才能使 Coolinator 正常工作"
L["EDIT_THE_ICONS_AND_BARS_ONSCREEN"] = "点击屏幕上的图标和进度条即可编辑"
L["ENABLE"] = "启用"
