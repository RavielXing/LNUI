...
local settings = {
  ...
  NUMBER_FONT = {key = "number_font", default = {asset = addonTable.Constants.DefaultFont, flags = {outline = true, shadow = true, slug = true}, size = 0.8}, refresh = {addonTable.Constants.RefreshReason.Design}},--lnui
