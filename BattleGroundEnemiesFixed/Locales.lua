...
Data.L = setmetatable({}, { --key set by all non english clients, Table gets accessed to read translations
  __index = function(t, k) -- t is the normal table (no metatable)
    if defaultLocale[k] then
      if gameLocale ~= "enUS" and not missingReported then
        C_Timer.After(3, function()
          BattleGroundEnemies:OnetimeInformation(
            -- "Missing localizations for your ingame language. You can help translating this addon on https://www.curseforge.com/wow/addons/battlegroundenemies/localization"
          )
        end)
      ...
      C_Timer.After(3, function()
        BattleGroundEnemies:OnetimeDebug(
          -- "Missing localization entry for['" .. k .. "']. Please report this to the addon author."
        )
      end)
      return k
    end
...
L["AttachToObject_Desc"] =
  "Note that not every object might be possible to select, depending on your positioning of the other frames. For example if you anchor the pvp talents at the racials and you are trying to anchor the racials at the pvp talents there will be a error message."
...
L["Auras_CustomFiltering_ConditionsMode_Desc"] =
  [=[Here you can choose how the selected conditions should apply to the auras.
...
L["Auras_Enabled_Desc"] =
  "When enabled there will be aura icons. There will also be a number for the remaining time and one for the stacks applied"
...
L["AurasFiltering_AddSpellID_Desc"] =
  "Enter a spellID or multiple comma-seperated spellIDs. The spellIDs are getting added to your filter list. Only auras whose spellID is on the filter list are getting shown when the spellID filtering is enabled."
L["AurasFiltering_Enabled_Desc"] =
  "When this option is enabled you will only see %s which you added to the filtering list"
...
L["BarHeight_Desc"] =
  "The height of each row. This setting is not available in combat due to Blizzard's combat protection."
...
L["Coloring_Enabled_Desc"] =
  "When this option is enabled you can choose whether the frame's border or the countdown text should be colored by debuff type (Like its know from the default UI, poisons are green, diseases blue etc.)"
L["Columns"] = "Columns"
...
L["CopySettingsMirrored_Desc"] =
  'Mirrored meaning that all of the position and expanding direction of modules get replaced by the horizontally opposite point or direction. (For example point "TOPLEFT" becomes "TOPRIGHT" and container modules like the aura module will grow the opposite direction)'
...
L["DebuffType_Filtering_Desc"] =
  "When this option is enabled you will only see debuffs of the chose typ. This option is not simulated in the test mode since this would require a huge database with tons of spells and their debuff type."
...
L["DisableArenaFramesInBattleground_Desc"] =
  "Disables the Arenaframes in a battleground. Also works when sArena is installed"
L["Disease"] = "Disease"
...
L["DrTracking_DisplayType_Desc"] =
  "Here you can choose if the status of the DR should be indicated by a colored frame around the icon or by the textcolor of the countdown text. Note that the Countdown text setting will only work if you aren't using an addon like OmniCC that modifys the textcolor."
L["DrTracking_Enabled"] = "Enable DR Tracking"
L["DrTracking_Enabled_Desc"] =
  "When enabled there will be icons for DR Tracking next to the enemy row. Green Border: Next CC will be half duration. Yellow Border: Next CC will be quarter duration. Red Border: Next CC will not apply because the player is immune"
L["DrTracking_Spacing"] = "DR Spacing"
L["DrTracking_Spacing_Desc"] = "The spacing between each DR icon"
L["DrTrackingFiltering_Enabled_Desc"] =
  "When this option is enabled you will only see icons of spells whose category is checked on the filtering list."
...
L["DrTracking_ShowDRCount"] = "Show DR Count"
L["DrTracking_ShowDRCount_Desc"] = "Show the diminishing returns counter (1/2, 2/2) on the icon"
...
L["EnableCustomDRCategoryIcons_Desc"] =
  "when enabled you can choose your own icon for each of the diminishing return categories"
L["EnableCustomPlayerCountProfiles"] = "Enable custom profiles for player count"
L["EnableCustomPlayerCountProfiles_Desc"] =
  "When this option is enabled you will be able to create your own profiles based on player size. The current used profiles for 1–5, 6–15 and 16-40 players won't be lost but disabled and you can use them as a baseline to create your own profiles. You can switch back whenever you want without losing any settings."
L["EnableInArenas"] = "Enable in Arenas"
L["EnableInBattlegrounds"] = "Enable in Battlegrounds"
L["enemies"] = "enemies"
L["Enemies"] = "Enemies"
L["EnemiesTargetingAllies_Enabled_Desc"] =
  "When you enable this option you will be notified by a sound when a set amount of enemys are targeting an ally"
L["EnemiesTargetingMe_Enabled_Desc"] =
  "When you enable this option you will be notified by a sound when a set amount of enemys are targeting you "
L["enemy"] = "enemy"
L["Enemy"] = "Enemy"
...
L["FontShadow_Enabled_Desc"] =
  "When enabled there will be a shadow around the font. You can choose the color of that shadow"
L["FontShadowColor"] = "Shadow color"
L["FontShadowColor_Desc"] = "The color of the text shadow"
L["ShadowOffsetX"] = "Shadow offset X"
L["ShadowOffsetX_Desc"] = "Horizontal offset of the text shadow"
L["ShadowOffsetY"] = "Shadow offset Y"
L["ShadowOffsetY_Desc"] = "Vertical offset of the text shadow"
...
L["Framescale"] = "Scale"
L["Framescale_Desc"] =
  "The scale of the mainframe. This setting is not available in combat due to Blizzard's combat protection."
L["General"] = "General"
...
L["HealthTextSettings"] = "Healthtext"
L["HealthTextType"] = "Health text type"
L["Height"] = "Height"
L["HideArenaframesIn"] = "Hide arena frames in"
L["HideHighestPriority"] = "Hide highest priority"
L["HideHighestPriority_Desc"] =
  "When enabled, it removes the aura with the highest priority, useful when the highest priority is already shown on the spec or class icon."
...
L["MouseWheelPlayerTargeting_Desc"] =
  "When this option is enabled you will be able to move your mouse over the enemy or ally frames and scroll to target the next or previous player in the list. Please be aware that this can interfere when you are using mouseover casting."
L["MyFocus"] = "My Focus"
...
L["Notifications_Allies_Enabled_Desc"] =
  "When enabled you will be notified when an ally is leaving or joining the battleground."
L["Notifications_Enabled"] = "Enable Notifications"
L["Notifications_Enemies_Enabled_Desc"] =
  "When enabled you will be notified when an enemy is leaving or joining the battleground."
...
L["ObjectiveAndRespawn_ObjectiveEnabled_Desc"] =
  "Shows in icon for flag, minecart and orb-carriers next to the enemy button"
L["ObjectiveAndRespawn_Position"] = "Position"
L["ObjectiveAndRespawn_Position_Desc"] =
  "If the icon should be shown left to the spec icon or right to the trinket/racial icons."
L["ObjectiveAndRespawn_RespawnEnabled"] = "Enable Respawn Timer"
L["ObjectiveAndRespawn_RespawnEnabled_Desc"] =
  "When enabled there will be an icon indicating the remaining time until the enemy is alive."
...
L["OverwriteMirroredConfirm"] =
  "Are you sure you want to overwrite the settings for %s with the mirrored settings of %s"
...
L["PlayerCount_Enabled_Desc"] =
  "If there should a text for the current number of players. Note that this count can be different than the current number of rows shown due to combat protection or leaving allies/enemies in a RBG"
L["players"] = "players"
L["Point"] = "Point"
...
L["PowerBar_Height_Desc"] =
  "The heigt of the ressource bar. Making the ressource bar higher will automatically make the health bar shorter"
...
L["RacialFiltering_Enabled_Desc"] =
  "When this option is enabled you will only see racials which are checked on the filtering list."
...
L["RangeIndicator_Enabled_Desc"] =
  "When tis option is enabled the frame will use the chosen alpha when an enemy is out of a chosen range"
L["RangeIndicator_Everything"] = "Modify the alpha of all elements"
L["RangeIndicator_Frames"] = "Modify alpha of"
L["RangeIndicator_Frames_Desc"] =
  "Set which parts of the enemy row should be shown with a higher transparency when the enemy is out of range."
L["RangeIndicator_Range"] = "Range"
L["RangeIndicator_Range_Desc"] =
  "If a player is farther than this distance (yards), their frame will use the chosen alpha. Range checks in combat can only use spells, so if your class has none for friendly targets, no range indicator will appear."
L["RangeIndicator_Range_InCombat"] = "Range in combat"
L["RangeIndicator_Range_OutOfCombat"] = "Range out of Combat"
...
L["ShowHighestPriority_Desc"] =
  "When enabled the addon will show an if the player got interruped or is affected by a priority aura"
L["ShowMine"] = "Show mine"
L["ShowMine_Desc"] = "Show %s that i applied"
L["ShowNumbers"] = "Show numbers"
L["ShowNumbers_Desc"] =
  "Show cooldown numbers, note that this option might not be working when you are using addons like OmniCC"
...
L["Spec_AuraDisplay_Enabled_Desc"] =
  "When this option is enabled you will see icons for crowd control and interrupts (when active) instead of the spec icon"
...
L["SpecClassPriority"] = "SpecClassPriority"
...
L["RaidTargetIcon"] = "Raid Target Icons"
L["CombatIndicator"] = "Combat Indicator"
L["TargetAmount"] = "target amount"
L["TargetAmount_Ally"] =
  "The sound is played as soon as a group member is targeted by more than the set number of opponents."
...
L["TargetCallingNotificationEnable_Desc"] =
  "Notifies you when there is a new target (detected via the raid target skull icon)"
L["TargetCallingSetMark"] = "Mark my target with skull icon"
L["TargetCallingSetMark_Desc"] =
  "Marks your current target automatically with the skull icon when you are the raid leader and there is no raid assistent in your group. It will also mark your curent target if you are not the raid leader but you are a assistant."
L["TargetCallingShowIcon"] = "Show icon on target caller's target"
L["TargetCallingShowIcon_Desc"] =
  "When enabled, you will see a icon on the frame which shows the target of the target caller"
...
L["TargetIndicatorNumeric_HideWhenZero_Desc"] =
  "When enabled, it will hide the text if no enemy is targeting that player."
...
L["Testmode_Toggle_Desc"] =
  [=[Enables/Disables the testing mode. This mode makes it easier to see what impact most of the options have. Its not possible to simulate all options but most of them are covered in this fancy test mode.
The test mode is disabled if you are currently in a battleground.]=]
L["Testmode_ToggleAnimation"] = "Toggle test mode animation"
L["Testmode_ToggleAnimation_Desc"] =
  "Enables/Disables the animation of the testmode so you can focus more on a specific setting without getting distracted by the animation."
...
L["UpdatePeriod_Desc"] =
  "The time between combat checks in seconds, dont put this too low because this can potentially cause performance issues."
L["Upwards"] = "Upwards"
L["UseBarHeight"] = "Use bar height"
L["UseBigDebuffsPriority"] = "Use BigDebuffs priorities"
L["UseBigDebuffsPriority_Desc"] =
...
if LOCALE_zhCN then
  ...
  L["AttachToObject_Desc"] =
    "请注意，并不是每个目标都可以选择，这取决于其他框架设置的定位。例如，你降锚点选择在种族技能或者天赋上时，将会有错误信息提示你。"
  ...
  L["Auras_CustomFiltering_ConditionsMode_Desc"] =
    "你可以在此处设置所选条件应如何应用于光环。如果设为“任意符合”，插件会显示满足任何一个条件的光环。如果设为“全部符合”，插件仅显示满足所有条件的光环。"
  L["Auras_Debuffs_Container_Color_Desc"] = "减益效果图标区域的外框颜色"
  L["Auras_Enabled"] = "开启光环"
  L["Auras_Enabled_Desc"] =
    "启用时，会显示你在敌方身上的所有光环图标，同时会显示剩余时间和堆叠层数"
  ...
  L["AurasFiltering_AddSpellID_Desc"] =
    "输入一个或多个想要加入到过滤列表的法术ID，使用逗号來分离。启用过滤时，只会显示在列表中法术ID的光环图标。"
  ...
  L["Coloring_Enabled_Desc"] =
    "启用时，可以选择框架边框或倒计时文本是否要通过减益效果的类型显示颜色（和默认界面一致，中毒是绿色，疾病是蓝色等等）"
  L["Columns"] = "纵列"
  ...
  L["Cooldown"] = "冷却"
  L["CopyFrom"] = "复制自"
  L["CopySettings"] = "复制设置，从"
  L["CopySettingsMirrored_Desc"] =
    "镜像表示这个模块的位置和生长方向都被替换为水平反转的位置和方向。（例如，“左上”会变为“右上”；类似光环模块的容器类模块会以反方向生长。）"
...
注意宏最长只能使用 255 个字符(包阔替换的名字)。]=]
  ...
  L["DebuffType_Filtering_Desc"] =
    "如果启用此选项，将只看到所选择类型的减益效果。测试模式中无法模拟这个选项，因为这需要一个庞大的法术和减益效果数据库。"
  ...
  L["DrTracking_DisplayType_Desc"] =
    "这里你可以选择控制递减状态是由图标边框颜色显示或者倒计时文本显示，请注意，倒计时文本计时只能使用一个插件如果你使用omnicc请关闭计时数字."
  L["DrTracking_Enabled"] = "开启控制递减监视"
  L["DrTracking_Enabled_Desc"] =
    "当此选项启用时，会在敌方横列边上显示控制技能递减的图标。绿色边框：下一个控制技能持续一半时间。黄色边框：下一个控制技能持续四分之一时间。红色边框：下一个控制技能无效，因为玩家已经免疫。"
  L["DrTracking_Spacing"] = "控制递减间距"
  L["DrTracking_Spacing_Desc"] = "控制递减图标之间的距离。"
  L["DrTrackingFiltering_Enabled_Desc"] =
    "当此选项启用时，你只会看到在过滤列表中选中的法术图标."
  ...
  L["DrTracking_ShowDRCount"] = "显示递减计数器"
  L["DrTracking_ShowDRCount_Desc"] = "在图标上显示递减计数器（1/2、2/2）"
  ...
  L["EnableCustomPlayerCountProfiles_Desc"] =
    "当此选项开启时，你可以自定义基于玩家数量的配置文件。当前使用的1-5，6-15和16-40的配置文件会被禁用而不会丢失。你可以使用它们作为你自定义的配置文件的基准。你可以随时切换回来，而不会丢失任何设置。"
  L["EnableInArenas"] = "在竞技场中开启"
  L["EnableInBattlegrounds"] = "在战场中开启"
  L["enemies"] = "敌方"
  L["Enemies"] = "敌方"
  L["EnemiesTargetingAllies_Enabled_Desc"] =
    "启用此选项时，当设定数量的敌人选中一个队友时，你会收到声音通知"
  L["EnemiesTargetingMe_Enabled_Desc"] =
    "启用此选项时，当设定数量的敌人选中你时，你会收到声音通知"
  L["enemy"] = "敌方"
  L["Enemy"] = "敌方"
  ...
  L["Framescale"] = "缩放大小"
  L["Framescale_Desc"] =
    "主要框架的縮放大小。由于暴雪的战斗保护，此设置无法在战斗中使用。"
  L["General"] = "常规"
  ...
  L["HideHighestPriority_Desc"] =
    "开启时，最高优先级的光环会被移除。当职业或专精图标已经显示最高优先级光环时，这个功能有作用。"
  ...
  L["MouseWheelPlayerTargeting_Desc"] =
    "开启这个选项时，你可以移动你的鼠标指针到敌方或者友方框体上，然后滚动滚轮以选择列表上的下一个或者上一个玩家。请注意，当您使用鼠标指向施法时，这可能会产生干扰。"
  L["MyFocus"] = "我的焦点"
  ...
  L["PlayerCount"] = "玩家数量"
  L["PlayerCount_Enabled_Desc"] =
    "是否要显示当前玩家数量。请注意，这个数量可能会和当前列表显示不同，因为插件在战斗中保护功能及有人离开随机战场。"
  L["players"] = "玩家"
  L["Point"] = "点"
  L["PointAtObject"] = "目标点"
  L["Poison"] = "中毒"
  ...
  L["RangeIndicator_Range_Desc"] =
    "敌人在这个距离范围以外时，敌方框架会显示成指定的透明度。"
  L["RangeIndicator_Range_InCombat"] = "战斗中距离"
  L["RangeIndicator_Range_OutOfCombat"] = "战斗外距离"
  ...
  L["ShowHighestPriority_Desc"] =
    "开启时，插件会在玩家被打断或者被一个优先级光环影响时显示其图标"
  L["ShowMine"] = "只显示自己的"
  L["ShowMine_Desc"] = "只显示自己施放的%s"
  L["ShowNumbers"] = "显示数字"
  L["ShowNumbers_Desc"] =
    "显示冷却计时，请注意，当你使用 OmniCC 等插件时，此选项可能不起作用"
  ...
  L["Spec_AuraDisplay_Enabled_Desc"] =
    "启用此选项后，将会在专精图标上显示控制技能和打断技能图标（当控制技能在目标身上时）"
  L["Spec_Enabled"] = "开启专精"
  ...
  L["TargetCallingSetMark_Desc"] =
    "当你是团队领袖且没有团队助理时，会自动使用骷髅图标来标记当前目标。如果你不是团队领袖而是助理，也会标记你当前的目标。"
  ...
  L["Testmode_Toggle_Desc"] =
    [=[启用/禁用测试模式，这种模式使你更容易看到大多数选项功能。模拟所有选项是不可能的，但大多数设置选项均已在这个测试模式中。
当你在战场中时，测试模式将会被禁用。]=]
  L["Testmode_ToggleAnimation"] = "测试模式动画"
  L["Testmode_ToggleAnimation_Desc"] =
    "开启/禁用测试模式的动画，使你可以更专注于特定的设置而不受动画影响."
  ...
  L["UpdatePeriod"] = "更新间隔"
  L["UpdatePeriod_Desc"] =
    "检查进出战斗时间，不要设置太低，因为这可能会导致游戏内性能问题。"
  L["Upwards"] = "向上"
...
elseif LOCALE_zhTW then
  ...
  L["AttachToObject_Desc"] =
    "請注意，並不是每個物件都可以選擇，會依據和其他框架的相對位置而定。例如，如果已經將 PVP 天賦對齊到種族技能，而又嘗試將種族技能對齊到 PVP 天賦時，會出現錯誤訊息。"
  ...
  L["Auras_CustomFiltering_ConditionsMode_Desc"] =
    '在這裡可以選擇，所選的條件要如何套用到光環。選擇 "任何" 時，只要符合任一條件就會顯示光環。選擇 "全部" 時，只有符合全部的條件才會顯示光環。'
  L["Auras_Debuffs_Container_Color_Desc"] = "減益效果圖示區域的外框顏色。"
  L["Auras_Enabled"] = "啟用光環"
  L["Auras_Enabled_Desc"] =
    "啟用時，會顯示光環圖示，同時也會顯示剩餘時間和堆疊層數的數字。"
  ...
  L["AurasFiltering_AddSpellID_Desc"] =
    "輸入一個或多個要加入到過濾清單的法術 ID，使用逗號來分隔。啟用過濾時，只會顯示法術 ID 在清單內的光環。"
  ...
  L["Coloring_Enabled_Desc"] =
    "啟用時，可以選擇框架邊框或倒數文字是否要依據減益效果的類型來顯示顏色 (和預設介面相同，中毒是綠色、疾病是藍色...等等)。"
  L["Columns"] = "直行"
  ...
  L["CopySettingsMirrored_Desc"] =
    '鏡像意味著模組的所有位置和延伸方向都被水平相反的點或方向取代。 (例如 "TOPLEFT" 點變為 "TOPRIGHT"，並且像光環模組這樣的容器模組將向相反方向延伸）'
...
請注意，巨集最長只能使用 255 個字元(包含替換後的敵人名字)。]=]
  ...
  L["DebuffType_Filtering_Desc"] =
    "啟用時，只會看所選類型的減益效果。測試模式中不會模擬這個選項，因為需要龐大的資料庫才能模擬出魔獸海量的法術和減益效果類型。"
  ...
  L["DrTracking_DisplayType_Desc"] =
    "選擇控場追蹤的指示要使用圖示周圍的彩色外框，還是彩色的倒數文字。請注意，沒有使用像是 OmniCC 這類型會更改文字顏色的插件時，彩色的倒數文字才能正常運作。"
  L["DrTracking_Enabled"] = "啟用控場追蹤"
  L["DrTracking_Enabled_Desc"] =
    "啟用時會在敵方的橫列旁顯示控場效果遞減的監控圖示。綠色邊框：下一個控場技能時間減半，黃色邊框：下一個控場技能時間只有四分之一，紅色邊框：下一個控場技能無效，因為玩家已經免疫。"
  L["DrTracking_Spacing"] = "控場追蹤間距"
  L["DrTracking_Spacing_Desc"] = "控場追蹤圖示之間的距離。"
  L["DrTrackingFiltering_Enabled_Desc"] =
    "啟用時，只會看到過濾清單中所勾選的類別中的法術圖示。"
  ...
  L["DrTracking_ShowDRCount"] = "顯示控場計數器"
  L["DrTracking_ShowDRCount_Desc"] = "在圖示上顯示遞減效果計數器（1/2、2/2）"
  ...
  L["EnableCustomPlayerCountProfiles_Desc"] =
    "啟用此選項時，能夠根據玩家數量建立自訂設定檔。目前使用的1-5人、6-15人和16-40人的設定檔仍會保留，但會被停用，可以將它們作為建立自訂設定檔的基礎。可以隨時切換回去而不會遺失任何設定。"
  L["EnableInArenas"] = "競技場中啟用"
  L["EnableInBattlegrounds"] = "戰場中啟用"
  L["enemies"] = "敵方"
  L["Enemies"] = "敵方"
  L["EnemiesTargetingAllies_Enabled_Desc"] =
    "啟用時，當一票敵人的目標是我方時，會播放通知音效。"
  ...
  L["HideHighestPriority_Desc"] =
    "啟用時，會移除最高優先順序的光環。當高優先順序的光環已經顯示在專精或職業圖示上時很有用。"
  ...
  L["MouseWheelPlayerTargeting_Desc"] =
    "啟用時，可以將滑鼠移動到敵方或友方框架上，並滾動滾輪來選取清單中的下一個或上一個玩家。請注意，當您使用滑鼠指向施法時，可能會產生干擾。"
  L["MyFocus"] = "我的專注目標"
  ...
  L["ObjectiveAndRespawn_ObjectiveEnabled_Desc"] =
    "在敵方按鈕旁顯示旗幟、礦車、或攜帶異能球圖示。"
  L["ObjectiveAndRespawn_Position"] = "位置"
  L["ObjectiveAndRespawn_Position_Desc"] =
    "圖示要顯示在專精圖示的左側，或是飾品/種族技能圖示的右側。"
  ...
  L["Spec_AuraDisplay_Enabled_Desc"] =
    "啟用時，會顯示群體控場和斷法技能的圖示 (有啟用時)，取代專精圖示。"
  L["Spec_Enabled"] = "啟用專精"
  ...
  L["TargetCallingSetMark_Desc"] =
    "當你是團隊隊長，而且隊中沒有團隊助理時，自動將你的當前目標標記骷髏圖示。當你不是隊長，但是助理時，也會上標記。"
  ...
  L["Testmode_Toggle_Desc"] =
    [=[啟用/停用測試模式，更容易觀察調整設定選項時的變化。無法模擬全部的選項效果，但在這個華麗的測試模式中，已經包含了絕大部分。

已經在戰場中時，會停用測試模式。]=]
  L["Testmode_ToggleAnimation"] = "切換測試動畫"
  L["Testmode_ToggleAnimation_Desc"] =
    "啟用/停用測試模式的動畫效果，以便能夠更專注於設定某個選項，而不會被動畫干擾。"
  ...
  L["UpdatePeriod"] = "更新間隔"
  L["UpdatePeriod_Desc"] =
    "多久檢查一次是否在戰鬥中，請不要輸入太低的數值，可能會導致影響遊戲效能問題。"
  L["Upwards"] = "向上"
  L["UseBarHeight"] = "使用橫列高度"
  L["UseBigDebuffsPriority"] = "使用 BigDebuffs 的優先順序"
  L["UseBigDebuffsPriority_Desc"] =
    "啟用此選項時，會改用來自大型控場圖示插件 BigDebuffs 的優先順序。優先順序會用於%s、%s 和%s模組。"
