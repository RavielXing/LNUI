...
local DATA = {
    {
        ...
        rows = {
            ...
            },
            {
                ...
                { id = {237369, 237367}, tag = "钝器" },
                { id = {237371, 237370}, tag = "利刃" },
                { id = {237373, 237372}, tag = "精细" },
            }
        }
    },
    {
        ...
        rows = {
            {
                ...
                { id = { 271887, 271886 }, tag = "全能" },
                { id = { 271890, 271889 }, tag = "暗伤" },
                { id = { 241296, 241297 }, tag = "伤害" },
                { id = { 241286, 241287 }, tag = "护盾" },
                { id = { 241292, 241293 }, tag = "主属" },
            },
            {
                { id = { 271884, 271883 }, tag = "生命" },
