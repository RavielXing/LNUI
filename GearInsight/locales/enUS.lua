...
GearInsight.LOC["enUS"] = {
    ...
    TALENT_IMPORT_OK2  = "Imported '%s', applying…",
...
do
    ...
    t["MT_TAB_MM"] = "M+ Intel"
    t["MT_TAB_TOOLS"] = "Advanced & Guides"
...
do
    ...
    t["NW_EFF_SHORT"] = "goes live on %s after your region's maintenance"
    t["NW_EFF_FULL"] = "Effective: %s (%s, after weekly maintenance) - other regions: %s"
    t["NW_EFF_TAG"] = "Upcoming"
    t["PN_FOLD_TIP"] = "Expand / collapse the full pull list"
    t["PN_META"] = "%d pulls · top %d runs, +%d"
    t["PN_MODE_KEY"] = "keystone"
    t["PN_MODE_MANUAL"] = "manual"
    t["PN_MODE_SIM"] = "simulated"
    t["PN_NEXT_TIP"] = "Next pull (Normal / Follower dungeons have no enemy-forces progress, flip by hand)"
    t["PN_NO_DATA"] = "No pull plan for this dungeon (only this season's 8 dungeons have one)."
    t["PN_OFF"] = "Pull navigator off (/gi nav on to re-enable)"
    t["PN_SIM_OFF"] = "Pull navigator simulation stopped."
    t["PN_SIM_ON"] = "Pull navigator simulation: advancing at 1/8 of the top players' pace (/gi nav sim again to stop)"
    t["PN_STAGE"] = "Pull %d / %d · progress %.1f%% · %s"
    t["PN_TIP_CLICK"] = "Click = make this the current pull"
    t["PN_TIP_HD"] = "Pull %d · %s · top players %ds · agreement %d%%"
    t["LY_MODE_ROT"] = "Rotation"
    t["LY_ROT_NOW_HD"] = "Press next · Blizzard's Assisted Combat (follows your current talents)"
    t["LY_ROT_NOW_NOTE"] = "Updates once you have a target / are in combat; key = what's bound on your bars (yellow = not bound yet, showing the addon's suggestion)"
    t["LY_ROT_LIST_HD"] = "Official rotation spells · %d · your key under each cell"
    t["LY_ROT_OPEN_HD"] = "Real openers from top players · WCL %s top %d · grey = your current talents don't have this spell"
    t["LY_ROT_RAID"] = "raid"
    t["LY_ROT_MPLUS"] = "Mythic+"
    t["LY_ROT_COACH_HD"] = "Coach notes · this spec"
    t["LY_ROT_NO_API"] = "This client has no Assisted Combat API (C_AssistedCombat); showing top openers and coach notes only."
    t["LY_ROT_NO_COACH"] = "No coach notes for this spec yet."
    t["LY_ROT_NEXT_IDLE"] = "(no target / not in combat)"
    t["LY_KEYS_BAD"] = "These keys were rejected by the game and not bound (click the cell and press again): "
    t["LY_TB_RESET"] = "Reset"
    t["LY_TB_NEXT"] = "assist"
    t["LY_TB_DONE"] = "Opener done - into the core rotation"
    t["LY_TB_TITLE_ASSIST"] = "Blizzard rotation assist"
    t["LY_ROT_PIN_ASSIST"] = "Pin to screen · assist only"
    t["LY_ROT_TAL_BTN"] = "Use their talents"
    t["LY_ROT_TAL_OK"] = "Switched to %s's talents (%s)"
    t["LY_ROT_TAL_FAIL"] = "Talent switch failed: "
    t["LY_ROT_TAL_TIP"] = "One click to copy %s's talents (hero talent %s) - imported as a new loadout named \"GI <name>\", your own loadouts are untouched"
    t["LY_ROT_TAL_NONE"] = "No build for this player in the talent library yet (added on the next data refresh)"
    t["LY_ROT_PIN_BTN"] = "Use this opener"
    t["LY_ROT_NO_OPEN"] = "no data"
    t["LY_ROT_ST_HD"] = "Single-target opener · top %d raid players · grey = your current talents don't have this spell"
    t["LY_ROT_AOE_HD"] = "AoE opener · first big pull, top %d Mythic+ players"
    t["LY_BADGE_TRINKET"] = "Tk"
    t["LY_BADGE_POTION"] = "Po"
    t["LY_TB_IDLE"] = "Target something attackable and this shows what to press"
    t["MT_TAB_TOOLS_TITLE"] = "Advanced & Guides"
    t["LY_TB_TITLE"] = "GI Rotation Assist"
    t["LY_TB_RESET_TIP"] = "Rewind the opener to step 1 (for practice; it also rewinds 6 s after leaving combat)"
    t["LY_KB_BTN"] = "Keyboard"
    t["LY_KB_BTN_TIP"] = "Open / close the virtual keyboard: what each key points at, which differ from the plan, whether WASD QE stay free for movement"
    t["LY_KB_HD"] = "Virtual keyboard · what every key on this layer points at"
    t["LY_KB_NOTE"] = "gold = a planned slot · red corner = current binding differs · grey = left for movement · dim text = used by another function"
    t["LY_KB_MOD_NONE"] = "No modifier"
    t["LY_KB_PLAN"] = "Planned: "
    t["LY_KB_NOW"] = "Now: "
    t["LY_KB_FREE"] = "Now: free"
    t["LY_KB_CLICK"] = "Click = rebind this slot"
    t["LY_KB_MOVE"] = "move"
    t["LY_KB_FOOT"] = "Click a key cap to rebind its slot; switch the Shift / Ctrl / Alt layer with the buttons above. Bare WASD / Space stay for movement; Q E follow the 'Use Q E too' option."
    t["LY_KB_MACRO_NEW"] = "(not created yet - it is built and placed when you click Apply suggestions to action bars)"
    t["LY_SPECIAL_TOOK"] = "%s pointed at slot %d, now given to \"%s\"; slot %d has no key"
    t["LY_SP_REPLY"] = "Reply whisper"
    t["LY_SP_REPLY_TIP"] = "Blizzard's native Reply: answer the latest whisper (default R)"
    t["LY_SP_PING"] = "Ping"
    t["LY_SP_PING_TIP"] = "Blizzard's native ping wheel: hold to mark a spot / focus / danger"
    t["LY_SP_HOW"] = "Click, then press the new key; Backspace = unbind; Esc = cancel"
    t["LY_SP_HD"] = "System · unset by default, shows on the virtual keyboard once set"
    t["LY_SP_NOTE"] = "reply / ping / focus / assist / interact / marks / autorun / pet attack"
    t["LY_SP_UNSET"] = "not set"
    t["LY_SP_OK"] = "active"
    t["LY_SP_DIFF"] = "differs from the game binding - click Apply suggestions"
    t["LY_SP_GAME"] = "game default %s · not taken, kept"
    t["LY_SP_NONE"] = "not bound in the game either"
    t["LY_SP_REPLY_SHORT"] = "reply"
    t["LY_SP_PING_SHORT"] = "ping"
    t["LY_SP_FOCUS_TIP"] = "Set your current target as focus (interrupt-on-focus, watching a boss cast)"
    t["LY_SP_FOCUS_SHORT"] = "focus+"
    t["LY_SP_TFOCUS_TIP"] = "Target your focus"
    t["LY_SP_TFOCUS_SHORT"] = "focus"
    t["LY_SP_ASSIST_TIP"] = "Target your target's target - follow the tank's kill target"
    t["LY_SP_ASSIST_SHORT"] = "assist"
    t["LY_SP_INTERACT_TIP"] = "Interact with target: loot, talk to NPCs, open doors"
    t["LY_SP_INTERACT_SHORT"] = "use"
    t["LY_SP_TAB_TIP"] = "Default Tab"
    t["LY_SP_SKULL_TIP"] = "Put a skull on the target (main kill target)"
    t["LY_SP_SKULL_SHORT"] = "skull"
    t["LY_SP_CROSS_TIP"] = "Put a cross on the target (second kill target)"
    t["LY_SP_CROSS_SHORT"] = "cross"
    t["LY_SP_AUTORUN_TIP"] = "Default Num Lock"
...
do
    ...
    t["MT_LAYOUT_MOD_ASK"] = "Load the \"Keybinds & Rotation\" module?\n\nOne-click action bar layout / smart key assignment / macro library / backup & restore.\nStays loaded for this session; pick \"Always load\" to open it directly next time."
    t["MT_LAYOUT_MOD_BTN"] = "Load Keybinds & Rotation"
    t["MT_LAYOUT_MOD_HINT"] = "\"Keybinds & Rotation\" is a separate module (GearInsight_Layout): lays out your action bars from top WCL players' cast frequency, assigns keys, macro library, backup / restore, MySlot export.\nNot loaded by default so it uses no memory; click below to load, choose \"Always load\" to stop being asked."
...
do
    local t = GearInsight.LOC.enUS
    t["MT_TAB_LAYOUT"] = "Keybinds + Rotation"
    t["MT_TAB_LAYOUT_TITLE"] = "Keybinds & Rotation · one-click action bars / macro library / auto key assignment / rotation assist"
    t["MT_TAB_WISH"] = "Farm Plan"
end
do
    -- 0.91.4：发版闸门补齐（这 7 个键 0.90.10~0.91.3 期间加的，之前没过审计）
    local t = GearInsight.LOC.enUS
    t["BTN_RELOAD"] = "Reload UI"
    t["SUP_STAT_PEOPLE"] = "supporters"
    t["SUP_STAT_WEEK"] = "this week"
    t["TALENT_LOD_ENABLED"] = "The talent library module was disabled; it has been enabled for you - click the button below to reload the UI."
