...
local function Refresh()
    ...
    if myIdx then
        ...
        lines[#lines + 1] = ("|cffffd100%s|r  %s %s · %s"):format(
            (GearInsight.MetaRowName and GearInsight.MetaRowName(myRow)) or myRow.cn or "?", roleName,
    ...
    for i = 1, math.min(3, rows and #rows or 0) do
        ...
        lines[#lines + 1] = ("%s%d %s|r  %s"):format(mark, i, (GearInsight.MetaRowName and GearInsight.MetaRowName(r)) or r.cn or "?",
