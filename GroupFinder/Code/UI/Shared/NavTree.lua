...
local function getVisibleTree()
	local tree = GF.NavData.GetTree and GF.NavData.GetTree() or GF.navTree or {}
	if GF.LFGWorkspaceView and GF.LFGWorkspaceView.GetVisibleRoots then
		return GF.LFGWorkspaceView:GetVisibleRoots(tree)
	end
	return tree
end
