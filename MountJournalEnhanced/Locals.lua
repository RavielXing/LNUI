...
L["CONFIRM_FAVORITE_PROFILE_DELETION"] = "確定要刪除配置文件“%s”嗎？所有當前的角色分配都將重置爲默認配置文件“%s”。"
L["DRESSUP_LABEL"] = "日志"
...
L["Passenger"] = "載客"
L["PET_ASSIGNMENT_INFO"] = "妳可以爲該坐騎分配壹只小寵物。它也會隨坐騎壹起被召喚出來。|n|n所有分配都會與您的所有角色共享。|n|n您可以右鍵單擊寵物條目來手動召喚它。|n|n請注意，大多數地面寵物不會隨您飛行，而是在您起飛時消失。此外，飛行寵物的速度通常比您慢。|n|n自動召喚寵物只在世界內容中有效。"
L["PET_ASSIGNMENT_NONE"] = "無小寵物"
L["PET_ASSIGNMENT_TITLE"] = "爲坐騎分配寵物"
...
L["SYNC_TARGET_TIP_FLAVOR"] = "准備上馬！"
L["SYNC_TARGET_TIP_TEXT"] = "自動選擇當前目標的坐標。"
L["SYNC_TARGET_TIP_TITLE"] = "將日志與目標同步"
L["TOGGLE_COLOR"] = "顯示下壹個顔色變體"
L["Transform"] = "變形"
...
L["SETTING_COLOR_NAMES"] = "根據稀有度爲列表中的名稱著色"
L["SETTING_COMPACT_LIST"] = "緊湊坐騎列表"
L["SETTING_CURSOR_KEYS"] = "啓用上下鍵浏覽坐騎"
L["SETTING_DISPLAY_BACKGROUND"] = "更改顯示的背景顔色"
L["SETTING_HEAD_ABOUT"] = "關于"
L["SETTING_HEAD_BEHAVIOUR"] = "行爲"
...
L["SETTING_SUMMONPREVIOUSPET"] = "下馬時再次召喚前壹只寵物。"
L["SETTING_TRACK_USAGE"] = "跟蹤所有角色的坐騎使用行爲"
