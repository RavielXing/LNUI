...
L["Border coloring of stealable, curable and dispellable auras."] = "Rahmenfarbe von stelbaren, heilbaren und bannbaren Auren."
L["Border highlighting"] = "Rahmenhervorhebung"
L["Border thickness"] = "Rahmendicke"
L["Boss"] = "Boss"
L["Boss Auras"] = "Bossauren"
...
L["Allow clicks to pass through auras to select the unit behind them. Tooltips still work on hover."] = "Erlaubt es, durch die Auren hindurchzuklicken, um die darunterliegende Einheit auszuwählen. Tooltips beim Überfahren bleiben erhalten."
L["Clip"] = "Anheften"
...
L["Male"] = "Männlich"
L["Mana"] = "Mana"
L["Manage Aura Filters"] = "verwalte Aurenfilter"
...
L["Show boss debuffs"] = "Zeige Boss Debuffs"
...
L["Show curable/removable auras"] = "Zeige heilbare/entfernbare Auren"
...
L["Shows debuffs cast by a boss."] = "Zeigt Debuffs verursacht durch einen Boss"
...
L["Stealable/Curable/Dispellable"] = "Stehlbar/Heilbar/Bannbar"
...
L["Combat auras"] = "Kampf-Auren"
L["Combat debuffs"] = "Kampf-Schwächungen"
...
L["Group/Raid debuffs"] = "Gruppen-/Schlachtzug-Schwächungen"
...
L["My combat auras"] = "Meine Kampf-Auren"
L["Only shows your buffs deemed useful in combat by Blizzard."] = "Zeigt nur deine Stärkungszauber, die von Blizzard als nützlich im Kampf eingestuft werden."
L["My group/raid debuffs"] = "Meine Gruppen-/Schlachtzug-Schwächungen"
L["Only shows debuffs you applied that are relevant in a group or raid context."] = "Zeigt nur Schwächungszauber, die du verursacht hast und die im Gruppen- oder Schlachtzugkontext relevant sind."
L["Purgeable/Stealable"] = "Entfernbar/Stehlbar"
L["Only shows buffs deemed useful in combat (e.g. HoTs)."] = "Zeigt nur Stärkungszauber, die von Blizzard als nützlich im Kampf eingestuft werden (z.B. HoTs)."
...
L["Only shows buffs that can be purged, stolen or dispelled by your class."] = "Zeigt nur Stärkungszauber, die von deiner Klasse gereinigt, gestohlen oder gebannt werden können."
...
L["Only shows debuffs deemed useful in combat by Blizzard."] = "Zeigt nur Schwächungszauber, die von Blizzard als nützlich im Kampf eingestuft werden."
...
L["Only shows debuffs whose dispel type matches your class (Holy Priest = Magic + Disease, Resto Druid = Magic + Curse + Poison, etc.)."] = "Zeigt nur Schwächungszauber, deren Banntyp zu deiner Klasse passt (Heilig-Priester = Magie + Krankheit, Wiederherstellungs-Druide = Magie + Fluch + Gift, etc.)."
...
L["Shows debuffs relevant in a group or raid context (boss mechanics, important debuffs)."] = "Zeigt Schwächungszauber, die im Gruppen- oder Schlachtzugkontext relevant sind (Boss-Mechaniken, wichtige Schwächungen)."
...
L["Blacklist / Whitelist"] = "Schwarze Liste / Weiße Liste"
L["Apply the blacklist/whitelist from the Aura Filters tab to this frame. This is separate from the Blizzard API filter below."] = "Die Schwarz- oder Weißliste aus dem Reiter 'Aurafilter' auf diesen Rahmen anwenden. Diese Einstellung ist unabhängig vom Blizzard-Filter darunter."
L["Whitelists will hide any aura not in the filter group.|nBlacklists will hide auras that are in the filter group.|nOnly Blizzard whitelisted spells (non-secret in combat) can be added to filters."] = "Weiße Listen verbergen jede Aura, die nicht im Filter enthalten ist.|nSchwarze Listen verbergen die im Filter enthaltenen Auren.|nNur von Blizzard freigegebene Zauber (im Kampf nicht geheim) können hinzugefügt werden."
