...
L["Allow clicks to pass through auras to select the unit behind them. Tooltips still work on hover."] = "Permite hacer clic a través de las auras para seleccionar la unidad de detrás. Las descripciones emergentes al pasar el ratón siguen funcionando."
L["Clip"] = "sujetar"
...
L["Combat debuffs"] = "Perjuicios de combate"
...
L["Group/Raid debuffs"] = "Perjuicios de grupo/banda"
...
L["My combat auras"] = "Mis auras de combate"
L["Only shows your buffs deemed useful in combat by Blizzard."] = "Solo muestra tus beneficios considerados útiles en combate por Blizzard."
L["My group/raid debuffs"] = "Mis perjuicios de grupo/banda"
L["Only shows debuffs you applied that are relevant in a group or raid context."] = "Solo muestra perjuicios que aplicaste y que son relevantes en contexto de grupo o banda."
L["Purgeable/Stealable"] = "Purgable/Robable"
L["Only shows buffs deemed useful in combat (e.g. HoTs)."] = "Solo muestra beneficios considerados útiles en combate por Blizzard (ej. HoTs)."
...
L["Only shows buffs that can be purged, stolen or dispelled by your class."] = "Solo muestra beneficios que pueden ser purgados, robados o disipados por tu clase."
...
L["Only shows debuffs deemed useful in combat by Blizzard."] = "Solo muestra perjuicios considerados útiles en combate por Blizzard."
...
L["Only shows debuffs whose dispel type matches your class (Holy Priest = Magic + Disease, Resto Druid = Magic + Curse + Poison, etc.)."] = "Solo muestra perjuicios cuyo tipo de disipación corresponde a tu clase (Sacerdote Sagrado = Magia + Enfermedad, Druida Restauración = Magia + Maldición + Veneno, etc.)."
