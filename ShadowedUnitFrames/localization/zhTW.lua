...
L["%s frames"] = "%s框架"
L["%s member"] = "%s成員"
L["0 removes the cap (uses the frame's rows and icons per row)."] = "0 表示不限制（使用框架的列數和每列圖示數）。"
L["A filter with this name already exists."] = "已存在同名過濾器。"
L["Accepts a spell ID, a spell link (shift-click a spell) or an exact spell name. You can also drag a spell from the spellbook onto this field. Spell names only resolve for spells your character currently knows; use the spell ID for anything else."] = "接受法術 ID、法術連結（Shift-點擊法術）或準確的法術名稱。也可以把法術從法術書拖到此欄。名稱只能解析你的角色已知的法術，其餘請使用法術 ID。"
L["Add section"] = "新增區段"
L["Added %s (#%d)."] = "已新增 %s (#%d)。"
L["Adds an Essence bar for Evokers."] = "為喚能師新增精華條。"
L["Adds another filter to this frame, shown after the previous sections. Overlaps are removed automatically."] = "為此框架新增另一個過濾器，顯示在之前的區段之後。重複項會自動移除。"
L["Adds the spell ID to aura tooltips, handy for filling the spell fields of custom filters and aura indicators."] = "在光環滑鼠提示中加入法術 ID，方便填寫自訂過濾器和光環指示器的法術欄。"
L["All tooltips"] = "所有滑鼠提示"
L["All tooltips except auras"] = "除光環外的所有滑鼠提示"
L["Anchor to buffs %d"] = "錨定到增益 %d"
L["Anchor to debuffs %d"] = "錨定到減益 %d"
L["Anchors this buff frame to the corresponding debuff frame, positioning it after the last visible debuff."] = "將此增益框架錨定到對應的減益框架，位於最後一個可見減益之後。"
L["Anchors this debuff frame to the corresponding buff frame, positioning it after the last visible buff."] = "將此減益框架錨定到對應的增益框架，位於最後一個可見增益之後。"
L["Any dispellable"] = "所有可驅散光環"
L["Application order"] = "施加順序"
L["Assign a filter to each unit frame per zone type. Filters are created and edited in the Custom filters tab."] = "按區域類型為每個單位框架指定過濾器。過濾器在自訂過濾器分頁中建立和編輯。"
L["Aura borders keep their neutral color instead of being tinted by dispel type. Has no effect with the Blizzard border style."] = "光環邊框保持中性顏色，而不按驅散類型著色。對暴雪邊框樣式無效。"
L["Big defensives first"] = "主要減傷優先"
L["Bleed"] = "流血"
L["Blizzard only applies spell filters to buffs on friendly units and to debuffs on hostile units, plus any spell it flags as never secret."] = "暴雪只對友方單位的增益和敵方單位的減益套用法術過濾，另加所有被標記為永不保密的法術。"
L["Border coloring of stealable buffs. Replaces the dispel type color on those auras."] = "可偷取增益的邊框顏色。將替換這些光環上的驅散類型顏色。"
L["Buffs flagged by Blizzard to show on raid frames in combat, HoTs mostly."] = "暴雪標記為戰鬥中顯示在團隊框架上的增益，大多是 HoT。"
L["Cancelable auras"] = "可取消的光環"
L["Cancelable Auras"] = "可取消的光環"
L["Class auras (group, raid)"] = "職業光環（隊伍、團隊）"
L["Color and opacity of the overlay pulsing on your own auras inside their pandemic window. Enabled in the general aura settings."] = "你自己的光環處於疫情時間窗時閃爍覆蓋層的顏色和不透明度。在一般光環設定中啟用。"
L["Colors used for dispel type coloring: aura borders, health bar tinting and dispel highlighting."] = "用於按驅散類型著色的顏色：光環邊框、生命條染色和邊框高亮。"
L["Contextual auras (group, raid)"] = "情境光環（隊伍、團隊）"
L["Cooldown swipe opacity"] = "冷卻掃過不透明度"
L["Create filter"] = "建立過濾器"
L["Curated list of class and healer spells. Combat display works for buffs on friendly units; the missing option requires a Blizzard-whitelisted spell."] = "精選的職業與治療者法術列表。戰鬥中的顯示對友方單位的增益有效；「缺失時」選項需要暴雪白名單法術。"
L["Curse"] = "詛咒"
L["Custom"] = "自訂"
L["Custom filters"] = "自訂過濾器"
L["Custom filters let you build aura filters from a spell's name or spell ID. Pick a mode when creating one: \"Show only matching spells\" or \"Hide matching spells\"."] = "自訂過濾器用法術名稱或法術 ID 建立光環過濾。建立時選擇模式：\"僅顯示列出的法術\"或\"隱藏列出的法術\"。"
L["Default"] = "預設"
L["Disable dispel type borders"] = "停用驅散類型邊框"
L["Disable right-click cancel"] = "停用右鍵取消"
L["Disable stack counts"] = "停用層數顯示"
L["Disable stealable coloring"] = "停用可偷取著色"
L["Disease"] = "疾病"
L["Dispellable Auras"] = "可驅散光環"
L["Dispellable by group"] = "隊伍可驅散"
L["Dispellable by my group"] = "我的隊伍可驅散"
L["Enable"] = "啟用"
L["Enlarge my auras"] = "放大我的光環"
L["Enlarged scale"] = "放大比例"
L["Enrage"] = "激怒"
L["Expiration"] = "到期時間"
L["Expiration (yours first)"] = "到期時間（自己優先）"
L["Filter"] = "過濾器"
L["Frame changes are deferred while in combat and will apply afterwards."] = "框架變更在戰鬥中被延後，戰鬥結束後生效。"
L["Gap in pixels between aura icons on the same row, negative values overlap them."] = "同一行光環圖示之間的像素間距，負值會使其重疊。"
L["Gap in pixels between aura rows, negative values overlap them."] = "光環行與行之間的像素間距，負值會使其重疊。"
L["Group"] = "群組"
L["Group this aura will be listed under. Both a spell and a group are required to add an aura."] = "此光環所屬的群組。新增光環需要法術和群組。"
L["Hide matching spells"] = "隱藏列出的法術"
L["Hides the stack count text on all Shadowed Unit Frame auras."] = "隱藏所有 Shadowed Unit Frames 光環上的層數文字。"
L["HoTs & raid frames buffs"] = "HoT 與團隊框架增益"
L["Horizontal spacing"] = "水平間距"
L["How auras in this frame are ordered. Sorting is per section."] = "此框架中光環的排序方式。排序按區段進行。"
L["Important only"] = "僅重要"
L["In combat, Blizzard only applies spell filters to buffs on friendly units and debuffs on hostile units, plus spells it flags as never secret."] = "戰鬥中暴雪只對友方單位的增益和敵方單位的減益套用法術過濾，另加被標記為永不保密的法術。"
L["Magic"] = "魔法"
L["Max icons"] = "最大圖示數"
L["Mode"] = "模式"
L["Move down"] = "下移"
L["Move up"] = "上移"
L["My Auras"] = "我的光環"
L["My HoTs & raid frames buffs"] = "我的 HoT 與團隊框架增益"
L["Name (yours first)"] = "名稱（自己優先）"
L["Neighborhood"] = "街區"
L["Only shows auras that have a dispel type, whether or not anyone in your group can dispel them."] = "僅顯示具有驅散類型的光環，無論隊伍中是否有人能驅散。"
L["Only shows buffs that someone in your group can purge, steal or dispel."] = "僅顯示隊伍中有人能淨化、竊取或驅散的增益。"
L["Only shows debuffs that someone in your group can dispel (you, when solo)."] = "僅顯示隊伍中有人能驅散的減益（單人時為你自己）。"
L["Only shows debuffs that you can dispel."] = "僅顯示你能驅散的減益。"
L["Opacity of the dark overlay showing the remaining time on auras."] = "顯示光環剩餘時間的暗色覆蓋層的不透明度。"
L["Pandemic overlay"] = "疫情覆蓋層"
L["Poison"] = "劇毒"
L["Private auras from bosses and encounters displayed using Blizzard's secure API."] = "透過暴雪安全 API 顯示的首領與戰鬥私有光環。"
L["Profile changes will be applied after combat."] = "設定檔變更將在戰鬥後生效。"
L["Pulses an overlay on your own auras inside their pandemic window, where refreshing them carries the remaining time over. Color and opacity are set in the Colors tab."] = "在你自己的光環處於疫情時間窗時顯示閃爍覆蓋層，此時刷新光環會繼承剩餘時間。顏色和不透明度在「顏色」分頁中設定。"
L["Right-clicking your own buffs cancels them; enable this to turn that off."] = "右鍵點擊你自己的增益會取消它們；啟用此項以關閉該行為。"
L["Scale multiplier applied to player auras when enlargement is enabled."] = "啟用放大時套用於玩家光環的縮放係數。"
L["Scale up auras that were cast by the player to make them more visible."] = "放大玩家施放的光環，使其更顯眼。"
L["Section"] = "區段"
L["Sections add extra filters to this frame, shown after the main filter. Auras already shown by a previous section are removed automatically. Each section has its own icon size, sorting and icon cap."] = "區段為此框架新增額外過濾器，顯示在主過濾器之後。已被前面區段顯示的光環會自動移除。每個區段有自己的圖示大小、排序和圖示上限。"
L["Shadow"] = "陰影"
L["Shadow color"] = "陰影顏色"
L["Shadow X"] = "陰影 X"
L["Shadow Y"] = "陰影 Y"
...
L["Show only matching spells"] = "僅顯示列出的法術"
L["Show spell IDs in aura tooltips"] = "在光環滑鼠提示中顯示法術 ID"
L["Shows placeholder auras on this unit's frames to preview positioning."] = "在此單位的框架上顯示範例光環以預覽位置。"
L["Some aura changes are deferred while combat restrictions are active (combat, dungeons, raids)."] = "戰鬥限制生效期間（戰鬥、地城、團隊副本），部分光環變更被延後。"
L["Spell"] = "法術"
L["Stacks"] = "層數"
L["Stacks font"] = "層數字型"
L["Stealable"] = "可偷取"
L["Stealable buffs are tinted by dispel type like the others."] = "可偷取的增益與其他光環一樣按驅散類型著色。"
L["Test mode"] = "測試模式"
L["Test mode cannot be toggled while in combat."] = "戰鬥中無法切換測試模式。"
L["Timer"] = "計時器"
L["Timer font"] = "計時器字型"
L["Unit changes will be applied after combat."] = "單位變更將在戰鬥後生效。"
L["Unit frame debuff order"] = "單位框架減益順序"
L["Unit frames cannot be unlocked while in combat."] = "戰鬥中無法解鎖單位框架。"
L["Unknown spell. Enter a spell ID, a spell link or an exact spell name."] = "未知法術。請輸入法術 ID、法術連結或準確的法術名稱。"
L["Vertical spacing"] = "垂直間距"
L["Which auras to show in this frame"] = "此框架顯示哪些光環"
L["Which tooltips to hide while in combat. Aura tooltips are shown natively by the game and can be kept visible."] = "戰鬥中隱藏哪些滑鼠提示。光環提示由遊戲原生顯示，可以保持可見。"
L["You can then use these filters in the Auras tab of the player, target, raid, etc. modules, or assign them per zone type in the Zone Filters tab."] = "之後可以在玩家、目標、團隊等模組的光環分頁中使用這些過濾器，或在區域過濾器分頁按區域類型指定。"
L["You have entered combat, test mode has been disabled."] = "你已進入戰鬥，測試模式已停用。"
L["You have entered combat, unit frames have been locked."] = "你已進入戰鬥，單位框架已鎖定。"
L["You must enter a name."] = "必須輸入名稱。"
L["You will need to create a filter in the Custom filters tab before you can assign it here."] = "需要先在自訂過濾器分頁建立過濾器，才能在此指定。"
L["Your buffs flagged to show on raid frames in combat."] = "你的被標記為戰鬥中顯示在團隊框架上的增益。"
L["Zone Filters"] = "區域過濾器"
...
L["3D"] = "3D"
L["A"] = "A"
L["Abbreviates unit names above 10 characters, \"Dark Rune Champion\" becomes \"D.R.Champion\" and \"Dark Rune Commoner\" becomes \"D.R.Commoner\".|n|nIn combat, shows full (non-abbreviated) name on enemy units."] = "簡化單位名稱需10個位元以上，'Dark Rune Champion'顯示為'D.R.Champion'或'Dark Rune Commoner'顯示為'D.R.Commoner'。|n|n戰鬥中，敵方單位名稱顯示完整（不縮寫）。"
...
L["Adds a bar indicating how much time is left on your statue."] = "新增一個顯示雕像剩餘時間的狀態條。"
...
L["Ammo"] = "彈藥"
L["Amount of health missing, if none is missing nothing is shown. Uses a short format, -18500 is shown as -18.5k, values below 10000 are formatted as is.|n|nIn combat, may show -0 at full health due to secret values."] = "生命損失值，如果沒有損失則不顯示。使用簡化格式-18500顯示為-18.5k，低於10000的生命值則不簡化。|n|n戰鬥中，由於秘密值，滿血時可能顯示 -0。"
L["Amount of power missing,  if none is missing nothing is shown. Uses a short format, -13850 is shown as 13.8k, values below 10000 are formatted as is.|n|nIn combat, may show -0 at full power due to secret values."] = "能量損失值，如果沒有損失則不顯示。使用簡化格式-13850顯示為-13.8k，低於10000的能量值則不簡化。|n|n戰鬥中，由於秘密值，滿能量時可能顯示 -0。"
L["Anchor point"] = "定位處"
L["Override General text settings"] = "覆蓋一般文字設定"
L["Use the text settings below instead of the ones from the General tab."] = "使用下方的文字設定，而非一般頁籤中的設定。"
L["Anchor to"] = "定位到"
L["Anchor to another frame"] = "定位到其他框架"
L["Anchor to buffs"] = "定位到增益"
L["Anchor to debuffs"] = "定位到減益"
L["Controls how the anchored aura frame is positioned relative to the parent frame."] = "控制錨定的光環框架相對於父框架的定位方式。"
L["New row"] = "新行"
L["Sequential"] = "順序排列"
...
L["Direction aura icons fill within a row."] = "光環圖示在行內排列的方向。"
...
L["Name (NSRT Nickname)"] = "名稱 (NSRT 暱稱)"
L["Name (NSRT Nickname/Class colored)"] = "名稱 (NSRT 暱稱/職業著色)"
L["Name (NSRT Nickname/Abbreviated)"] = "名稱 (NSRT 暱稱/縮寫)"
L["Unit name replaced by NSRT nickname if available. Falls back to the regular name if NSRT is not installed or no nickname is set."] = "如果可用，單位名稱將替換為NSRT暱稱。如果未安裝NSRT或未設置暱稱，則顯示普通名稱。"
L["NSRT nickname colored by class. Falls back to the regular name if NSRT is not installed or no nickname is set.|n|nIn combat, shows uncolored name on enemy units."] = "按職業著色的NSRT暱稱。如果未安裝NSRT或未設置暱稱，則顯示普通名稱。|n|n戰鬥中，敵方單位顯示無著色名稱。"
L["Abbreviated NSRT nickname (if longer than 10 characters). Falls back to the regular name if NSRT is not installed or no nickname is set.|n|nIn combat, shows full (non-abbreviated) name on enemy units."] = "NSRT暱稱縮寫（超過10個字元時）。如果未安裝NSRT或未設置暱稱，則顯示普通名稱。|n|n戰鬥中，敵方單位顯示完整名稱。"
...
L["Per row"] = "每行"
L["Percent HP"] = "百分比生命值"
L["Percent of the players current health that's being healed, if they have 100,000 total health and 15,000 is incoming then 15% is shown.|n|nIn combat, only works on allied units."] = "百分比顯示玩家目前受到治療的生命值，如果他們有100,000總生命並且受到15,000的治療則顯示15%。"
...
L["Position"] = "位置"
L["Position of the bar when thickness is less than 100%."] = "厚度小於100%時計量條的位置。"
L["Positioning"] = "定位"
L["Power"] = "綜合能量"
L["Power bar"] = "綜合能量條"
L["Power Type"] = "能量類型"
...
L["Relative size of the bar perpendicular to the fill direction. 100% matches the health bar exactly."] = "垂直於填充方向的計量條相對大小。100%與生命條完全匹配。"
L["Resources"] = "來源"
...
L["Shorten damage absorption, if 13,000 damage will be absorbed, it will show 13k."] = "簡化傷害吸收，如果13,000的傷害被吸收，將會顯示為13K。"
...
L["Text parent"] = "文字來源"
L["Text/Tags"] = "文字/標籤"
L["The \"%s\" option is ignored for zone assignments; select the filter directly in a unit's Auras tab to use it."] = "「%s」選項不適用於區域分配；如需使用，請在單位的光環標籤頁中直接選擇該過濾器。"
...
L["Unit name colored by class.|n|nIn combat, shows uncolored name on enemy units."] = "依照職業着色單位名稱。|n|n戰鬥中，敵方單位名稱不顯示職業顏色。"
...
L["When the unit is mising health, the [missinghp] tag is shown, when they are at full health then the [name] tag is shown. This lets you see -1000 when they are missing 1000 HP, but their name when they are not missing any.|n|nIn combat, health deficit only works on allied units."] = "當單位的生命損失時，將顯示[missinghp]標籤。當單位生命恢復時，將顯示[name]標籤。當生命損失1000時則顯示為-1000，當生命無損失時則顯示為名稱。|n|n戰鬥中，生命缺損僅對友方單位有效。"
...
L["Only shows buffs marked as important by Blizzard. Server-maintained list."] = "僅顯示暴雪標記為重要的增益。伺服器維護列表。"
L["Only shows buffs you cast yourself."] = "僅顯示你自己施放的增益。"
L["Only shows buff types that your class can cast (e.g. a Priest sees Fortitude and Renew), regardless of who cast them."] = "僅顯示你的職業可以施放的增益類型（如牧師看到堅韌和恢復），無論施放者是誰。"
L["Only shows crowd control effects (Stun, Root, Silence, Fear, Polymorph, Cyclone, etc.)."] = "僅顯示控制效果（昏迷、定身、沉默、恐懼、變形、颶風等）。"
L["Only shows debuffs marked as important by Blizzard. Server-maintained list."] = "僅顯示暴雪標記為重要的減益。伺服器維護列表。"
L["Only shows debuffs you applied yourself."] = "僅顯示你自己施加的減益。"
...
L["Only shows external defensives that you cast on someone."] = "僅顯示你對他人施放的外部防禦。"
...
L["Only shows major defensive cooldowns that you activated yourself."] = "僅顯示你自己啟動的大型防禦冷卻。"
L["Only shows your class buff types that you cast yourself."] = "僅顯示你自己施放的職業增益類型。"
...
-- Performance
L["Performance"] = "效能"
L["Performance settings"] = "效能設定"
L["Adjust polling and refresh rates for various addon subsystems. Lower values = more responsive but higher CPU usage. Higher values = less CPU but slower updates."] = "調整插件模組的更新間隔。較低的值 = 反應更快但CPU佔用更高。較高的值 = CPU佔用更低但更新較慢。"
L["Range check interval"] = "距離檢查間隔"
L["How often to check if units are in range (seconds)."] = "檢查目標是否在範圍內的頻率（秒）。"
L["Fast tag refresh"] = "快速標籤更新"
L["Refresh rate for rapidly changing tags like health/power percent (seconds)."] = "快速變化標籤（如生命值/能量百分比）的更新頻率（秒）。"
L["Normal tag refresh"] = "普通標籤更新"
L["Refresh rate for standard dynamic tags (seconds)."] = "標準動態標籤的更新頻率（秒）。"
L["Slow tag refresh"] = "慢速標籤更新"
L["Refresh rate for slowly changing tags like AFK timers (seconds)."] = "緩慢變化標籤（如暫離計時器）的更新頻率（秒）。"
...
L["Reset all performance settings to their default values."] = "將所有效能設定恢復為預設值。"
L["Add spell"] = "新增法術"
