...
L["Allow clicks to pass through auras to select the unit behind them. Tooltips still work on hover."] = "允許點擊穿透光環圖示以選取下方的單位。滑鼠懸停時提示資訊仍正常顯示。"
L["Clip"] = "內間距"
L["Close color"] = "關閉着色"
...
L["Only shows your buffs deemed useful in combat by Blizzard."] = "僅顯示暴雪認為在戰鬥中有用的你的增益。"
L["My group/raid debuffs"] = "我的隊伍/團隊減益"
L["Only shows debuffs you applied that are relevant in a group or raid context."] = "僅顯示你施加的在隊伍或團隊中相關的減益。"
L["Purgeable/Stealable"] = "可淨化/可竊取"
L["Only shows buffs deemed useful in combat (e.g. HoTs)."] = "僅顯示暴雪認為在戰鬥中有用的增益（如持續治療）。"
L["Only shows buffs marked as important by Blizzard. Server-maintained list."] = "僅顯示暴雪標記為重要的增益。伺服器維護列表。"
L["Only shows buffs that can be purged, stolen or dispelled by your class."] = "僅顯示你的職業可以淨化、竊取或驅散的增益。"
...
L["Only shows debuffs deemed useful in combat by Blizzard."] = "僅顯示暴雪認為在戰鬥中有用的減益。"
L["Only shows debuffs marked as important by Blizzard. Server-maintained list."] = "僅顯示暴雪標記為重要的減益。伺服器維護列表。"
L["Only shows debuffs whose dispel type matches your class (Holy Priest = Magic + Disease, Resto Druid = Magic + Curse + Poison, etc.)."] = "僅顯示驅散類型匹配你的職業的減益（神聖牧師 = 魔法 + 疾病，恢復德魯伊 = 魔法 + 詛咒 + 毒藥等）。"
...
L["Apply the blacklist/whitelist from the Aura Filters tab to this frame. This is separate from the Blizzard API filter below."] = "將光環過濾器分頁中的黑名單或白名單套用到此框架。此設定與下方的暴雪API過濾器無關。"
L["Whitelists will hide any aura not in the filter group.|nBlacklists will hide auras that are in the filter group.|nOnly Blizzard whitelisted spells (non-secret in combat) can be added to filters."] = "白名單將隱藏不在過濾器中的所有光環。|n黑名單將隱藏在過濾器中的光環。|n只能新增暴雪許可的法術（戰鬥中非機密）。"
