...
local L = {}
L["Disable dispel coloring"] = "禁用驱散着色"
L["Disables the special border color for dispellable/purgeable auras. They will use school colors instead (Magic, Curse, Disease, Poison)."] = "禁用可驱散/可净化光环的特殊边框颜色。它们将改用学派颜色（魔法、诅咒、疾病、毒药）。"
L["Blizzard frames"] = "暴雪框体"
L["Shows the same auras that Blizzard's default unit frames display. Reads filtered data directly from Blizzard frames."] = "显示与暴雪默认单位框架相同的光环。直接从暴雪框架读取过滤后的数据。"
L["Cancelable auras"] = "可取消光环"
L["Cancelable Auras"] = "可取消光环"
L["Class auras (group, raid)"] = "职业光环（小队、团队）"
L["Contextual auras (group, raid)"] = "情境光环（小队、团队）"
...
L["Outside bar limit"] = "外部计量条限制"
L["Blacklist / Whitelist"] = "黑名单 / 白名单"
L["Apply the blacklist/whitelist from the Aura Filters tab to this frame. This is separate from the Blizzard API filter below."] = "应用光环过滤器选项卡中的黑名单/白名单到此框架。此设置与下方的暴雪API过滤器无关。"
L["Anchor to buffs %d"] = "锚点定位到增益效果 %d"
L["Anchor to debuffs %d"] = "锚点定位到负面效果 %d"
L["Test mode"] = "测试模式"
L["Shows placeholder auras on this unit's frames to preview positioning."] = "在该单位的框架上显示占位光环，以预览位置布局。"
L["Use Boss Mod Cast Name overrides"] = "使用 首领模组 角色名称覆盖"

L["Fixed enlarged aura layout"] = "固定放大光环布局"
...
L["Allow clicks to pass through auras to select the unit behind them. Tooltips still work on hover."] = "允许点击穿透光环图标以选中下方的单位。鼠标悬停时提示信息仍正常显示。"
L["Clip"] = "内间距"
L["Close color"] = "关闭颜色"
...
L["Filtering debuffs only"] = "仅过滤负面效果"
L["Filters"] = "过滤器"
...
L["Shows debuffs cast by a boss."] = "显示首领施放的负面效果。"
...
L["When this filter is active, apply the filter to buffs."] = "当这个过滤器激活时，过滤增益效果。"
L["When this filter is active, apply the filter to debuffs."] = "当这个过滤器激活时，过滤负面效果。"
...
L["Combat auras"] = "战斗光环"
L["Combat debuffs"] = "战斗减益"
L["Crowd control effects"] = "控制效果"
L["Dispellable by me"] = "可由我驱散"
L["External defensives"] = "外部防御"
L["Group/Raid Auras"] = "队伍/团队光环"
L["Group/Raid debuffs"] = "队伍/团队减益"
L["Important auras"] = "重要光环"
L["My big defensives"] = "我的大型防御"
L["My class auras"] = "我的职业光环"
L["My external defensives"] = "我的外部防御"
L["My combat auras"] = "我的战斗光环"
L["Only shows your buffs deemed useful in combat by Blizzard."] = "仅显示暴雪认为在战斗中有用的你的增益。"
L["My group/raid debuffs"] = "我的队伍/团队减益"
L["Only shows debuffs you applied that are relevant in a group or raid context."] = "仅显示你施加的在队伍或团队中相关的减益。"
L["Purgeable/Stealable"] = "可净化/可窃取"
L["Only shows buffs deemed useful in combat (e.g. HoTs)."] = "仅显示暴雪认为在战斗中有用的增益（如持续治疗）。"
L["Only shows buffs marked as important by Blizzard. Server-maintained list."] = "仅显示暴雪标记为重要的增益。服务器维护列表。"
L["Only shows buffs that can be purged, stolen or dispelled by your class."] = "仅显示你的职业可以净化、窃取或驱散的增益。"
...
L["Only shows debuffs deemed useful in combat by Blizzard."] = "仅显示暴雪认为在战斗中有用的减益。"
L["Only shows debuffs marked as important by Blizzard. Server-maintained list."] = "仅显示暴雪标记为重要的减益。服务器维护列表。"
L["Only shows debuffs whose dispel type matches your class (Holy Priest = Magic + Disease, Resto Druid = Magic + Curse + Poison, etc.)."] = "仅显示驱散类型匹配你的职业的减益（神圣牧师 = 魔法 + 疾病，恢复德鲁伊 = 魔法 + 诅咒 + 毒药等）。"
