...
L["%s frames"] = "%s frames"
L["%s member"] = "%s member"
L["Gap in pixels between aura icons on the same row, negative values overlap them."] = "Gap in pixels between aura icons on the same row, negative values overlap them."
L["Gap in pixels between aura rows, negative values overlap them."] = "Gap in pixels between aura rows, negative values overlap them."
...
L["0 removes the cap (uses the frame's rows and icons per row)."] = "0 removes the cap (uses the frame's rows and icons per row)."
L["1 aura group disabled"] = "1 aura group disabled"
L["2D"] = "2D"
L["3D"] = "3D"
L["A"] = "A"
L["A filter with this name already exists."] = "A filter with this name already exists."
L["Accepts a spell ID, a spell link (shift-click a spell) or an exact spell name. You can also drag a spell from the spellbook onto this field. Spell names only resolve for spells your character currently knows; use the spell ID for anything else."] = "Accepts a spell ID, a spell link (shift-click a spell) or an exact spell name. You can also drag a spell from the spellbook onto this field. Spell names only resolve for spells your character currently knows; use the spell ID for anything else."
L["Abbreviates unit names above 10 characters, \"Dark Rune Champion\" becomes \"D.R.Champion\" and \"Dark Rune Commoner\" becomes \"D.R.Commoner\".|n|nIn combat, shows full (non-abbreviated) name on enemy units."] = "Abbreviates unit names above 10 characters, \"Dark Rune Champion\" becomes \"D.R.Champion\" and \"Dark Rune Commoner\" becomes \"D.R.Commoner\".|n|nIn combat, shows full (non-abbreviated) name on enemy units."
...
L["Add"] = "Add"
L["Add section"] = "Add section"
L["Add spell"] = "Add spell"
L["Added %s (#%d)."] = "Added %s (#%d)."
L["Adds an Essence bar for Evokers."] = "Adds an Essence bar for Evokers."
L["Adds another filter to this frame, shown after the previous sections. Overlaps are removed automatically."] = "Adds another filter to this frame, shown after the previous sections. Overlaps are removed automatically."
L["Add Aura"] = "Add Aura"
L["Add aura"] = "Add aura"
...
L["Adds a bar indicating how much time is left on your statue."] = "Adds a bar indicating how much time is left on your statue."
...
L["AFK:%s"] = "AFK:%s"
L["Adds the spell ID to aura tooltips, handy for filling the spell fields of custom filters and aura indicators."] = "Adds the spell ID to aura tooltips, handy for filling the spell fields of custom filters and aura indicators."
...
L["All tooltips"] = "All tooltips"
L["All tooltips except auras"] = "All tooltips except auras"
...
L["Ammo"] = "Ammo"
L["Amount of health missing, if none is missing nothing is shown. Uses a short format, -18500 is shown as -18.5k, values below 10000 are formatted as is.|n|nIn combat, may show -0 at full health due to secret values."] = "Amount of health missing, if none is missing nothing is shown. Uses a short format, -18500 is shown as -18.5k, values below 10000 are formatted as is.|n|nIn combat, may show -0 at full health due to secret values."
L["Amount of power missing,  if none is missing nothing is shown. Uses a short format, -13850 is shown as 13.8k, values below 10000 are formatted as is.|n|nIn combat, may show -0 at full power due to secret values."] = "Amount of power missing,  if none is missing nothing is shown. Uses a short format, -13850 is shown as 13.8k, values below 10000 are formatted as is.|n|nIn combat, may show -0 at full power due to secret values."
L["Anchor point"] = "Anchor point"
L["Application order"] = "Application order"
...
L["Any dispellable"] = "Any dispellable"
L["Aquatic"] = "Aquatic"
...
L["Assign a filter to each unit frame per zone type. Filters are created and edited in the Custom filters tab."] = "Assign a filter to each unit frame per zone type. Filters are created and edited in the Custom filters tab."
...
L["Aura borders keep their neutral color instead of being tinted by dispel type. Has no effect with the Blizzard border style."] = "Aura borders keep their neutral color instead of being tinted by dispel type. Has no effect with the Blizzard border style."
L["Aura indicators"] = "Aura indicators"
...
L["B"] = "B"
L["Cancelable auras"] = "Cancelable auras"
L["Cancelable Auras"] = "Cancelable Auras"
...
L["Blizzard only applies spell filters to buffs on friendly units and to debuffs on hostile units, plus any spell it flags as never secret."] = "Blizzard only applies spell filters to buffs on friendly units and to debuffs on hostile units, plus any spell it flags as never secret."
...
L["Big defensive cooldowns"] = "Big defensive cooldowns"
...
L["Border coloring of stealable buffs. Replaces the dispel type color on those auras."] = "Border coloring of stealable buffs. Replaces the dispel type color on those auras."
...
L["Buffs flagged by Blizzard to show on raid frames in combat, HoTs mostly."] = "Buffs flagged by Blizzard to show on raid frames in combat, HoTs mostly."
...
L["Class auras (group, raid)"] = "Class auras (group, raid)"
L["Class-filtered auras"] = "Class-filtered auras"
L["Class Icon"] = "Class Icon"
...
L["Clip"] = "Clip"
L["Crowd control effects"] = "Crowd control effects"
...
L["Code"] = "Code"
L["Color and opacity of the overlay pulsing on your own auras inside their pandemic window. Enabled in the general aura settings."] = "Color and opacity of the overlay pulsing on your own auras inside their pandemic window. Enabled in the general aura settings."
...
L["Colors"] = "Colors"
L["Colors used for dispel type coloring: aura borders, health bar tinting and dispel highlighting."] = "Colors used for dispel type coloring: aura borders, health bar tinting and dispel highlighting."
...
L["Contextual auras (group, raid)"] = "Contextual auras (group, raid)"
L["Cooldown rings for"] = "Cooldown rings for"
L["Cooldown swipe opacity"] = "Cooldown swipe opacity"
...
L["Curated list of class and healer spells. Combat display works for buffs on friendly units; the missing option requires a Blizzard-whitelisted spell."] = "Curated list of class and healer spells. Combat display works for buffs on friendly units; the missing option requires a Blizzard-whitelisted spell."
...
L["Disable stack counts"] = "Disable stack counts"
...
L["Dispellable Auras"] = "Dispellable Auras"
L["Display"] = "Display"
L["Display enemy buffs using LibClassicDuration data."] = "Display enemy buffs using LibClassicDuration data."
L["DND"] = "DND"
L["Direction aura icons fill within a row."] = "Direction aura icons fill within a row."
L["Direction new rows of auras stack."] = "Direction new rows of auras stack."
L["DND:%s"] = "DND:%s"
L["Disable dispel type borders"] = "Disable dispel type borders"
L["Disable right-click cancel"] = "Disable right-click cancel"
L["Disable stealable coloring"] = "Disable stealable coloring"
L["Dispellable by me"] = "Dispellable by me"
L["Dispellable by my group"] = "Dispellable by my group"
...
L["Enlarge my auras"] = "Enlarge my auras"
...
L["Expiration (yours first)"] = "Expiration (yours first)"
L["Export"] = "Export"
...
L["Free (screen)"] = "Free (screen)"
L["Frame"] = "Frame"
L["Anchor to buffs %d"] = "Anchor to Buffs %d"
L["Anchor to debuffs %d"] = "Anchor to Debuffs %d"
L["Anchors this buff frame to the corresponding debuff frame, positioning it after the last visible debuff."] = "Anchors this buff frame to the corresponding debuff frame, positioning it after the last visible debuff."
L["Anchors this debuff frame to the corresponding buff frame, positioning it after the last visible buff."] = "Anchors this debuff frame to the corresponding buff frame, positioning it after the last visible buff."
L["Controls how the anchored aura frame is positioned relative to the parent frame."] = "Controls how the anchored aura frame is positioned relative to the parent frame."
L["Frame changes are deferred while in combat and will apply afterwards."] = "Frame changes are deferred while in combat and will apply afterwards."
L["New row"] = "New row"
...
L["Group this aura will be listed under. Both a spell and a group are required to add an aura."] = "Group this aura will be listed under. Both a spell and a group are required to add an aura."
L["Groups"] = "Groups"
L["Groups per row"] = "Groups per row"
L["Group/Raid Auras"] = "Group/Raid Auras"
...
L["Hide matching spells"] = "Hide matching spells"
...
L["Hides the stack count text on all Shadowed Unit Frame auras."] = "Hides the stack count text on all Shadowed Unit Frame auras."
...
L["HoTs & raid frames buffs"] = "HoTs & raid frames buffs"
...
L["How auras in this frame are ordered. Sorting is per section."] = "How auras in this frame are ordered. Sorting is per section."
...
L["Important only"] = "Important only"
L["In combat, Blizzard only applies spell filters to buffs on friendly units and debuffs on hostile units, plus spells it flags as never secret."] = "In combat, Blizzard only applies spell filters to buffs on friendly units and debuffs on hostile units, plus spells it flags as never secret."
...
L["MT ToT"] = "MT ToT"
L["My Auras"] = "My Auras"
L["My HoTs & raid frames buffs"] = "My HoTs & raid frames buffs"
L["My big defensives"] = "My big defensives"
L["My class auras"] = "My class auras"
L["My external defensives"] = "My external defensives"
L["Name"] = "Name"
L["Name (yours first)"] = "Name (yours first)"
L["Name (Abbreviated)"] = "Name (Abbreviated)"
L["Name (NSRT Nickname)"] = "Name (NSRT Nickname)"
L["Name (NSRT Nickname/Class colored)"] = "Name (NSRT Nickname/Class colored)"
L["Name (NSRT Nickname/Abbreviated)"] = "Name (NSRT Nickname/Abbreviated)"
...
L["Off:%s"] = "Off:%s"
L["Only shows buffs marked as important by Blizzard. Server-maintained list."] = "Only shows buffs marked as important by Blizzard. Server-maintained list."
L["Only shows auras that have a dispel type, whether or not anyone in your group can dispel them."] = "Only shows auras that have a dispel type, whether or not anyone in your group can dispel them."
L["Only shows buffs you cast yourself."] = "Only shows buffs you cast yourself."
L["Only shows buff types that your class can cast (e.g. a Priest sees Fortitude and Renew), regardless of who cast them."] = "Only shows buff types that your class can cast (e.g. a Priest sees Fortitude and Renew), regardless of who cast them."
L["Only shows crowd control effects (Stun, Root, Silence, Fear, Polymorph, Cyclone, etc.)."] = "Only shows crowd control effects (Stun, Root, Silence, Fear, Polymorph, Cyclone, etc.)."
L["Only shows debuffs marked as important by Blizzard. Server-maintained list."] = "Only shows debuffs marked as important by Blizzard. Server-maintained list."
L["Only shows debuffs you applied yourself."] = "Only shows debuffs you applied yourself."
L["Only shows defensive buffs received from another player (Pain Suppression, Ironbark, Life Cocoon, etc.)."] = "Only shows defensive buffs received from another player (Pain Suppression, Ironbark, Life Cocoon, etc.)."
L["Only shows external defensives that you cast on someone."] = "Only shows external defensives that you cast on someone."
L["Only shows major defensive cooldowns (Shield Wall, Ice Block, Divine Shield, etc.). List maintained by Blizzard."] = "Only shows major defensive cooldowns (Shield Wall, Ice Block, Divine Shield, etc.). List maintained by Blizzard."
L["Only shows major defensive cooldowns that you activated yourself."] = "Only shows major defensive cooldowns that you activated yourself."
L["Only shows your class buff types that you cast yourself."] = "Only shows your class buff types that you cast yourself."
L["Offline"] = "Offline"
...
L["Only shows buffs that someone in your group can purge, steal or dispel."] = "Only shows buffs that someone in your group can purge, steal or dispel."
L["Only shows debuffs that someone in your group can dispel (you, when solo)."] = "Only shows debuffs that someone in your group can dispel (you, when solo)."
L["Only shows debuffs that you can dispel."] = "Only shows debuffs that you can dispel."
L["Opacity of the dark overlay showing the remaining time on auras."] = "Opacity of the dark overlay showing the remaining time on auras."
...
L["Health bar"] = "Health bar"
L["Frame"] = "Frame"
L["Health fill (reverse)"] = "Health fill (reverse)"
L["Health bar (fill + reverse overlay)"] = "Health bar (fill + reverse overlay)"
L["Bar anchored to the end of the health bar, growing outward (uses overflow limit)."] = "Bar anchored to the end of the health bar, growing outward (uses overflow limit)."
L["Bar anchored to the frame edge, growing inward with reverse fill."] = "Bar anchored to the frame edge, growing inward with reverse fill."
L["Bar overlaid on the health bar with reverse fill, growing inward from the health fill edge."] = "Bar overlaid on the health bar with reverse fill, growing inward from the health fill edge."
L["Bar fills missing health then overflows as reverse overlay on the health bar."] = "Bar fills missing health then overflows as reverse overlay on the health bar."
L["Override background"] = "Override background"
L["Override color"] = "Override color"
L["Override General text settings"] = "Override General text settings"
L["Override list"] = "Override list"
L["Override list filters"] = "Override list filters"
L["Override lists"] = "Override lists"
L["Pain"] = "Pain"
L["Pandemic overlay"] = "Pandemic overlay"
L["Party"] = "Party"
...
L["Purgeable/Stealable"] = "Purgeable/Stealable"
L["Per row"] = "Per row"
L["Percent HP"] = "Percent HP"
L["Percent of the players current health that's being healed, if they have 100,000 total health and 15,000 is incoming then 15% is shown.|n|nIn combat, only works on allied units."] = "Percent of the players current health that's being healed, if they have 100,000 total health and 15,000 is incoming then 15% is shown.|n|nIn combat, only works on allied units."
...
L["Adjust polling and refresh rates for various addon subsystems. Lower values = more responsive but higher CPU usage. Higher values = less CPU but slower updates."] = "Adjust polling and refresh rates for various addon subsystems. Lower values = more responsive but higher CPU usage. Higher values = less CPU but slower updates."
L["Range check interval"] = "Range check interval"
L["How often to check if units are in range (seconds)."] = "How often to check if units are in range (seconds)."
L["Fast tag refresh"] = "Fast tag refresh"
L["Poison"] = "Poison"
L["Refresh rate for rapidly changing tags like health/power percent (seconds)."] = "Refresh rate for rapidly changing tags like health/power percent (seconds)."
L["Normal tag refresh"] = "Normal tag refresh"
L["Refresh rate for standard dynamic tags (seconds)."] = "Refresh rate for standard dynamic tags (seconds)."
L["Slow tag refresh"] = "Slow tag refresh"
L["Refresh rate for slowly changing tags like AFK timers (seconds)."] = "Refresh rate for slowly changing tags like AFK timers (seconds)."
L["Fake cast monitor"] = "Fake cast monitor"
L["Polling rate for cast bars on non-event units like focus target (seconds)."] = "Polling rate for cast bars on non-event units like focus target (seconds)."
L["Combat indicator"] = "Combat indicator"
L["How often to poll NPC combat status for the combat indicator (seconds)."] = "How often to poll NPC combat status for the combat indicator (seconds)."
L["Temp enchant scan"] = "Temp enchant scan"
L["How often to scan for temporary weapon enchants (seconds)."] = "How often to scan for temporary weapon enchants (seconds)."
L["Reset to defaults"] = "Reset to defaults"
L["Reset all performance settings to their default values."] = "Reset all performance settings to their default values."
L["Player"] = "Player"
...
L["Position"] = "Position"
L["Position of the bar when thickness is less than 100%."] = "Position of the bar when thickness is less than 100%."
...
L["PVP:%s"] = "PVP:%s"
L["Profile changes will be applied after combat."] = "Profile changes will be applied after combat."
L["Pulses an overlay on your own auras inside their pandemic window, where refreshing them carries the remaining time over. Color and opacity are set in the Colors tab."] = "Pulses an overlay on your own auras inside their pandemic window, where refreshing them carries the remaining time over. Color and opacity are set in the Colors tab."
...
L["Relative size of the bar perpendicular to the fill direction. 100% matches the health bar exactly."] = "Relative size of the bar perpendicular to the fill direction. 100% matches the health bar exactly."
...
L["Right-clicking your own buffs cancels them; enable this to turn that off."] = "Right-clicking your own buffs cancels them; enable this to turn that off."
...
L["Scale multiplier applied to player auras when enlargement is enabled."] = "Scale multiplier applied to player auras when enlargement is enabled."
L["Scale up auras that were cast by the player to make them more visible."] = "Scale up auras that were cast by the player to make them more visible."
...
L["Section"] = "Section"
L["Sections add extra filters to this frame, shown after the main filter. Auras already shown by a previous section are removed automatically. Each section has its own icon size, sorting and icon cap."] = "Sections add extra filters to this frame, shown after the main filter. Auras already shown by a previous section are removed automatically. Each section has its own icon size, sorting and icon cap."
...
L["Shorten damage absorption, if 13,000 damage will be absorbed, it will show 13k."] = "Shorten damage absorption, if 13,000 damage will be absorbed, it will show 13k."
...
L["Shows placeholder auras on this unit's frames to preview positioning."] = "Shows placeholder auras on this unit's frames to preview positioning."
...
L["Private auras from bosses and encounters displayed using Blizzard's secure API."] = "Private auras from bosses and encounters displayed using Blizzard's secure API."
...
L["Show only matching spells"] = "Show only matching spells"
L["Show party as raid"] = "Show party as raid"
L["Show player in party"] = "Show player in party"
L["Show spell IDs in aura tooltips"] = "Show spell IDs in aura tooltips"
L["Show your auras"] = "Show your auras"
L["Shows all buffs on the unit without any filtering."] = "Shows all buffs on the unit without any filtering."
L["Shows all debuffs on the unit without any filtering."] = "Shows all debuffs on the unit without any filtering."
...
L["Some aura changes are deferred while combat restrictions are active (combat, dungeons, raids)."] = "Some aura changes are deferred while combat restrictions are active (combat, dungeons, raids)."
...
L["Stealable buffs are tinted by dispel type like the others."] = "Stealable buffs are tinted by dispel type like the others."
...
L["Test mode cannot be toggled while in combat."] = "Test mode cannot be toggled while in combat."
...
L["The \"%s\" option is ignored for zone assignments; select the filter directly in a unit's Auras tab to use it."] = "The \"%s\" option is ignored for zone assignments; select the filter directly in a unit's Auras tab to use it."
...
L["Unit name replaced by NSRT nickname if available. Falls back to the regular name if NSRT is not installed or no nickname is set."] = "Unit name replaced by NSRT nickname if available. Falls back to the regular name if NSRT is not installed or no nickname is set."
...
L["Abbreviated NSRT nickname (if longer than 10 characters). Falls back to the regular name if NSRT is not installed or no nickname is set.|n|nIn combat, shows full (non-abbreviated) name on enemy units."] = "Abbreviated NSRT nickname (if longer than 10 characters). Falls back to the regular name if NSRT is not installed or no nickname is set.|n|nIn combat, shows full (non-abbreviated) name on enemy units."
L["Unit changes will be applied after combat."] = "Unit changes will be applied after combat."
L["Unit frames cannot be unlocked while in combat."] = "Unit frames cannot be unlocked while in combat."
L["Unit name (Class colored)"] = "Unit name (Class colored)"
L["Unit name colored by class.|n|nIn combat, shows uncolored name on enemy units."] = "Unit name colored by class.|n|nIn combat, shows uncolored name on enemy units."
...
L["Unknown"] = "Unknown"
L["Unknown spell. Enter a spell ID, a spell link or an exact spell name."] = "Unknown spell. Enter a spell ID, a spell link or an exact spell name."
L["Unlink frames"] = "Unlink frames"
L["Up"] = "Up"
L["Which auras to show in this frame"] = "Which auras to show in this frame"
L["Which tooltips to hide while in combat. Aura tooltips are shown natively by the game and can be kept visible."] = "Which tooltips to hide while in combat. Aura tooltips are shown natively by the game and can be kept visible."
L["Update interval"] = "Update interval"
L["Use Boss Mod Cast Name overrides"] = "Use Boss Mod Cast Name overrides"
L["Use spell name overrides provided by boss mods (BigWigs) on the cast bars."] = "Use spell name overrides provided by boss mods (BigWigs) on the cast bars."
L["Use the text settings below instead of the ones from the General tab."] = "Use the text settings below instead of the ones from the General tab."
...
L["When the unit is missing health, the [missinghp] tag is shown, when they are at full health then the [name] tag is shown. This lets you see -1000 when they are missing 1000 HP, but their name when they are not missing any.|n|nIn combat, health deficit only works on allied units."] = "When the unit is mising health, the [missinghp] tag is shown, when they are at full health then the [name] tag is shown. This lets you see -1000 when they are missing 1000 HP, but their name when they are not missing any.|n|nIn combat, health deficit only works on allied units."
...
L["You have entered combat, test mode has been disabled."] = "You have entered combat, test mode has been disabled."
L["You have entered combat, unit frames have been locked."] = "You have entered combat, unit frames have been locked."
...
L["You can then use these filters in the Auras tab of the player, target, raid, etc. modules, or assign them per zone type in the Zone Filters tab."] = "You can then use these filters in the Auras tab of the player, target, raid, etc. modules, or assign them per zone type in the Zone Filters tab."
...
L["You must enter a name."] = "You must enter a name."
...
L["You will need to create a filter in the Custom filters tab before you can assign it here."] = "You will need to create a filter in the Custom filters tab before you can assign it here."
...
L["Bar overlaid on the health bar with reverse fill, growing inward from the health fill edge."] = "Bar overlaid on the health bar with reverse fill, growing inward from the health fill edge."
L["Bar fills missing health then overflows as reverse overlay on the health bar."] = "Bar fills missing health then overflows as reverse overlay on the health bar."
L["Your buffs flagged to show on raid frames in combat."] = "Your buffs flagged to show on raid frames in combat."
