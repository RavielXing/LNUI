...
L["Apply the blacklist/whitelist from the Aura Filters tab to this frame. This is separate from the Blizzard API filter below."] = "Apply the blacklist/whitelist from the Aura Filters tab to this frame. This is separate from the Blizzard API filter below."
...
L["Disable dispel coloring"] = "Disable dispel coloring"
L["Disables the special border color for dispellable/purgeable auras. They will use school colors instead (Magic, Curse, Disease, Poison)."] = "Disables the special border color for dispellable/purgeable auras. They will use school colors instead (Magic, Curse, Disease, Poison)."
...
L["Blacklist / Whitelist"] = "Blacklist / Whitelist"
L["Blizzard frames"] = "Blizzard frames"
L["Shows the same auras that Blizzard's default unit frames display. Reads filtered data directly from Blizzard frames."] = "Shows the same auras that Blizzard's default unit frames display. Reads filtered data directly from Blizzard frames."
...
L["Clip"] = "Clip"
L["Combat auras"] = "Combat auras"
L["Combat debuffs"] = "Combat debuffs"
...
L["Allow clicks to pass through auras to select the unit behind them. Tooltips still work on hover."] = "Allow clicks to pass through auras to select the unit behind them. Tooltips still work on hover."
L["Enable"] = "Enable"
L["Enlarge auras for"] = "Enlarge auras for"
L["Enlarge my auras"] = "Enlarge my auras"
L["Fixed enlarged aura layout"] = "Fixed enlarged aura layout"
L["Fixed enlarged aura layout desc"] = "When enabled, always shows the configured number of auras per row regardless of enlarged aura size. Enlarged auras extend visually but do not reduce the number of auras per row."
...
L["Group/Raid debuffs"] = "Group/Raid debuffs"
...
L["My combat auras"] = "My combat auras"
L["My external defensives"] = "My external defensives"
L["My group/raid debuffs"] = "My group/raid debuffs"
L["Name"] = "Name"
...
L["Off:%s"] = "Off:%s"
L["Only shows buffs deemed useful in combat (e.g. HoTs)."] = "Only shows buffs deemed useful in combat (e.g. HoTs)."
...
L["Only shows buffs that can be purged, stolen or dispelled by your class."] = "Only shows buffs that can be purged, stolen or dispelled by your class."
...
L["Only shows debuffs deemed useful in combat by Blizzard."] = "Only shows debuffs deemed useful in combat by Blizzard."
...
L["Only shows debuffs whose dispel type matches your class (Holy Priest = Magic + Disease, Resto Druid = Magic + Curse + Poison, etc.)."] = "Only shows debuffs whose dispel type matches your class (Holy Priest = Magic + Disease, Resto Druid = Magic + Curse + Poison, etc.)."
L["Only shows debuffs you applied that are relevant in a group or raid context."] = "Only shows debuffs you applied that are relevant in a group or raid context."
L["Only shows debuffs you applied yourself."] = "Only shows debuffs you applied yourself."
L["Only shows your buffs deemed useful in combat by Blizzard."] = "Only shows your buffs deemed useful in combat by Blizzard."
...
L["Only Blizzard-whitelisted spells are available (guaranteed to work in combat)."] = "Only Blizzard-whitelisted spells are available (guaranteed to work in combat)."
...
L["Shows debuffs relevant in a group or raid context (boss mechanics, important debuffs)."] = "Shows debuffs relevant in a group or raid context (boss mechanics, important debuffs)."
