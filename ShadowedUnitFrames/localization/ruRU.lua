...
L["Click through"] = "Кликать сквозь"
L["Allow clicks to pass through auras to select the unit behind them. Tooltips still work on hover."] = "Позволяет кликать сквозь ауры для выбора юнита под ними. Всплывающие подсказки при наведении сохраняются."
L["Clip"] = "Cрезать"
...
L["Combat auras"] = "Боевые ауры"
L["Combat debuffs"] = "Боевые дебаффы"
...
L["Group/Raid debuffs"] = "Дебаффы группы/рейда"
...
L["My combat auras"] = "Мои боевые ауры"
L["Only shows your buffs deemed useful in combat by Blizzard."] = "Показывает только ваши баффы, признанные Blizzard полезными в бою."
L["My group/raid debuffs"] = "Мои дебаффы группы/рейда"
L["Only shows debuffs you applied that are relevant in a group or raid context."] = "Показывает только дебаффы, наложенные вами и актуальные в контексте группы или рейда."
L["Purgeable/Stealable"] = "Очищаемые/Похищаемые"
L["Only shows buffs deemed useful in combat (e.g. HoTs)."] = "Показывает только баффы, признанные Blizzard полезными в бою (напр. HoT'ы)."
...
L["Only shows buffs that can be purged, stolen or dispelled by your class."] = "Показывает только баффы, которые ваш класс может очистить, похитить или рассеять."
...
L["Only shows debuffs deemed useful in combat by Blizzard."] = "Показывает только дебаффы, признанные Blizzard полезными в бою."
...
L["Only shows debuffs whose dispel type matches your class (Holy Priest = Magic + Disease, Resto Druid = Magic + Curse + Poison, etc.)."] = "Показывает только дебаффы, чей тип рассеивания соответствует вашему классу (Свет-Жрец = Магия + Болезнь, Исцеление-Друид = Магия + Проклятие + Яд, и т.д.)."
...
L["Blacklist / Whitelist"] = "Чёрный список / Белый список"
L["Apply the blacklist/whitelist from the Aura Filters tab to this frame. This is separate from the Blizzard API filter below."] = "Применить чёрный или белый список из вкладки «Фильтры аур» к этому фрейму. Эта настройка не зависит от фильтра Blizzard ниже."
L["Whitelists will hide any aura not in the filter group.|nBlacklists will hide auras that are in the filter group.|nOnly Blizzard whitelisted spells (non-secret in combat) can be added to filters."] = "Белые списки скрывают ауры, отсутствующие в фильтре.|nЧёрные списки скрывают ауры, присутствующие в фильтре.|nДобавлять можно только заклинания, одобренные Blizzard (не секретные в бою)."
