...
L["Click through"] = "Cliquer au travers"
L["Allow clicks to pass through auras to select the unit behind them. Tooltips still work on hover."] = "Permet de cliquer au travers des auras pour sélectionner l'unité en dessous. Les infobulles au survol restent actives."
L["Clip"] = "Marge"
...
L["Combat auras"] = "Auras de combat"
L["Combat debuffs"] = "Affaiblissements de combat"
L["Crowd control effects"] = "Effets de contrôle"
L["Dispellable by me"] = "Dissipable par moi"
L["External defensives"] = "Défensifs externes"
L["Group/Raid Auras"] = "Auras de groupe/raid"
L["Group/Raid debuffs"] = "Affaiblissements de groupe/raid"
...
L["My combat auras"] = "Mes auras de combat"
L["Only shows your buffs deemed useful in combat by Blizzard."] = "N'affiche que vos buffs jugés utiles en combat par Blizzard."
L["My group/raid debuffs"] = "Mes affaiblissements de groupe/raid"
L["Only shows debuffs you applied that are relevant in a group or raid context."] = "N'affiche que les affaiblissements que vous avez appliqués et qui sont pertinents en groupe ou en raid."
L["Purgeable/Stealable"] = "Purgeable/Volable"
L["Only shows buffs deemed useful in combat (e.g. HoTs)."] = "N'affiche que les buffs jugés utiles en combat par Blizzard (ex. HoTs)."
...
L["Only shows buffs that can be purged, stolen or dispelled by your class."] = "N'affiche que les buffs qui peuvent être purgés, volés ou dissipés par votre classe."
...
L["Only shows debuffs deemed useful in combat by Blizzard."] = "N'affiche que les affaiblissements jugés utiles en combat par Blizzard."
...
L["Only shows debuffs whose dispel type matches your class (Holy Priest = Magic + Disease, Resto Druid = Magic + Curse + Poison, etc.)."] = "N'affiche que les affaiblissements dont le type de dissipation correspond à votre classe (Prêtre Sacré = Magie + Maladie, Druide Restauration = Magie + Malédiction + Poison, etc.)."
