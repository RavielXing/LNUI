...
L["%s frames"] = "%s 창"
L["%s member"] = "%s 구성원"
L["0 removes the cap (uses the frame's rows and icons per row)."] = "0은 제한을 없앱니다(창의 줄 수와 줄당 아이콘 수를 사용)."
L["A filter with this name already exists."] = "같은 이름의 필터가 이미 있습니다."
L["Accepts a spell ID, a spell link (shift-click a spell) or an exact spell name. You can also drag a spell from the spellbook onto this field. Spell names only resolve for spells your character currently knows; use the spell ID for anything else."] = "주문 ID, 주문 링크(주문을 Shift-클릭) 또는 정확한 주문 이름을 입력할 수 있습니다. 주문책에서 주문을 끌어다 놓을 수도 있습니다. 이름은 캐릭터가 아는 주문만 인식되며, 그 외에는 주문 ID를 사용하세요."
L["Add section"] = "섹션 추가"
L["Added %s (#%d)."] = "%s (#%d) 추가됨."
L["Adds an Essence bar for Evokers."] = "기원사의 정수 바를 추가합니다."
L["Adds another filter to this frame, shown after the previous sections. Overlaps are removed automatically."] = "이 창에 필터를 하나 더 추가하며, 이전 섹션들 뒤에 표시됩니다. 중복은 자동으로 제거됩니다."
L["Adds the spell ID to aura tooltips, handy for filling the spell fields of custom filters and aura indicators."] = "오라 툴팁에 주문 ID를 추가합니다. 사용자 지정 필터와 오라 표시기의 주문 칸을 채울 때 유용합니다."
L["All tooltips"] = "모든 툴팁"
L["All tooltips except auras"] = "오라를 제외한 모든 툴팁"
L["Anchor to buffs %d"] = "버프 %d에 고정"
L["Anchor to debuffs %d"] = "디버프 %d에 고정"
L["Anchors this buff frame to the corresponding debuff frame, positioning it after the last visible debuff."] = "이 버프 창을 해당 디버프 창에 고정하여 마지막으로 표시된 디버프 뒤에 배치합니다."
L["Anchors this debuff frame to the corresponding buff frame, positioning it after the last visible buff."] = "이 디버프 창을 해당 버프 창에 고정하여 마지막으로 표시된 버프 뒤에 배치합니다."
L["Any dispellable"] = "해제 가능한 모든 오라"
L["Application order"] = "적용 순서"
L["Assign a filter to each unit frame per zone type. Filters are created and edited in the Custom filters tab."] = "구역 유형별로 각 유닛 창에 필터를 지정합니다. 필터는 사용자 지정 필터 탭에서 만들고 편집합니다."
L["Aura borders keep their neutral color instead of being tinted by dispel type. Has no effect with the Blizzard border style."] = "오라 테두리가 해제 유형 색 대신 중립 색상을 유지합니다. 블리자드 테두리 스타일에는 적용되지 않습니다."
L["Big defensives first"] = "주요 방어기 우선"
L["Bleed"] = "출혈"
L["Blizzard only applies spell filters to buffs on friendly units and to debuffs on hostile units, plus any spell it flags as never secret."] = "블리자드는 아군 유닛의 버프와 적 유닛의 디버프에만 주문 필터를 적용하며, 절대 비밀이 아닌 것으로 표시된 주문도 포함됩니다."
L["Border coloring of stealable buffs. Replaces the dispel type color on those auras."] = "훔치기 가능한 버프의 테두리 색상입니다. 해당 오라의 해제 유형 색상을 대체합니다."
L["Buffs flagged by Blizzard to show on raid frames in combat, HoTs mostly."] = "블리자드가 전투 중 공격대 창에 표시하도록 지정한 버프로, 대부분 HoT입니다."
L["Cancelable auras"] = "취소 가능한 오라"
L["Cancelable Auras"] = "취소 가능한 오라"
L["Class auras (group, raid)"] = "직업 오라(파티, 공격대)"
L["Color and opacity of the overlay pulsing on your own auras inside their pandemic window. Enabled in the general aura settings."] = "자신의 오라가 판데믹 구간에 있을 때 깜박이는 오버레이의 색상과 불투명도입니다. 일반 오라 설정에서 활성화합니다."
L["Colors used for dispel type coloring: aura borders, health bar tinting and dispel highlighting."] = "해제 유형 색상에 사용되는 색입니다: 오라 테두리, 생명력 바 색조, 테두리 강조."
L["Contextual auras (group, raid)"] = "상황별 오라(파티, 공격대)"
L["Cooldown swipe opacity"] = "재사용 대기시간 스와이프 불투명도"
L["Create filter"] = "필터 만들기"
L["Curated list of class and healer spells. Combat display works for buffs on friendly units; the missing option requires a Blizzard-whitelisted spell."] = "엄선된 직업 및 힐러 주문 목록입니다. 전투 중 표시는 아군 유닛의 버프에서 작동하며, \"없을 때\" 옵션은 블리자드 화이트리스트 주문이 필요합니다."
L["Curse"] = "저주"
L["Custom"] = "사용자 지정"
L["Custom filters"] = "사용자 지정 필터"
L["Custom filters let you build aura filters from a spell's name or spell ID. Pick a mode when creating one: \"Show only matching spells\" or \"Hide matching spells\"."] = "사용자 지정 필터는 주문 이름이나 주문 ID로 오라 필터를 만듭니다. 만들 때 모드를 선택하세요: \"목록의 주문만 표시\" 또는 \"목록의 주문 숨기기\"."
L["Default"] = "기본값"
L["Disable dispel type borders"] = "해제 유형 테두리 비활성화"
L["Disable right-click cancel"] = "우클릭 취소 비활성화"
L["Disable stack counts"] = "중첩 표시 비활성화"
L["Disable stealable coloring"] = "훔치기 가능 색상 비활성화"
L["Disease"] = "질병"
L["Dispellable Auras"] = "해제 가능한 오라"
L["Dispellable by group"] = "파티가 해제 가능"
L["Dispellable by my group"] = "내 파티가 해제 가능"
L["Enable"] = "활성화"
L["Enlarge my auras"] = "내 오라 확대"
L["Enlarged scale"] = "확대 배율"
L["Enrage"] = "격노"
L["Expiration"] = "만료"
...
L["In combat, Blizzard only applies spell filters to buffs on friendly units and debuffs on hostile units, plus spells it flags as never secret."] = "전투 중 블리자드는 아군 유닛의 버프와 적 유닛의 디버프에만 주문 필터를 적용하며, 절대 비밀이 아닌 주문도 포함됩니다."
L["Link from"] = "연결 원본"
L["Link to"] = "연결 대상"
L["Magic"] = "마법"
L["Max icons"] = "최대 아이콘"
...
L["Move up"] = "위로"
L["My Auras"] = "내 오라"
L["My HoTs & raid frames buffs"] = "내 HoT 및 공격대 창 버프"
L["Name (yours first)"] = "이름(내 것 우선)"
L["Neighborhood"] = "주거 지역"
L["Only shows auras that have a dispel type, whether or not anyone in your group can dispel them."] = "파티원이 해제할 수 있는지와 관계없이 해제 유형이 있는 오라만 표시합니다."
L["Only shows buffs that someone in your group can purge, steal or dispel."] = "파티의 누군가가 정화, 훔치기 또는 해제할 수 있는 버프만 표시합니다."
L["Only shows debuffs that someone in your group can dispel (you, when solo)."] = "파티의 누군가가 해제할 수 있는 디버프만 표시합니다(솔로일 때는 본인)."
L["Only shows debuffs that you can dispel."] = "내가 해제할 수 있는 디버프만 표시합니다."
L["Opacity of the dark overlay showing the remaining time on auras."] = "오라의 남은 시간을 보여주는 어두운 오버레이의 불투명도입니다."
L["Pandemic overlay"] = "판데믹 오버레이"
L["Poison"] = "독"
L["Private auras from bosses and encounters displayed using Blizzard's secure API."] = "블리자드의 보안 API로 표시되는 우두머리와 전투의 비공개 오라입니다."
L["Profile changes will be applied after combat."] = "프로필 변경은 전투 후 적용됩니다."
L["Pulses an overlay on your own auras inside their pandemic window, where refreshing them carries the remaining time over. Color and opacity are set in the Colors tab."] = "자신의 오라가 판데믹 구간에 있을 때 오버레이가 깜박입니다. 이 구간에서 갱신하면 남은 시간이 이어집니다. 색상과 불투명도는 색상 탭에서 설정합니다."
L["Returns the scaled threat percentage for the unit, if you put this on a party member you would see the percentage of how close they are to getting any from any hostile mobs. Always 0 - 100%.|nThis cannot be used on target of target or focus target types of units."] = "유닛의 위협 수준 비율을 반환합니다. 파티원에게 사용하면 적대적 몹의 위협 수준에 얼마나 근접했는지 비율로 보입니다. 항상 0 - 100%입니다.|n대상의 대상이나 주시 대상 유형 유닛에는 사용할 수 없습니다."
L["Right-clicking your own buffs cancels them; enable this to turn that off."] = "자신의 버프를 우클릭하면 취소됩니다. 이 동작을 끄려면 이 옵션을 활성화하세요."
L["Scale multiplier applied to player auras when enlargement is enabled."] = "확대가 활성화됐을 때 플레이어 오라에 적용되는 배율입니다."
L["Scale up auras that were cast by the player to make them more visible."] = "플레이어가 시전한 오라를 확대해 더 잘 보이게 합니다."
L["Section"] = "섹션"
L["Sections add extra filters to this frame, shown after the main filter. Auras already shown by a previous section are removed automatically. Each section has its own icon size, sorting and icon cap."] = "섹션은 주 필터 뒤에 표시되는 추가 필터입니다. 이전 섹션에 이미 표시된 오라는 자동으로 제거됩니다. 각 섹션은 자체 아이콘 크기, 정렬, 아이콘 제한을 가집니다."
L["Shadow"] = "그림자"
...
L["Show only matching spells"] = "목록의 주문만 표시"
L["Show spell IDs in aura tooltips"] = "오라 툴팁에 주문 ID 표시"
L["Shows placeholder auras on this unit's frames to preview positioning."] = "이 유닛의 창에 예시 오라를 표시해 위치를 미리 봅니다."
L["Some aura changes are deferred while combat restrictions are active (combat, dungeons, raids)."] = "전투 제한이 활성화된 동안(전투, 던전, 공격대) 일부 오라 변경은 보류됩니다."
L["Spell"] = "주문"
L["Stacks"] = "중첩"
L["Stacks font"] = "중첩 글꼴"
L["Stealable"] = "훔치기 가능"
L["Stealable buffs are tinted by dispel type like the others."] = "훔치기 가능한 버프도 다른 오라처럼 해제 유형에 따라 색이 입혀집니다."
L["Test mode"] = "테스트 모드"
L["Test mode cannot be toggled while in combat."] = "전투 중에는 테스트 모드를 전환할 수 없습니다."
L["Timer"] = "타이머"
L["Timer font"] = "타이머 글꼴"
L["Unit changes will be applied after combat."] = "유닛 변경은 전투 후 적용됩니다."
L["Unit frame debuff order"] = "유닛 창 디버프 순서"
L["Unit frames cannot be unlocked while in combat."] = "전투 중에는 유닛 창을 잠금 해제할 수 없습니다."
...
L["You have entered combat, test mode has been disabled."] = "전투에 진입하여 테스트 모드가 비활성화되었습니다."
L["You have entered combat, unit frames have been locked."] = "전투에 진입하여 유닛 창이 잠겼습니다."
L["You must enter a name."] = "이름을 입력해야 합니다."
L["You will need to create a filter in the Custom filters tab before you can assign it here."] = "여기에 지정하려면 먼저 사용자 지정 필터 탭에서 필터를 만들어야 합니다."
L["Your buffs flagged to show on raid frames in combat."] = "전투 중 공격대 창에 표시되도록 지정된 내 버프입니다."
L["Zone Filters"] = "구역 필터"
...
L["Adds a bar indicating how much time is left on your statue."] = "조각상의 남은 시간을 표시하는 바를 추가합니다."
...
L["Ammo"] = "탄약류"
L["Amount of health missing, if none is missing nothing is shown. Uses a short format, -18500 is shown as -18.5k, values below 10000 are formatted as is.|n|nIn combat, may show -0 at full health due to secret values."] = "생명력 감소량으로, 없으면 아무것도 표시되지 않습니다. 짧은 형태를 사용해 -18500은 -18.5k로 10000 미만 값은 그대로 표시됩니다.|n|n전투 중, 생명력이 가득 차면 Secret Values로 인해 -0이 표시될 수 있습니다."
L["Amount of power missing,  if none is missing nothing is shown. Uses a short format, -13850 is shown as 13.8k, values below 10000 are formatted as is.|n|nIn combat, may show -0 at full power due to secret values."] = "자원 감소량으로, 없으면 아무것도 표시되지 않습니다. 짧은 형태를 사용해 -13850은 13.8k로 10000 미만 값은 그대로 표시됩니다.|n|n전투 중, 자원이 가득 차면 Secret Values로 인해 -0이 표시될 수 있습니다."
L["Anchor point"] = "부착 지점"
L["Override General text settings"] = "일반 텍스트 설정 재정의"
L["Use the text settings below instead of the ones from the General tab."] = "일반 탭의 설정 대신 아래의 텍스트 설정을 사용합니다."
L["Anchor to"] = "부착"
L["Anchor to another frame"] = "다른 창에 부착"
L["Anchor to buffs"] = "버프에 부착"
L["Anchor to debuffs"] = "디버프에 부착"
L["Controls how the anchored aura frame is positioned relative to the parent frame."] = "연결된 오라 프레임이 상위 프레임에 대해 어떻게 배치되는지 제어합니다."
L["New row"] = "새 줄"
L["Sequential"] = "순차적"
...
L["Direction aura icons fill within a row."] = "오라 아이콘이 행에서 채워지는 방향입니다."
L["Direction new rows of auras stack."] = "오라의 새 행이 쌓이는 방향입니다."
...
L["Name (NSRT Nickname)"] = "이름 (NSRT 별명)"
L["Name (NSRT Nickname/Class colored)"] = "이름 (NSRT 별명/직업 색상)"
L["Name (NSRT Nickname/Abbreviated)"] = "이름 (NSRT 별명/약식)"
L["Unit name replaced by NSRT nickname if available. Falls back to the regular name if NSRT is not installed or no nickname is set."] = "NSRT 별명이 있으면 유닛 이름 대신 표시합니다. NSRT가 설치되지 않았거나 별명이 설정되지 않은 경우 일반 이름을 표시합니다."
L["NSRT nickname colored by class. Falls back to the regular name if NSRT is not installed or no nickname is set.|n|nIn combat, shows uncolored name on enemy units."] = "직업 색상이 적용된 NSRT 별명. NSRT가 설치되지 않았거나 별명이 설정되지 않은 경우 일반 이름을 표시합니다.|n|n전투 중 적 유닛에는 색상 없는 이름을 표시합니다."
L["Abbreviated NSRT nickname (if longer than 10 characters). Falls back to the regular name if NSRT is not installed or no nickname is set.|n|nIn combat, shows full (non-abbreviated) name on enemy units."] = "NSRT 별명 약식 (10자 이상일 경우). NSRT가 설치되지 않았거나 별명이 설정되지 않은 경우 일반 이름을 표시합니다.|n|n전투 중 적 유닛에는 전체 이름을 표시합니다."
...
L["Health bar"] = "생명력 바"
L["Frame"] = "프레임"
L["Health fill (reverse)"] = "생명력 채움 (역방향)"
L["Health bar (fill + reverse overlay)"] = "생명력 바 (채움 + 역방향 오버레이)"
L["Bar anchored to the end of the health bar, growing outward (uses overflow limit)."] = "생명력 바 끝에 고정되어 바깥으로 늘어남 (넘침 한계 사용)."
L["Bar anchored to the frame edge, growing inward with reverse fill."] = "프레임 가장자리에 고정되어 역방향 채움으로 안쪽으로 늘어남."
L["Bar overlaid on the health bar with reverse fill, growing inward from the health fill edge."] = "역방향 채움으로 생명력 바 위에 겹쳐져 채움 가장자리에서 안쪽으로 늘어남."
L["Bar fills missing health then overflows as reverse overlay on the health bar."] = "부족한 생명력을 채운 후 생명력 바 위에 역방향 겹침으로 넘침."
...
L["Percent of the players current health that's being healed, if they have 100,000 total health and 15,000 is incoming then 15% is shown.|n|nIn combat, only works on allied units."] = "치유 중인 플레이어의 현재 백분율 생명력으로 총 생명력이 100,000이고 15,000이 들어오는 경우 15%가 표시됩니다."
...
L["Position"] = "위치"
L["Position of the bar when thickness is less than 100%."] = "두께가 100% 미만일 때 바의 위치입니다."
L["Positioning"] = "위치 지정"
L["Power"] = "자원"
L["Power bar"] = "자원 바"
L["Power Type"] = "자원 유형"
...
L["Relative size of the bar perpendicular to the fill direction. 100% matches the health bar exactly."] = "채우기 방향에 수직인 바의 상대적 크기입니다. 100%는 생명력 바와 정확히 일치합니다."
L["Resources"] = "참고자료"
...
L["Shorten damage absorption, if 13,000 damage will be absorbed, it will show 13k."] = "짧게 표시한 피해 흡수량으로, 피해량 13,000이 흡수되는 경우 13k로 표시합니다."
...
L["Unit name colored by class.|n|nIn combat, shows uncolored name on enemy units."] = "직업별 색상이 지정된 유닛 이름입니다.|n|n전투 중에는 적 유닛의 이름이 색상 없이 표시됩니다."
...
L["When the unit is mising health, the [missinghp] tag is shown, when they are at full health then the [name] tag is shown. This lets you see -1000 when they are missing 1000 HP, but their name when they are not missing any.|n|nIn combat, health deficit only works on allied units."] = "유닛의 생명력이 빠진 경우 [missinghp] 태그가, 생명력이 가득찬 경우에는 [name] 태그가 표시됩니다. 이렇게 하면 생명력 1000이 감소한 경우 -1000이 보이지만 감소하지 않은 때는 이름이 보입니다.|n|n전투 중에는 생명력 결손이 아군 유닛에서만 작동합니다."
...
-- 12.0 Aura filters
L["Big defensive cooldowns"] = "주요 방어 쿨다운"
L["Center Left"] = "중앙 왼쪽"
L["Center Right"] = "중앙 오른쪽"
L["Class-filtered auras"] = "직업별 오라"
L["Crowd control effects"] = "군중 제어 효과"
L["Dispellable by me"] = "내가 해제 가능"
L["External defensives"] = "외부 방어 효과"
L["Group/Raid Auras"] = "파티/공격대 오라"
L["Important auras"] = "중요한 오라"
L["My big defensives"] = "내 주요 방어 효과"
L["My class auras"] = "내 직업 오라"
L["My external defensives"] = "내 외부 방어 효과"
L["Purgeable/Stealable"] = "정화 가능/훔치기 가능"
L["Only shows buffs marked as important by Blizzard. Server-maintained list."] = "블리자드가 중요하다고 표시한 강화 효과만 표시합니다. 서버 관리 목록."
L["Only shows buffs you cast yourself."] = "본인이 시전한 강화 효과만 표시합니다."
L["Only shows buff types that your class can cast (e.g. a Priest sees Fortitude and Renew), regardless of who cast them."] = "당신의 직업이 시전할 수 있는 강화 효과 유형만 표시합니다 (예: 사제는 인내와 소생만 표시). 시전자와 무관합니다."
L["Only shows crowd control effects (Stun, Root, Silence, Fear, Polymorph, Cyclone, etc.)."] = "군중 제어 효과만 표시합니다 (기절, 이동 불가, 침묵, 공포, 변이, 회오리 등)."
L["Only shows debuffs marked as important by Blizzard. Server-maintained list."] = "블리자드가 중요하다고 표시한 약화 효과만 표시합니다. 서버 관리 목록."
L["Only shows debuffs you applied yourself."] = "본인이 적용한 약화 효과만 표시합니다."
L["Only shows defensive buffs received from another player (Pain Suppression, Ironbark, Life Cocoon, etc.)."] = "다른 플레이어에게 받은 방어 강화 효과만 표시합니다 (고통 억제, 무쇠껍질, 생명의 고치 등)."
L["Only shows external defensives that you cast on someone."] = "당신이 다른 대상에게 시전한 외부 방어 효과만 표시합니다."
L["Only shows major defensive cooldowns (Shield Wall, Ice Block, Divine Shield, etc.). List maintained by Blizzard."] = "주요 방어 쿨다운만 표시합니다 (방패의 벽, 얼음 방패, 천상의 보호막 등). 블리자드 관리 목록."
L["Only shows major defensive cooldowns that you activated yourself."] = "본인이 활성화한 주요 방어 쿨다운만 표시합니다."
L["Only shows your class buff types that you cast yourself."] = "본인이 시전한 직업 강화 효과 유형만 표시합니다."
L["Shows all buffs on the unit without any filtering."] = "필터 없이 대상의 모든 강화 효과를 표시합니다."
L["Shows all debuffs on the unit without any filtering."] = "필터 없이 대상의 모든 약화 효과를 표시합니다."

-- Performance
L["Performance"] = "성능"
L["Performance settings"] = "성능 설정"
L["Adjust polling and refresh rates for various addon subsystems. Lower values = more responsive but higher CPU usage. Higher values = less CPU but slower updates."] = "애드온 모듈의 갱신 주기를 조정합니다. 낮은 값 = 더 빠른 반응이지만 CPU 사용량 증가. 높은 값 = CPU 부담 감소, 갱신 속도 저하."
L["Range check interval"] = "거리 확인 주기"
L["How often to check if units are in range (seconds)."] = "대상이 범위 내에 있는지 확인하는 주기 (초)."
L["Fast tag refresh"] = "빠른 태그 갱신"
L["Refresh rate for rapidly changing tags like health/power percent (seconds)."] = "생명력/자원 퍼센트 등 빠르게 변하는 태그의 갱신 주기 (초)."
L["Normal tag refresh"] = "보통 태그 갱신"
L["Refresh rate for standard dynamic tags (seconds)."] = "일반적인 동적 태그의 갱신 주기 (초)."
L["Slow tag refresh"] = "느린 태그 갱신"
L["Refresh rate for slowly changing tags like AFK timers (seconds)."] = "자리비움 타이머 등 느리게 변하는 태그의 갱신 주기 (초)."
L["Fake cast monitor"] = "가상 시전 모니터"
L["Polling rate for cast bars on non-event units like focus target (seconds)."] = "주시 대상 등 이벤트 없는 유닛의 시전바 확인 주기 (초)."
L["Combat indicator"] = "전투 표시기"
L["How often to poll NPC combat status for the combat indicator (seconds)."] = "전투 표시기를 위한 NPC 전투 상태 확인 주기 (초)."
L["Temp enchant scan"] = "임시 마법부여 스캔"
