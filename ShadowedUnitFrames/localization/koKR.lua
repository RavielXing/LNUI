...
L["Allow clicks to pass through auras to select the unit behind them. Tooltips still work on hover."] = "오라 아이콘을 통과하여 아래에 있는 유닛을 선택할 수 있습니다. 마우스를 올리면 툴팁은 정상적으로 표시됩니다."
L["Clip"] = "테두리 간격"
L["Close color"] = "색상 닫기"
...
L["Combat auras"] = "전투 오라"
L["Combat debuffs"] = "전투 약화 효과"
L["Crowd control effects"] = "군중 제어 효과"
L["Dispellable by me"] = "내가 해제 가능"
L["External defensives"] = "외부 방어 효과"
L["Group/Raid Auras"] = "파티/공격대 오라"
L["Group/Raid debuffs"] = "파티/공격대 약화 효과"
L["Important auras"] = "중요한 오라"
L["My big defensives"] = "내 주요 방어 효과"
L["My class auras"] = "내 직업 오라"
L["My external defensives"] = "내 외부 방어 효과"
L["My combat auras"] = "내 전투 오라"
L["Only shows your buffs deemed useful in combat by Blizzard."] = "블리자드가 전투에서 유용하다고 판단한 본인의 강화 효과만 표시합니다."
L["My group/raid debuffs"] = "내 파티/공격대 약화 효과"
L["Only shows debuffs you applied that are relevant in a group or raid context."] = "파티 또는 공격대에서 관련 있는 내가 적용한 약화 효과만 표시합니다."
L["Purgeable/Stealable"] = "정화 가능/훔치기 가능"
L["Only shows buffs deemed useful in combat (e.g. HoTs)."] = "블리자드가 전투에서 유용하다고 판단한 강화 효과만 표시합니다 (예: 지속 치유)."
L["Only shows buffs marked as important by Blizzard. Server-maintained list."] = "블리자드가 중요하다고 표시한 강화 효과만 표시합니다. 서버 관리 목록."
L["Only shows buffs that can be purged, stolen or dispelled by your class."] = "당신의 직업이 정화, 훔치기 또는 해제할 수 있는 강화 효과만 표시합니다."
...
L["Only shows debuffs deemed useful in combat by Blizzard."] = "블리자드가 전투에서 유용하다고 판단한 약화 효과만 표시합니다."
L["Only shows debuffs marked as important by Blizzard. Server-maintained list."] = "블리자드가 중요하다고 표시한 약화 효과만 표시합니다. 서버 관리 목록."
L["Only shows debuffs whose dispel type matches your class (Holy Priest = Magic + Disease, Resto Druid = Magic + Curse + Poison, etc.)."] = "당신의 직업이 해제할 수 있는 약화 효과만 표시합니다 (신성 사제 = 마법 + 질병, 회복 드루이드 = 마법 + 저주 + 독 등)."
...
L["Shows debuffs relevant in a group or raid context (boss mechanics, important debuffs)."] = "파티 또는 공격대에서 관련 있는 약화 효과를 표시합니다 (보스 메커닉, 중요한 약화 효과)."
