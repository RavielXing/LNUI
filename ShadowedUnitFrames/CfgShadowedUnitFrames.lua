...
U1RegisterAddon("ShadowedUnitFrames", {
    title = LOCALE_zhCN and "SUF头像增强" or "SUF頭像增強",
    defaultEnable = 0,
    load = "NORMAL",
    optionsAfterLogin = 1,
    -- weakConflicts = { "HealthBarColor", "Adapt" },
    tags = { TAG_INTERFACE, TAG_GOOD },
    icon = [[Interface\AddOns\ShadowedUnitFrames\media\textures\suf]],
    desc = LOCALE_zhCN and "定制型很强的著名头像插件`配置命令 /suf`解锁命令 /suf lock" or "定製型很強的著名頭像插件`配置命令 /suf`解鎖命令 /suf lock",
    ...
    {
        type = 'button',
        text = LOCALE_zhCN and '锁定解锁框架' or '鎖定解鎖框架',
        callback = function()
    ...
    {
        text = LOCALE_zhCN and '选择预设方案' or '選擇預設方案',
        type = 'radio',
        var = 'prestyle',
        default = (GetScreenWidth() <= 1280) and "COMPACT" or "MINI",
        options = {'简洁文字型', 'TEXT', '头像贯通型', 'CENTER', "左右头像型", "SIDE"},
        secure = 1,
        confirm = LOCALE_zhCN and "注意：当前SUF设置将重置，您是否确定？" or "註意：當前SUF設置將重置，您是否確定？",
        tip = LOCALE_zhCN and "说明`预设了几套方案，感谢玩家叶心安提供的配置。注意，每次切换方案会把当前方案保存在'备份'方案中，可以恢复，但连续切换就无法恢复了。" or "說明`預設了幾套方案，感謝群友葉心安提供的配置。註意，每次切換方案會把當前方案保存在'備份'方案中，可以恢復，但連續切換就無法恢復了。",
        callback = function(cfg, v, loading)
            if(loading) then return end
            if ShadowUF.db:GetCurrentProfile() == "备份" then
                return U1Message(LOCALE_zhCN and "请不要在SUF界面里选择'备份'方案" or "請不要在SUF界面裏選擇'備份'方案")
            end
    ...
    {
        type = 'button',
        text = LOCALE_zhCN and '恢复备份方案' or '恢復備份方案',
        callback = function()
            if ShadowUF.db:GetCurrentProfile() == "备份" then
                return U1Message(LOCALE_zhCN and "请不要在SUF界面里选择'备份'方案" or "請不要在SUF界面裏選擇'備份'方案")
            end
            ShadowUF.db:CopyProfile("备份", true)
    ...
    TEXT = {
      ...
      units = {
        ...
        player = {
          ...
          chi = { height = 0.8, },
          combatText = { enabled = false, height = 0.5, },
          comboPoints = { anchorPoint = "TR", growth = "DOWN", height = 1, isBar = true, size = 15, spacing = 5, x = 6, y = 1, },
          ...
          text = {
            { anchorPoint = "C", size = 2, text = "[( )level] [( )name]", width = 10, x = 0, y = 17 , },--LNui：纯文字头像自己框架
            { anchorPoint = "C", text = "[( )curhp] | [( )perhp]", width = 10, x = 0, y = -3, },--LNui：纯文字头像自己框架
            -- { anchorPoint = "LC", size = -2, text = "[level]", width = 10, x = 25, },--LNui：纯文字头像自己框架
            -- { anchorPoint = "RC", size = -2, text = "[perpp]", width = 10, x = -35, },--LNui：纯文字头像自己框架
            { anchorPoint = "RC", size = -2, text = "[curpp] | [perpp]", width = 0, x = -60, },--LNui：纯文字头像自己框架
            { anchorTo = "", text = "", },
            { anchorTo = "", text = "", },
            { anchorTo = "", text = "", },
            { anchorTo = "$staggerBar", block = false, name = "文字", text = "[monk:abs:stagger]", width = 1, },
        ...
        target = {
          ...
          scale = 1.2,
          text = {
            { anchorPoint = "C", size = 1, text = "[( )level] [name]", width = 10, x = 0, y = 17, },--LNui：纯文字头像目标框架
            { anchorPoint = "C", size = 1, text = "[( )curhp] | [( )perhp]", width = 10, x = 0, y = -3, },--LNui：纯文字头像目标框架
            -- { anchorPoint = "LC", size = -2, text = "[( )level]", width = 10, x = 30, },--LNui：纯文字头像目标框架
            { anchorPoint = "RC", size = -2, text = "[perpp]", width = 10, x = -35, },--LNui：纯文字头像目标框架
            { size = -2, text = "[classification]", width = 10, x = 0, y = 35, },--LNui：纯文字头像目标框架
          },
          width = 200,
        },
        targettarget = {
    ...
    CENTER = {
      ...
      units = {
        ...
        player = {
          ...
          chi = { height = 1.2, },
          combatText = { enabled = false, height = 0.5, },
          comboPoints = { anchorPoint = "TC", growth = "RIGHT", height = 1, isBar = true, size = 15, spacing = -3, x = 25, y = -5, },
          druidBar = { background = false, height = 0, order = 0, reverse = false, vertical = false, },
          emptyBar = {
            backgroundColor = { b = 0, g = 0, r = 0, },
            class = false,
          ...
          text = {
            { anchorPoint = "LC", size = 1, text = "[level] [name]", width = 10, x = 90, y = 13, },--LNui：贯穿头像自己框架
            { anchorPoint = "RC", size = -1, text = "[( )curhp] | [( )perhp]", width = 5, x = -90, y = 11, },--LNui：贯穿头像自己框架
            -- { anchorPoint = "LC", size = -2, text = "[level]", width = 10, x = 25, },--LNui：贯穿头像自己框架
            -- { anchorPoint = "RC", size = -2, text = "[perpp]", width = 10, x = -35, },--LNui：贯穿头像自己框架
            { anchorPoint = "RC", size = -2, text = "[curpp] | [perpp]", width = 0, x = -60, },--LNui：纯文字头像自己框架
            { anchorTo = "", text = "", },
            { anchorTo = "", text = "", },
            { anchorTo = "", text = "", },
        ...
        target = {
          ...
          scale = 1.2,
          text = {
            { anchorPoint = "C", size = 1, text = "[( )level] [name]", width = 10, x = -55, y = 13, },--LNui：贯穿头像目标框架
            { anchorPoint = "C", size = -1, text = "[( )curhp] | [( )perhp]", width = 10, x = 50, y = 11, },--LNui：贯穿头像目标框架
            -- { anchorPoint = "LC", size = -2, text = "[( )level]", width = 10, x = 25, },--LNui：贯穿头像目标框架
            { anchorPoint = "RC", size = -2, text = "[perpp]", width = 10, x = -35, },--LNui：贯穿头像目标框架
            { size = -2, text = "[classification]", width = 10, x = 0, y = 55, },--LNui：贯穿头像目标框架
          },
          width = 200,
        },
        targettarget = {
    ...
    SIDE = {
      ...
      units = {
        ...
        player = {
          ...
          chi = { height = 0.7, },
          combatText = { enabled = false, height = 0.5, },
          comboPoints = { anchorPoint = "TC", growth = "RIGHT", isBar = true, size = 15, spacing = -3, x = 30, y = -3, },
          druidBar = { background = false, height = 0, order = 0, reverse = false, vertical = false, },
          emptyBar = {
            backgroundColor = { b = 0, g = 0, r = 0, },
            class = false,
          ...
          soulShards = { height = 1, },
          text = {
            { anchorPoint = "C", text = "[( )level] [( )name]", width = 10, x = -10, y = 20, },--LNui：左右头像型自己框架
            { anchorPoint = "C", text = "[( )curhp] | [( )perhp]", width = 10, x = 0, },--LNui：左右头像型自己框架
            -- { anchorPoint = "RC", text = "[perhp]", width = 5, x = -40, },--LNui：左右头像型自己框架
            -- { anchorPoint = "C", size = -2, text = "[level]", width = 5, x = 23, },--LNui：左右头像型自己框架
            { anchorPoint = "RC", size = -2, text = "[curpp] | [perpp]", width = 0, x = -60, },--LNui：左右头像型自己框架
            -- nil,
            -- nil,
            { anchorTo = "", text = "", },
            { anchorTo = "", text = "", },
        ...
        target = {
          ...
          scale = 1.2,
          text = {
            { anchorPoint = "C", text = "[( )curhp] |", width = 10, x = -10, },--LNui：左右头像目标框架
            { anchorPoint = "RC", text = "[dechp] [( )rare]", width = 10, x = -70, },--LNui：左右头像目标框架
            { anchorPoint = "C", text = "[( )level] [( )name]", width = 10, x = -10, y = 42, },--LNui：左右头像目标框架
            { anchorPoint = "RC", size = -2, text = "[( )perpp]", width = 3, x = -40, },--LNui：左右头像目标框架
            -- { anchorPoint = "LC", size = -2, text = "[level]", width = 10, x = 25, },--LNui：左右头像目标框架
            { anchorPoint = "C", x = 0, },
          },
          width = 240,
        },
