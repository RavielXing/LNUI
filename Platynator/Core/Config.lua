...
local settings = {
  ...
  LEGACY_SIMPLIFIED_NAMEPLATES = {key = "simplified_nameplates", default = {minion = true, minor = false, instancesNormal = true}},--lnui
  ...
  SHOW_NAMEPLATES = {key = "show_nameplates", default = {
    friendlyNPC = false, friendlyPlayer = false, friendlyMinion = false, enemy = true, enemyMinion = true, enemyMinor = true
  }, refresh = {addonTable.Constants.RefreshReason.ShowBehaviour}},--lnui
  SHOW_FRIENDLY_IN_INSTANCES = {key = "show_friendly_in_instances_1", default = "never", refresh = {addonTable.Constants.RefreshReason.ShowBehaviour}},--lnui
