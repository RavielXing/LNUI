...
function addon.tsv:AddTrueStatValuesTooltip(tooltip, statId)
    ...
    local barLabel =
        ...
        "/" .. tostring(statInfo.bracketMaxRating) .. " [当前" .. pctLabel .. " 递减]"
    ...
    tooltip:AddDoubleLine("档位数值：", statInfo.trueRating, r, g, b, r, g, b)
    tooltip:AddDoubleLine("溢出数值：", lostRating, r, g, b, r, g, b)
