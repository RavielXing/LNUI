...
rematch.constants = {
    ...
    -- petpanel search + stat row heights, with the optional typebar collapsed/expanded
    PETPANEL_TOP_COLLAPSED_HEIGHT = 56,
    PETPANEL_TOP_EXPANDED_HEIGHT = 115,
    -- typebar constants
    TYPEBAR_TAB_TYPE = 1,
    ...
    -- help text
    HELP_TEXT_PET_FILTER = L["In addition to the filters in this menu, you can further refine the pet list with the search box. Some search examples:\n\nPets: %sBlack Tabby\124r\nZones: %sSilithus\124r\nAbilities: %sSandstorm\124r\nText in abilities: %sBleed\124r\nLevels: %slevel=21-23\124r\nStats: %sspeed>300\124r\n\nSearches in \"quotes\" will limit results to only complete matches.\n\nSearch results will be sorted by relevance unless the option %sDon't Sort By Relevance\124r is checked in the Options tab."]..L["\n\nTo require multiple abilities, separate two or three ability names with commas, such as %sBite, Solar Beam, Sunlight\124r. The HP, Power and Speed fields accept <, = or > followed by a number. Uncollected pets use possible rare level 25 breed stats; each entered stat may be satisfied by a different breed."],
