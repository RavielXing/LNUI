...
local DEFAULT_SETTINGS = {
    ...
    routeAutoAdvance   = true,      -- a route moves on once you reach a stop
    showRoutePath      = true,      -- draw the route's legs on the world map
    showMinimapRoute   = true,      -- point at the next stop from the minimap
    guideWindowWidth   = nil,       -- set once the guide window is dragged wider
    guideWindowScale   = 1.0,       -- step tracker / route window scale
    rareMountAlerts    = true,      -- flag rares that drop a mount you're missing
