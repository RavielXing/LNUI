...
MCLcore.mountList[2] = {
	...
	categories = {
		Achievement = {
			name = "Achievement",
			mounts = {168056, 168055, 169162, 169194, 168329, 161215, 163216, 166539, 167171, 174861, 174654, 235515},
			mountID = {}
		},
		AlliedRaces = {
			name = "Allied Races",
...
MCLcore.mountList[17] = {
	...
	categories = {
		...
		Promotion = {
			...
			mounts = {95341, 112327, 92724, 143631, 163127, 43599, 151618, 151617, 258430, 246445, 217340},
			mountID = {}
		},
		RAF = {
			name = "Recruit-A-Friend",
...
MCLcore.mountList[18] = {
	...
	categories = {
		Achievement = {
			name = "Achievement",
			mounts = {192806, 192784, 205205, 208152, 210060, 192774, 210142, "m1614", 198822, 192792, 192788, 211862, 192765, "m1733"},
			mountID = {}
		},
		DragonRiding = {
			name = "Dragon Riding",
...
MCLcore.mountList[19] = {
	...
	categories = {
		...
		Quest = {
			name = "Quest",
			mounts = {219391, 224150, 242733, 242734, 238051, 242713, 242715, 221765, 239563},
			mountID = {}
		},
		Raid = {
			name = "Raid",
...
MCLcore.mountList[21] = {
	...
	categories = {
		...
		May2026 = {
			name = "May 2026",
			mounts = {210141, 268363, 268364},
			mountID = {}
		},
		Jun2026 = {
			name = "June 2026",
			mounts = {236415, 238941, 268876, 268877},
			mountID = {}
		},
		Jul2026 = {
			name = "July 2026",
			mounts = {243596, 273317, 273651},
			mountID = {}
		},
		Aug2026 = {
			name = "August 2026",
			mounts = {243591, 211087, 274681},
			mountID = {}
		},
		Sep2026 = {
			name = "September 2026",
			mounts = {247795, 278574, 278575, 247793},
			mountID = {}
		},
		BonusRewards = {
			name = "Bonus Rewards",
...
MCLcore.mountNotes = {
	[13335] = "Drops from Lord Aurius Rivendare (final boss) in Stratholme (undead side). Very low drop rate (~0.8%). Fast farm: kill boss, reset, repeat. Subject to 10 instances/hour lockout. {{m:23,26.8,11.6}}",
	...
	[21218] = "Drops from trash mobs inside Temple of Ahn'Qiraj (AQ40). Can only be used inside the instance. {{m:81,22.0,93.8}}",
	[21321] = "Drops from trash mobs inside Temple of Ahn'Qiraj (AQ40). Can only be used inside the instance. {{m:81,22.0,93.8}}",
	[21323] = "Drops from trash mobs inside Temple of Ahn'Qiraj (AQ40). Can only be used inside the instance. {{m:81,22.0,93.8}}",
	[21324] = "Drops from trash mobs inside Temple of Ahn'Qiraj (AQ40). Can only be used inside the instance. {{m:81,22.0,93.8}}",
	[30480] = "Drops from Attumen the Huntsman (first boss) in Karazhan. Approximately 1% drop rate. Solo-friendly first boss of the raid. {{m:42,46.9,74.7}}",
	[32458] = "Drops from Kael'thas Sunstrider in The Eye (Tempest Keep). Very low drop rate (~1.7%). Soloable at max level. Also available on the Black Market Auction House. {{m:109,76.5,65.6}}",
	[32768] = "Drops from Anzu in Sethekk Halls on Heroic difficulty. Approximately 1.5% drop rate. Fast farm: kill Anzu, reset, repeat. Subject to 10 instances/hour lockout. {{m:108,44.9,65.6}}",
	...
	[35513] = "Drops from Kael'thas Sunstrider in Magisters' Terrace on Heroic difficulty. Approximately 4% drop rate. Fast farm: kill Kael'thas, reset, repeat. Subject to 10 instances/hour lockout. {{m:122,61.3,30.9}}",
	...
	[43951] = "Drops from the Infinite Corruptor in Culling of Stratholme on Heroic difficulty. Must reach the dragon before the 25-minute timer expires. 100% drop rate when killed. {{m:71,66.7,49.7}}",
	[43952] = "Drops from Malygos in the Eye of Eternity (10/25). Very low drop rate (~2%). One lockout per week per difficulty. Also available on the Black Market Auction House. {{m:114,27.5,26.0}}",
	[43953] = "Drops from Malygos in the Eye of Eternity (10/25). Low drop rate (~4%). One lockout per week per difficulty. Also available on the Black Market Auction House. {{m:114,27.5,26.0}}",
	[43954] = "Rewarded from defeating Sartharion with 3 drakes alive on 25-man difficulty. Leave the trash alone and just kill the boss. {{m:115,60.1,56.7}}",
	[43959] = "Drops from any boss in Vault of Archavon (10/25). Extremely rare drop. Your faction must control Wintergrasp to enter. Alliance version. {{m:123,50.1,11.4}}",
	...
	[45693] = "Drops from Yogg-Saron in Ulduar with 0 Keepers active (0-light) on 25-man. Approximately 1% drop rate. Soloable but requires handling several mechanics. Also available on the Black Market Auction House. {{m:120,41.6,17.8}}",
	...
	[49636] = "Drops from Onyxia in Onyxia's Lair (10/25). Very low drop rate (~1%). Short solo fight. Also available on the Black Market Auction House. {{m:70,52.0,76.8}}",
	...
	[50818] = "Drops from The Lich King in Icecrown Citadel 25-man Heroic only. Approximately 1% drop rate. Must be 25H, not 10-man. Soloable at max level. Also available on the Black Market Auction House. {{m:118,53.2,86.4}}",
	...
	[63040] = "Drops from Altairus in Vortex Pinnacle on Normal or Heroic difficulty. Approximately 0.9% drop rate. Fast farm: kill Altairus (second boss), reset, repeat. {{m:249,76.6,84.3}}",
	[63041] = "Drops from Al'Akir in Throne of the Four Winds (10/25). Very low drop rate (~1%). Available on Normal or Heroic. Also available on the Black Market Auction House. {{m:249,38.3,80.6}}",
	[63042] = "Most spawns are located around the temple of earth.",
	[63043] = "Drops from Slabhide in The Stonecore on Normal or Heroic difficulty. Approximately 0.9% drop rate. Fast farm: kill Slabhide (second boss), reset, repeat. {{m:207,47.7,52.0}}",
	...
	[68823] = "Drops from Bloodlord Mandokir in Zul'Gurub (Heroic). Approximately 1% drop rate. Fast farm: kill boss, reset, repeat. Subject to 10 instances/hour lockout. {{m:50,69.7,42.4}}",
	[68824] = "Drops from High Priestess Kilnara in Zul'Gurub (Heroic). Approximately 1% drop rate. Fast farm: kill boss, reset, repeat. Subject to 10 instances/hour lockout. {{m:50,69.7,42.4}}",
	[69224] = "Drops from Ragnaros in Firelands (10/25). Very low drop rate (~2% Heroic, ~1% Normal). Cannot be bonus rolled. Also available on the Black Market Auction House. {{m:198,47.3,78.0}}",
	[69226] = "Reward from the achievement \"Mountacular\" (collect 250 mounts). Flying mount.",
	[69747] = "Kasha's bag drops from freeing Kasha the bear in the dungeon Zul'aman. A good way of getting the bag is doing achievement Bear-ly made it. {{m:95,77.7,63.2}}",
	[71665] = "Drops from Alysrazor in Firelands (10/25). Very low drop rate (~2%). Available on Normal and Heroic. Cannot be bonus rolled. {{m:198,47.3,78.0}}",
	...
	[77067] = "Drops from Deathwing (Madness of Deathwing) in Dragon Soul (10/25). Very low drop rate (~2%). Available on Normal and Heroic. Also available on the Black Market Auction House. {{m:71,66.7,49.7}}",
	[77069] = "Drops from Deathwing (Madness of Deathwing) in Dragon Soul on Heroic difficulty only. Was 100% during Cataclysm, now approximately 1%. Also available on the Black Market Auction House. {{m:71,66.7,49.7}}",
	[78919] = "Drops from Ultraxion in Dragon Soul (10/25). Very low drop rate (~1%). Available on Normal and Heroic, not LFR. Also available on the Black Market Auction House. {{m:71,66.7,49.7}}",
	...
	[87777] = "Drops from Elegon in Mogu'shan Vaults. Very low drop rate (~1%). Available in 10/25 Normal and Heroic, but NOT LFR. Cannot be bonus rolled. Sold on Black Market AH. {{m:379,59.6,39.2}}",
	...
	[93666] = "Drops from Horridon in Throne of Thunder. Very low drop rate (~1.5%). Available in 10/25 Normal and Heroic, but NOT LFR. Cannot be bonus rolled. Sold on Black Market AH. {{m:504,63.6,32.2}}",
	...
	[95059] = "Drops from Ji-Kun in Throne of Thunder. Very low drop rate (~2%). Available in 10/25 Normal and Heroic. Cannot be bonus rolled. Sold on Black Market AH. {{m:504,63.6,32.2}}",
	...
	[104253] = "Drops from Mythic Garrosh in Siege of Orgrimmar. Was 100% on Heroic during MoP, now ~1-2% drop rate. Mythic only. Sold on Black Market AH. {{m:390,74.0,42.2}}",
	...
	[116660] = "100% drop from Mythic Blackhand in Blackrock Foundry. Soloable at max level. Cannot be obtained from bonus rolls. Also sold on the Black Market Auction House. {{m:543,51.4,27.4}}",
	...
	[123890] = "100% drop from Mythic Archimonde in Hellfire Citadel. Soloable at max level. Cannot be obtained from bonus rolls. Also sold on the Black Market Auction House. {{m:534,45.5,53.4}}",
	...
	[142236] = "Drops from Attumen the Huntsman in Return to Karazhan on Mythic difficulty. The original Midnight mount remains available from the classic Karazhan raid. Low drop rate, lootable once per week. {{m:42,46.9,74.7}}",
	...
	[142552] = "Drops from the Nightbane timed encounter in Return to Karazhan. To spawn Nightbane, click all 5 Soul Fragments within the time limit during a Mythic run. The mount has a 20% base drop chance multiplied by the number of eligible players (up to 100% with 5 eligible). {{m:42,46.9,74.7}}",
	...
	[143643] = "Drops from Mistress Sassz'ine in the Tomb of Sargeras raid. For legacy farming, queue for the Gates of Hell LFR wing via the NPC in Legion Dalaran. Also available on the Black Market Auction House. {{m:646,63.8,22.4}}",
	...
	[152789] = "Drops from Argus the Unmaker in Antorus, the Burning Throne on Mythic difficulty only. Also available on the Black Market Auction House. One of the most impressive-looking Legion mounts. {{m:885,54.8,62.2}}",
	...
	[152816] = "Drops from Felhounds of Sargeras in Antorus, the Burning Throne. For legacy farming, queue for the Light's Breach LFR wing via the NPC in Legion Dalaran. {{m:885,54.8,62.2}}",
	...
	[159842] = "Drops from {{npc:126983,Harlan Sweete}} (final boss) in Freehold dungeon on Mythic difficulty. Approximately 1% drop rate. Must clear entire dungeon each run. {{m:895,84.6,78.9}}",
	[159921] = "Drops from the last boss in Kings' Rest dungeon on Mythic difficulty. Approximately 1% drop rate. Farm by running Mythic (non-keystone) and resetting. Subject to 10 instances/hour lockout. {{m:862,37.8,39.0}}",
	[160829] = "Drops from {{npc:131817,Elder Leaxa}} (first boss) in The Underrot dungeon on Mythic difficulty. Approximately 1% drop rate. Fast farm: kill first boss, leave, reset. {{m:863,51.9,65.8}}",
	...
	[166518] = "Drops from {{npc:146409,Lady Jaina Proudmoore}} in Battle of Dazar'alor on Mythic difficulty. Approximately 1% drop rate (was 100% during current content). Soloable at current gear. Also available on the Black Market Auction House. {{m:862,54.3,29.5}}",
	...
	[166705] = "Drops from {{npc:158041,N'Zoth the Corruptor}} in Ny'alotha, the Waking City on Mythic difficulty. Very low drop rate (~1%). Was 100% during current content. Also available on the Black Market Auction House. {{m:1530,15.0,55.0}}",
	...
	[168826] = "Drops from {{npc:150396,HK-8 Aerial Oppression Unit}} in Operation: Mechagon dungeon. Approximately 1-2% drop rate. Drops on Mythic difficulty. {{m:1462,72.0,36.9}}",
	...
	[168830] = "Drops from {{npc:144838,King Mechagon}} in Operation: Mechagon dungeon on Hard Mode. Approximately 1-2% drop rate. Hard Mode requires not pressing any red buttons throughout the dungeon. {{m:1462,72.0,36.9}}",
	...
	[174872] = "Drops from {{npc:158041,N'Zoth the Corruptor}} in Ny'alotha, the Waking City on Mythic difficulty. Very low drop rate (~1%). Soloable at max level. Also available on the Black Market Auction House. {{m:1530,15.0,55.0}}",
	...
	[180581] = "Requires the Venthyr Covenant.\n\nRare drop (~1%) from Hopecrusher, a rare elite in the Chalice District of Revendreth.\n\nHopecrusher only spawns when you interact with the {{m:1525,52,52}} Large Prey bat corpse in the courtyard. If the corpse isn't there, the rare is on cooldown — try again later or hop realms.\n\nLow drop rate — expect repeated kills.",
	...
	[184062] = "Drops from the Elite mobs in the Theater of Pain — the outdoor arena in Maldraxxus {{m:1536,50.7,47.4}}, NOT the dungeon of the same name.\n\nClear the roaming Elites in the open-world arena for a chance at the mount; it does not come from the Theater of Pain dungeon bosses. Low drop rate — expect many kills.",
	...
	[192778] = "Sold by Xydan in the Bronze Enclave, Valdrakken for 5,000 Timewarped Badges during Dragonflight Timewalking. Ground mount. Added in patch 12.0.7 (previously unobtainable).",
	...
	[206585] = "Drops in Naxxramas (10/25 player). Low drop rate (~1%). Soloable at max level. {{m:115,87.4,51.1}}",
	...
	[210061] = "Drops from Fyrakk the Blazing in Amirdrassil, the Dream's Hope on Mythic difficulty only. Was 100% during Dragonflight Season 3, now approximately 1%. Also available on the Black Market Auction House. {{m:2200,27.0,31.0}}",
	[210140] = "Sold by Xydan in the Bronze Enclave, Valdrakken for 5,000 Timewarped Badges during Dragonflight Timewalking. Ground mount. Added in patch 12.0.7 (datamined in Dragonflight, first obtainable in 12.0.7).",
	[210141] = "Trading Post (May 2025 and May 2026) for 325 Trader's Tender.",
	...
	[211087] = "Trading Post (August 2026) for 500 Trader's Tender. Originally a Mountain Dew Gaming promotional mount.",
	...
	[224147] = "Drops from Queen Ansurek in Nerub-ar Palace on any difficulty. Low drop rate (~1-2%). {{m:2255,46.2,17.4}}",
	[224151] = "Drops from Queen Ansurek in Nerub-ar Palace on Mythic difficulty only. Was 100% during TWW Season 1, now approximately 1%. Also available on the Black Market Auction House. {{m:2255,46.2,17.4}}",
	...
	[225548] = "Drops from The Candle King, final boss of Darkflame Cleft. Very low drop rate. {{m:2214,55.5,21.6}}",
	...
	[229924] = "Drops from bosses in Liberation of Undermine. Low drop rate.",
	[229940] = "Drops from bosses in Liberation of Undermine. Low drop rate.",
	[229945] = "Drops from bosses in Liberation of Undermine. Low drop rate.",
	...
	[235626] = "Drops from Chrome King Gallywix in Liberation of Undermine. Available on any difficulty. Low drop rate.",
	...
	[236415] = "Trading Post (June 2025 and June 2026) for 325 Trader's Tender.",
	[236960] = "Drops from Chrome King Gallywix in Liberation of Undermine on Mythic difficulty only. Was 100% during TWW Season 2, now approximately 1%. Also available on the Black Market Auction House.",
	...
	[238941] = "Trading Post (June 2025 and June 2026) for 700 Trader's Tender.",
	...
	[243061] = "Drops from Dimensius the All-Devouring in Manaforge Omega on Mythic difficulty only. 100% drop rate during TWW Season 3.",
	...
	[243591] = "Trading Post (August 2025 and August 2026) for 700 Trader's Tender.",
	...
	[243596] = "Trading Post (July 2025 and July 2026) for 575 Trader's Tender.",
	...
	[246590] = "Drops from the final boss of March on Quel'Danas on Mythic difficulty only. 100% drop rate during current content.",
	...
	[247793] = "Trading Post (September 2025 and September 2026) for 650 Trader's Tender.",
	[247794] = "Datamined for the Trading Post (Patch 11.2.0). Not yet offered in any monthly rotation.",
	[247795] = "Trading Post (September 2025 and September 2026) for 325 Trader's Tender.",
	...
	[246735] = "Rare drop from any of the 15 rare creatures in Harandar - the same pool that drops the Vibrant Petalwing. Rares reset daily, and all 15 are pinned on the world map by the Guide; a rare you have already killed today is greyed out until reset.",
	[252012] = "Rare drop from any of the 15 rare creatures in Harandar - the same pool that drops the Rootstalker Grimlynx. Rares reset daily, and all 15 are pinned on the world map by the Guide; a rare you have already killed today is greyed out until reset.",
	[256423] = "Drops from the Sporespawned Cache at Fungara Village, one of the nine Treasures of Harandar.",
	[257085] = "Rare drop from any of the 14 rare creatures in Voidstorm - the same pool that drops the Sanguine Harrower. Rares reset daily, and all 14 are pinned on the world map by the Guide; a rare you have already killed today is greyed out until reset.",
	[257147] = "Rare drop from any of the 15 rare creatures in Eversong Woods - the same pool that drops the Cerulean Hawkstrider. Rares reset daily, and all 15 are pinned on the world map by the Guide; a rare you have already killed today is greyed out until reset.",
	[257152] = "Rare drop from any of the 15 rare creatures in Zul'Aman - the same pool that drops the Witherbark Pango. Rares reset daily, and all 15 are pinned on the world map by the Guide; a rare you have already killed today is greyed out until reset.",
	[257156] = "Rare drop from any of the 15 rare creatures in Eversong Woods - the same pool that drops the Cobalt Dragonhawk. Rares reset daily, and all 15 are pinned on the world map by the Guide; a rare you have already killed today is greyed out until reset.",
	...
	[257200] = "Rare drop from any of the 15 rare creatures in Zul'Aman - the same pool that drops the Amani Sharptalon. Rares reset daily, and all 15 are pinned on the world map by the Guide; a rare you have already killed today is greyed out until reset.",
	[257223] = "The Honored Warrior's Cache in Zul'Aman stays sealed until you bring it four tokens - one from each of the Chosen guardians that spawn from the urns around the zone.",
	...
	[260635] = "Rare drop from any of the 14 rare creatures in Voidstorm - the same pool that drops the Augmented Stormray. Rares reset daily, and all 14 are pinned on the world map by the Guide; a rare you have already killed today is greyed out until reset.",
	...
	[262914] = "Drops from the final boss of Windrunner Spire dungeon. Low drop rate.",
	...
	[278574] = "Trading Post (September 2026) for 500 Trader's Tender.",
	[278575] = "Trading Post (September 2026) for 500 Trader's Tender.",
	...
	[275432] = "Horde Vicious mount for Midnight Season 2. Reward from the Venomous Combatant achievement after winning Rated PvP matches at 1000+ rating.",
	[275433] = "Alliance Vicious mount for Midnight Season 2. Reward from the Venomous Combatant achievement after winning Rated PvP matches at 1000+ rating.",
	[275652] = "Reward from the achievement \"Glory of the Venomous Raider.\" Complete the Venomous Abyss raid achievement meta.\n\nRaid entrance, in the Vaults of Atal'Utek: {{m:2509,47.2,21.7}}",
	[275653] = "Sold by Second Mate Sluggs at Tokka's Folly on The Coiled Isle for 2,500 Coiled Filament. Requires Bloodsworn Crew standing with Captain Tokka, earned through Cursed Fishing.\n\n{{m:2512,51.6,49.8}}",
	[275654] = "Sold by the Skull of Er'inye, next to the Altar of Corrosion in the Vaults of Atal'Utek, for 10,000 Corrosive Coin.\n\n{{m:2509,51.2,62.4}}",
	[275656] = "Reward from the achievement \"Treasures of the Coiled Isle.\" Discover all 22 hidden treasures across the Coiled Isle - every location is pinned on the world map by the Guide, and pins disappear as you loot them.\n\nA star on a pin means that treasure needs extra steps first.",
	[275657] = "Reward from the achievement \"Let Me Solo Him: Azta'rec.\" Defeat the Delves Nemesis boss Azta'rec solo, on the higher of the two Nemesis difficulties, during Midnight Season 2.\n\nAzta'rec's lair is the Venomfall Deeps delve in the north of the Coiled Isle: {{m:2512,51.2,31.0}}\nUnlocked by clearing a Tier 10 delve with at least one life remaining.",
	[275658] = "Drops from Ula'tek, the final boss of The Venomous Abyss, on Mythic difficulty.\n\nRaid entrance, in the Vaults of Atal'Utek: {{m:2509,47.2,21.7}}",
	[275659] = "Drops from Ral'kala, the Nightmare-only Prey boss on the Coiled Isle. Introduced by the hunt \"Prey: A Ghostly Nightmare.\"",
	[275660] = "Sold by Construct V'anore at the Preyseeker's Headquarters in Silvermoon City for 2,250 Remnant of Anguish. Requires Preyhunter's Journey Rank 10.\n\n{{m:2393,55.7,65.9}}",
	[275664] = "Sold by Kifaan (Val and Naigtal) for 15 Voidlight Marl. Requires completing the achievement \"Heroic Showdowns.\"",
	[276162] = "Sold by Telemancer Astrandis at the Delver's Headquarters in Silvermoon City for 10 Voidlight Marl. Requires Delver's Journey Rank 5.\n\n{{m:2393,52.5,78.8}}",
	[276549] = "Rare drop from any of the 12 rare creatures on the Coiled Isle - the same pool that drops the Ruby Writhe. Rares reset daily, and all 12 are pinned on the world map by the Guide; a rare you have already killed today is greyed out until reset.",
	[276551] = "Sold by Jan'sari the Watchful at Tokka's Landing on The Coiled Isle for 8,000 Voidlight Marl. Requires Zul'jarra's Forces Renown 19.\n\n{{m:2512,58.8,46.0}}",
	[276553] = "Reward from the achievement \"Pro Poison Patroller.\" Complete 250 Temple Patrols within the Vaults of Atal'Utek. Three patrols are active every 10 minutes and any of them count.\n\nAmani Foothold, the Vaults hub: {{m:2509,51.2,62.4}}",
	[276801] = "Reward from the achievement \"Assault the Vault.\" Complete the Vaults of Atal'Utek achievements: all 12 Temple Patrol variants, all 6 Temple Strikes, all 3 Temple Incursions, all three Ancient Foes, and all 12 Funerary Inscriptions.\n\nThe Funerary Inscriptions are the only fixed locations - all 12 are pinned on the world map by the Guide, and pins disappear as you read them.",
	[276802] = "Sold by Jan'sari the Watchful at Tokka's Landing on The Coiled Isle for 6,000 Voidlight Marl. Requires Zul'jarra's Forces Renown 17.\n\n{{m:2512,58.8,46.0}}",
	[276803] = "Rare drop from any of the 12 rare creatures on the Coiled Isle - the same pool that drops the Topaz Skyfang. Rares reset daily, and all 12 are pinned on the world map by the Guide; a rare you have already killed today is greyed out until reset.",
	...
	["m2912"] = "Reward from the achievement \"Treasures of Harandar.\" Discover all 9 hidden treasures across Harandar - every location is pinned on the world map by the Guide, and pins disappear as you loot them.\n\nA star on a pin means that treasure needs extra steps first.\n\nTwo of them also hand out mounts of their own: the Peculiar Cauldron gives the Ruddy Sporeglider, and the Sporespawned Cache gives the Untainted Grove Crawler.",
