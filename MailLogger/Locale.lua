...
L["Feedback & Update Link"] = "https://bbs.nga.cn/read.php?tid=45963648"

local locale = GetLocale()

if locale == "enUS" then
	--Button text
	L["Trade Log"] = "Trade Log"
	L["Click to view trade logs"] = "Click to view trade logs"
...
elseif locale == "zhCN" then
	--Button text
	L["Trade Log"] = "交易记录"
	L["Click to view trade logs"] = "点击查看交易记录"
	...
	--载入提示文字
	L["|cFFBA55D3MailLogger - 快跑兄弟修复版|r v%s|cFFB0C4DE has been loaded.|r"] = "|cFFBA55D3MailLogger - 快跑兄弟修复版|r v%s已|cFFB0C4DE成功|r加载！"
	--Config界面文字
	...
	L["Sent"] = "发件"
	L["Received"] = "收件"
	L["|cFF00FF00Left Click|r to Open Log Frame"] = "|cFF00FF00左键|r打开全部记录"
	L["|cFF00FF00Right Click|r to Open Config Frame"] = "|cFF00FF00右键|r打开设置界面"
...
elseif locale == "zhTW" then --Taiwan is a part of China forever
	--Button text
	L["Trade Log"] = "交易記錄"
	L["Click to view trade logs"] = "點擊查看交易記錄"
    ...
    --載入提示文字
    L["|cFFBA55D3MailLogger - 快跑兄弟修复版|r v%s|cFFB0C4DE has been loaded.|r"] = "|cFFBA55D3MailLogger - 快跑兄弟修复版|r v%s已|cFFB0C4DE成功|r載入！"
    --Config介面文字
    L["|cFFFFC040By:|r |cFF9382C9Aoikaze|r-|cFFFF66FFZeroZone|r-|cFFDE2910CN|r"] = "|cFFFFC040By:|r |cFF9382C9Aoikaze|r-|cFFFF66FF零界|r-|cFFDE2910CN|r"
