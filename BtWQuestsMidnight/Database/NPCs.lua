...
BtWQuestsDatabase:AddNPCsTable({
    ...
    [236739] = {
        name = "Magistrix Landra Dawnstrider",
        locations = {
            [2395] = {
                {
                    x = 0.467077,
    ...
    [248631] = {
        name = "Commander Koruth Mountainfist",
        locations = {
            [2393] = {
                {
                    x = 0.453725,
