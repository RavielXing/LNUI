                    ...
                    subSettings = {
                        {
                            ...
                            settingType = SETTING_TYPE.ADDON_VARIABLE,
                            name = L["point.offsetX"],
                            tooltip = L["equipmentSummary.statIcon.offset.tooltip"],
...
local function Register()--lnui设置命令
    local category, layout = LibBlzSettings:RegisterVerticalSettingsTable(ADDON_NAME, settings, nil, true)
	_G.SLASH_COOLDOWNDONE1 = "/iio";
	SlashCmdList["ITEMINFOOVERLAY"] = function()
