...
L["Auto role check"] = "自动确认职责";
L["Accepts the role check window for you. The roles used are the ones you have selected in the Dungeon Finder."] = "替你确认职责检查窗口。使用的是你在地下城查找器中选择的职责。";
L["Mythic+ only"] = "仅史诗+";
