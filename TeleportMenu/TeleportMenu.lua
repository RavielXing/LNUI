...
local function createAnchors()
	...
	buttonsFrameLeft:SetPoint("TOPRIGHT", GameMenuFrame,  "TOPLEFT", -globalHeight + 1, -buttonFrameYOffset - 35)--lnui
	buttonsFrameRight:SetPoint("TOPLEFT", GameMenuFrame.mmbct, "TOPRIGHT", 0, -buttonFrameYOffset - 35)--lnui
